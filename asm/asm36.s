...
off_813036C:    .word dword_8129180
    ...
    ldrb r1, [r5,#0xc]
    sub r1, #1
    ldr r2, off_81303FC // =unk_8130400 
    ldrb r3, [r2,r1]
    mov r1, #1
    mov r2, #0
    bl sub_811F91C
...
sub_813068C:
    ...
    bl sub_8130404
    add r5, r0, #0
    ldr r1, off_8130724 // =unk_20065C0 
    ldrb r0, [r5,#0xc]
    tst r0, r0
    pop {r5}
    bne loc_81306AC
...
sub_8131210:
    ...
    strb r1, [r7,#0x1b]
    ldrb r0, [r5,#0xc]
    ldr r1, off_81312D0 // =unk_81312D4 
    ldrb r0, [r1,r0]
    bl sub_8132280
    b locret_81312C8
loc_813123E:
...
loc_81314FC:
    ldr r4, [sp]
    lsl r4, r4, #1
    ldr r0, off_8131538 // =dword_873EA50 
    ldr r1, [sp,#4]
    ldrh r1, [r1,r4]
    mov r2, #0x90
    sub r1, r1, r2
...
sub_8131570:
    ...
    // a3
    mov r2, #0
    ldr r3, dword_8131584 // =0x8130884 
    mov r4, #8
    mov r5, #8
    bl drawTiles // (int a1, int a2, int a3) -> void
.endfunc // sub_8131570
...
sub_8131C2C:
    ...
    ldr r1, off_8131C68 // =unk_8131C6C 
    mov r2, #0
loc_8131C34:
    ldr r3, [r1,r2]
    str r3, [r4,r2]
...
loc_8131CBA:
    ...
    and r0, r1
    lsl r0, r0, #2
    ldr r1, off_8131D3C // =unk_8131D40 
    ldr r0, [r1,r0]
    str r0, [r4,r6]
    add r6, #4
    bl sub_8131EB0
...
sub_8131D80:
    ...
    and r0, r1
    lsl r0, r0, #2
    ldr r1, off_8131E4C // =unk_8131E50 
    ldr r0, [r1,r0]
    str r0, [r4,r6]
    bl sub_8131EB0
    pop {r4-r7,pc}
...
loc_8131EEC:
    ldrh r0, [r6,r4]
    mov r3, #0
    ldr r1, dword_8131F18 // =0x8131BF4 
loc_8131EF2:
    ldrh r2, [r1,r3]
    cmp r0, r2
    bne loc_8131EFE
    ldr r1, dword_8131F1C // =0x8131BFC 
    ldrh r0, [r1,r3]
    b loc_8131F04
loc_8131EFE:
    add r3, #2
...
.thumb_func
sub_81325E4:
    ldr r1, off_81325EC // =unk_81325F0 
    ldrb r0, [r1,r0]
    mov pc, lr
    .balign 4, 0x00
...
sub_81326D4:
    ...
    bl sub_800183C
    bl sub_8046664
    ldr r0, off_8132714 // =locret_8132718 
    bl sub_8000B30
...
loc_8132764:
    ...
    mov r0, #0x48 
    ldrb r1, [r5,r0]
    ldr r0, off_8132774 // =off_8132778 
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
    pop {pc}
...
loc_813282E:
    ...
    ldr r7, [r7,r6]
    ldr r6, off_8132874 // =dword_86ACD24+60 
    bl sub_8045FBC
    ldr r6, [sp,#0xc]
    add r6, #4
    str r6, [sp,#0xc]
...
loc_81328E4:
    ...
    ldr r7, [r7,r6]
    ldr r6, off_8132934 // =dword_86ACD24+60 
    bl sub_8045FBC
    ldr r6, [sp,#0xc]
    add r6, #4
    str r6, [sp,#0xc]
...
loc_8132CD4:
    ...
    ldr r2, off_8132D50 // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_8132D9C:
    ...
    mov r1, #0
    ldr r2, off_8132E9C // =unk_2017A00 
...
loc_8132FDE:
    ...
    cmp r7, #0x10
    ble loc_8132FDA
    ldr r7, off_81330A8 // =word_2013A00 
    mov r4, #0
    lsl r6, r6, #1
...
loc_813306A:
    ...
    // a3
    mov r2, #2
    ldr r3, off_81330A8 // =word_2013A00 
    lsr r4, r6, #2
    mov r0, #0x19
    // a1
    sub r0, r0, r4
...
loc_8133EDC:
    ...
    ldr r2, off_8133F68 // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_8134138:
    push {lr}
    ldr r0, off_8134188 // =unk_813418C 
    ldrb r1, [r7,#0xe]
    lsl r1, r1, #1
    ldrh r0, [r0,r1]
    mov r1, #0x18
...
loc_8134812:
    ...
    cmp r2, r3
    beq loc_8134826
    ldr r1, dword_81348CC // =0x30069A0 
    ldrb r3, [r1,r2]
    mov r1, #4
    eor r3, r1
    strb r3, [r0,r4]
...
sub_81352A0:
    ...
    str r4, [sp,#0x10]
    ldrb r0, [r5,#0xc]
    ldr r1, off_813530C // =unk_8135310 
    ldrb r1, [r1,r0]
    bl getPETNaviSelect
    bl sub_80137B6
    add r6, r0, #0
...
.endfunc // sub_8135F34
    ...
    mov r1, #0xd
    mov r2, #3
    ldr r3, off_8135F84 // =unk_813565C 
    mov r4, #0xa
    mov r5, #6
    bl drawTiles // (int a1, int a2, int a3) -> void
    pop {r4-r7,pc}
...
sub_8135FA4:
    push {lr}
    ldr r1, off_8135FC0 // =unk_8135FC4 
    ldrb r0, [r5,#0xf]
    lsl r0, r0, #3
    add r1, r1, r0
    ldrh r0, [r5,#0x20]
...
loc_8136962:
    ...
    bl sub_80465A0
    ldr r1, off_813699C // =unk_81369B5 
    ldrb r2, [r5,#0xf]
    ldrb r1, [r1,r2]
    ldrb r0, [r5,#3]
    cmp r0, r1
...
sub_8136B58:
    push {r4-r7,lr}
    lsl r7, r0, #2
    ldr r1, off_8136B98 // =unk_8136B9C 
    ldrb r0, [r5,#0xf]
    // a2
    ldrb r1, [r1,r0]
    // a1
...
.endfunc // sub_8136BA0
    ...
    mov r1, #0xd
    mov r2, #3
    ldr r3, off_8136BD8 // =unk_813565C 
    mov r4, #0xa
    mov r5, #6
    bl drawTiles // (int a1, int a2, int a3) -> void
    pop {r4-r7,pc}
...
sub_8137648:
    push {lr}
    ldr r2, off_8137658 // =unk_813765C 
    ldrh r0, [r2,r0]
    add r1, r1, r5
    ldrh r1, [r1]
    tst r0, r1
...
.thumb_func
sub_81376B8:
    ldr r2, off_8137710 // =word_20065B4 
    ldrh r3, [r2]
    sub r0, r0, r1
    lsl r1, r1, #1
    add r0, r0, r1
...
.thumb_func
sub_8137700:
    ldr r1, off_8137710 // =word_20065B4 
    mov r0, #0x7f
    lsl r0, r0, #8
    mov r2, #0xff
    orr r0, r2
...
loc_8137AE8:
    ...
    ldr r2, off_8137B64 // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_8137D20:
    push {r4-r7,lr}
    add r7, r5, #0
    ldr r0, off_8137D48 // =unk_2017A00 
    mov r1, #0xe0
    bl sub_80008C0
    ldrh r0, [r7,#0x24]
    ldr r1, off_8137D4C // =unk_201CF00 
    ldr r2, off_8137D48 // =unk_2017A00 
    mov r3, #7
    mov r4, #0
    bl sub_8137D50
    mov r0, #2
...
sub_8138478:
    push {lr}
    push {r0-r7}
    ldr r0, off_81384DC // =unk_2017A00 
    ldrb r1, [r3,#1]
    ldr r2, off_81384C8 // =word_2013A00 
    ldr r3, off_81384CC // =unk_2014A00 
    mov r4, #0xc
    mov r5, #1
    ldr r6, off_81384D0 // =dword_86ACD24+60 
...
sub_8138908:
    ...
    // a3
    mov r2, #1
    ldr r3, off_8138938 // =unk_2016A00 
    mov r4, #0xe
    mov r5, #6
    bl drawTiles // (int a1, int a2, int a3) -> void
    pop {r3-r5,pc}
