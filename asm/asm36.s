...
.endfunc // sub_81304EC
    ...
    mov r3, #0xa
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8130608-0x813059a-2] // =0x216
    orr r3, r4
    mov r5, #5
    bl sub_8120458
    mov r0, #0x14
    ...
    mov r3, #8
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8130610-0x81305c6-2] // =0x34F
    orr r3, r4
    mov r5, #5
    bl sub_81204C4
    mov r0, #0x15
...
loc_8133E68:
    tst r7, r7
    bne loc_8133E72
    ldr r0, [pc, #0x8133e78-0x8133e6c-4] // =0x7A
    bl sound_play
loc_8133E72:
    add r0, r7, #0
    tst r0, r0
...
.endfunc // sub_81341A0
    ...
    mov r3, #0xb
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8134304-0x813422a-2] // =0x216
    orr r3, r4
    mov r5, #7
    bl sub_8120458
    mov r1, #0x18
    ...
    mov r3, #9
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x813430c-0x8134256-2] // =0x34F
    orr r3, r4
    mov r5, #7
    bl sub_81204C4
    mov r1, #0x18
...
.endfunc // sub_8134310
    ...
    mov r3, #0xb
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x813447c-0x813439a-2] // =0x216
    orr r3, r4
    mov r5, #7
    bl sub_8120458
    mov r1, #0x18
    ...
    mov r3, #9
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8134484-0x81343c6-2] // =0x34F
    orr r3, r4
    mov r5, #7
    bl sub_81204C4
    mov r1, #0x18
...
sub_8134548:
    push {lr}
    ldr r0, [pc, #0x8134588-0x813454a-2] // =0x182
    mov r1, #0x1c
    mov r2, #0x28 
    mov r3, #0x2e 
    bl sub_8134558
...
loc_813474E:
    ...
    add r1, #0x20 
    orr r0, r1
    ldr r1, [pc, #0x8134794-0x8134758-4] // =0x2
    ldrb r2, [r5,#0x15]
    str r2, [sp]
    mov r3, #0xf
    and r2, r3
...
sub_8136804:
    push {lr}
    ldr r1, [pc, #0x8136824-0x8136806-2] // =0x303
    tst r0, r1
    beq locret_8136822
    ldrh r0, [r5,#0x24]
    ldrh r1, [r5,#0x20]
...
sub_8136FB8:
    ...
    cmp r0, #3
    beq loc_8136FFC
    ldr r0, [pc, #0x8137014-0x8136fde-2] // =0x1
    bl sub_8137670
    mov r0, #0x20 
    strb r0, [r5]
    b locret_813700C
...
loc_8137078:
    ...
    ldrh r0, [r7,#0x2c]
    strb r0, [r5,#6]
    ldr r0, [pc, #0x8137094-0x8137080-4] // =0x1
    bl sub_8137670
    mov r0, #0
    strh r0, [r5,#0xe]
    mov r0, #0x28 
...
sub_81370D4:
    ...
    cmp r0, #2
    beq loc_8137124
    ldr r0, [pc, #0x813715c-0x81370fc-4] // =0x1
    bl sub_8137670
    mov r0, #0x14
    bl sub_81376A8
    bl sub_81375D8
...
loc_8137208:
    ...
    b locret_8137222
loc_8137214:
    ldr r0, [pc, #0x8137228-0x8137214-4] // =0x1
    bl sub_8137670
    mov r0, #0
    strh r0, [r5,#0xe]
    mov r0, #0x48 
...
sub_813726C:
    ...
    cmp r0, #1
    beq loc_81372A6
    ldr r0, [pc, #0x81372e0-0x8137290-4] // =0x1
    bl sub_8137670
    mov r0, #0x1c
    bl sub_81376A8
    bl sub_81375D8
...
loc_813747A:
    add r7, r6, #0
    ldr r0, [pc, #0x8137490-0x813747c-4] // =0x1
    bl sub_8137670
    mov r0, #0
    strh r0, [r5,#0xe]
    mov r0, #0x6c 
...
sub_81374D4:
    ...
    cmp r0, #4
    bne loc_81374FE
    ldr r0, [pc, #0x8137524-0x81374f2-2] // =0x1
    bl sub_8137670
    mov r0, #0x7c 
    strb r0, [r5]
    b locret_813751E
...
sub_81375AC:
    ...
    cmp r0, #0x30 
    bne locret_81375C4
    ldr r0, [pc, #0x81375c8-0x81375ba-2] // =0x1
    bl sub_813768C
    mov r0, #0x90
    strb r0, [r5]
locret_81375C4:
...
sub_813838C:
    ...
    strh r1, [r0,#6]
    ldr r1, [pc, #0x81383c0-0x81383a2-2] // =0x1E89
    strh r1, [r0,#8]
    mov r0, #8
    mov r1, #4
    bl engine_setScreeneffect
