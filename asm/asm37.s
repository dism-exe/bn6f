...
sub_813B934:
    push {lr}
    mov r0, r10
    ldr r0, [r0,#0x5c]  // memBlock
    ldr r1, [pc, #0x813b94c-0x813b93a-2] // =0x188  // numWords
    bl CpuSet_ZeroFillWord
    mov r0, r10
    ldr r0, [r0,#0x58]  // memBlock
...
sub_813C06C:
    ...
    sub sp, sp, #0xc
    str r2, [sp,#4]
    ldr r5, [pc, #0x813c180-0x813c072-2] // =loc_813C188
    mov r3, #0xe
    mul r2, r3
    add r5, r5, r2
    ldr r4, [pc, #0x813c184-0x813c07a-2] // =loc_813C1A4
    add r4, r4, r2
    str r4, [sp]
    bl sub_813B9B4
    str r0, [sp,#8]
...
a6VDhxFjzDfhjtx:    .byte 0x36, 0x3A, 0x56, 0x5E, 0x2C
    ...
    .byte 0x76, 0x77, 0x0
    .byte 0, 0
off_813C180:    .word loc_813C188
off_813C184:    .word loc_813C1A4
...
sub_813C1C0:
    ...
    sub sp, sp, #8
    str r0, [sp,#4]
    ldr r5, [pc, #0x813c2e4-0x813c1c6-2] // =loc_813C2EC
    mov r1, #0xe
    mul r0, r1
    add r5, r5, r0
    ldr r1, [pc, #0x813c2e8-0x813c1ce-2] // =loc_813C308
    add r1, r1, r0
    str r1, [sp]
    mov r6, r10
    ldr r6, [r6,#0x58]
...
a6VDhxFjzDfhjtx_0:    .byte 0x36, 0x3A, 0x56, 0x5E, 0x2C
    ...
    .byte 0x76, 0x77, 0x0
    .balign 4, 0x00
off_813C2E4:    .word loc_813C2EC
off_813C2E8:    .word loc_813C308
...
sub_813D41C:
    ...
    ldr r6, [pc, #0x813d484-0x813d420-4] // =loc_813D410
    add r4, r0, #0
    mov r5, #0
loc_813D426:
    ldrb r0, [r7]
...
sub_813DA84:
    push {lr}
    ldr r0, [pc, #0x813da90-0x813da86-2] // =byte_2010290  // memBlock
    mov r1, #0x10  // numWords
    bl CpuSet_ZeroFillWord
    pop {pc}
...
sub_813E07C:
    push {r4-r7,lr}
    push {r0}
    ldr r0, [pc, #0x813e0a0-0x813e080-4] // =byte_2001150  // memBlock
    mov r1, #0x2c   // numWords
    bl CpuSet_ZeroFillWord
    pop {r0}
...
sub_813E616:
    ...
    mov r2, #0x40 
    bl initMemblockToByte
    ldr r0, [pc, #0x813e6bc-0x813e622-2] // =unk_2000FC0  // memBlock
    mov r1, #0x20   // numWords
    bl CpuSet_ZeroFillWord
    ldr r0, [pc, #0x813e6c0-0x813e62a-2] // =unk_2000FF0  // memBlock
    mov r1, #0x20   // numWords
    bl CpuSet_ZeroFillWord
    pop {pc}
...
reqBBS_init_s_2005780:
    push {r4-r7,lr}
    push {r0}
    ldr r0, [pc, #0x813f400-0x813f3c4-4] // =byte_2005780  // memBlock
...
reqBBS_initMemory_813F9DA:
    ...
    mov r2, #0x80
    bl initMemblockToByte
    ldr r0, [pc, #0x813fd88-0x813f9e6-2] // =reqBBS_numRequestsSent  // memBlock
    mov r1, #4  // numWords
    bl CpuSet_ZeroFillWord
    ldr r0, [pc, #0x813fd8c-0x813f9ee-2] // =unk_2000770  // memBlock
    mov r1, #4  // numWords
    bl CpuSet_ZeroFillWord
    pop {pc}
...
loc_81401FC:
    ...
    add r1, #3
    mov r2, #2
    ldr r3, [pc, #0x8140240-0x814021c-4] // =loc_8140244
    mov r4, #2
    mov r5, #2
    bl sub_80018C2
    pop {r4-r7}
...
loc_8140290:
    ...
    add r1, #3
    mov r2, #2
    ldr r3, [pc, #0x81402c4-0x81402a0-4] // =loc_81402C8
    mov r4, #1
    mov r5, #2
    bl sub_80018C2
    pop {r4-r7}
...
loc_81402DE:
    ...
    mov r1, #6
    mov r2, #1
    ldr r3, [pc, #0x8140304-0x81402ea-2] // =loc_8140308
    mov r4, #1
    mov r5, #2
    bl sub_80018C2
    pop {r4-r7}
...
loc_8140320:
    ...
    mov r1, #6
    mov r2, #1
    ldr r3, [pc, #0x8140350-0x814032c-4] // =loc_8140354
    mov r4, #1
    mov r5, #2
    bl sub_80018C2
    pop {r4-r7}
...
sub_81420B0:
    push {r4-r7,lr}
    bl sub_8142080
    ldr r1, [pc, #0x81420c0-0x81420b6-2] // =loc_81420C4
    ldrb r0, [r1,r0]
    lsl r0, r0, #0x10
    pop {r4-r7,pc}
    .byte 0, 0
off_81420C0:    .word loc_81420C4
...
sub_8142204:
    ...
    lsl r1, r1, #2
    add r1, #0x2c 
    ldr r2, [pc, #0x814221c-0x8142212-2] // =loc_8142220
    ldrb r0, [r2,r0]
    str r0, [r5,r1]
    pop {r4-r7,pc}
    .balign 4, 0x00
off_814221C:    .word loc_8142220
...
// end of function sub_8142248
    ...
    bl sub_81426CE
    ldr r1, [pc, #0x8142290-0x8142282-2] // =loc_8142294
    lsl r0, r0, #2
    ldr r0, [r1,r0]
...
// end of function sub_81426CE
    ...
    push {r4-r7,lr}
    bl sub_81426CE
    ldr r7, [pc, #0x8142798-0x8142792-2] // =loc_814279C
    ldrb r0, [r7,r0]
    pop {r4-r7,pc}
off_8142798:    .word loc_814279C
loc_814279C:
    lsr r7, r0, #0xc
    lsr r4, r1, #0x14
    asr r6, r1, #0x20
...
sub_81430B6:
    ...
    add r4, r0, #0
    bl sub_8143088
    ldr r1, [pc, #0x81430d0-0x81430be-2] // =loc_81430D4
    lsl r0, r0, #2
    add r1, r1, r0
    ldrh r0, [r1]
    ldrh r1, [r1,#2]
...
sub_8143B5E:
    ...
    ldrh r0, [r0,r3]
    add r0, r0, r4
    ldr r1, [pc, #0x8143b80-0x8143b6e-2] // =loc_8143B84
    ldrh r1, [r1,r3]
    add r1, r1, r4
    pop {r4-r7,pc}
    .balign 4, 0x00
...
jpt_8144268:    .word loc_814428C  // jump table for switch statement
    .word loc_814429C
    .word loc_81442B4
    .word loc_81442F0
    .word loc_81442FA
...
jpt_8145150:    .word loc_8145190  // jump table for switch statement
    .word loc_814519C
    .word loc_814519C
    .word loc_81451FC
    .word loc_81451A6
...
jpt_814543E:    .word loc_81454C8  // jump table for switch statement
    .word loc_8145500
    .word loc_8145506
    .word loc_814551C
    .word loc_8145534
...
jpt_814568C:    .word loc_8145750  // jump table for switch statement
    .word def_814568C
    .word def_814568C
    .word def_814568C
    .word def_814568C
...
loc_814641C:
    ldr r2, [pc, #0x8146434-0x814641c-4] // =InterruptMasterEnableRegister
    ldrh r1, [r2]
    mov r0, #0
    strh r0, [r2]
...
loc_814645C:
    ldr r1, [pc, #0x8146470-0x814645c-4] // =byte_200FE00
    mov r0, #6
    strh r0, [r1,#0x14] // (word_200FE14 - 0x200fe00)
    mov r0, #0xf3
    mov r1, #1
...
loc_81464A0:
    ...
    beq loc_81464AA
    mov r0, #1
    strb r0, [r1,#0xb] // (byte_200FE0B - 0x200fe00)
    b loc_81464AC
loc_81464AA:
    strb r3, [r1,#0xb] // (byte_200FE0B - 0x200fe00)
loc_81464AC:
    mov r0, #0
loc_81464AE:
    pop {r1}
...
jpt_8146518:    .word loc_8146540  // jump table for switch statement
    .word loc_8146548
    .word loc_8146552
    .word loc_8146552
    .word loc_8146558
...
loc_8146548:
    ...
    strb r0, [r2,#0x7] // (byte_200FE07 - 0x200fe00)
    mov r0, #1
    strh r0, [r2,#0x1a] // (word_200FE1A - 0x200fe00)
    b def_8146518
loc_8146552:
    mov r0, #2
    strb r0, [r2,#0x7] // (byte_200FE07 - 0x200fe00)
...
jpt_814700A:    .word loc_8147104  // jump table for switch statement
    .word def_814700A
    .word loc_8147108
    .word def_814700A
    .word def_814700A
...
jpt_814730E:    .word loc_814732C  // jump table for switch statement
    .word loc_8147336
    .word loc_8147340
    .word loc_8147328
    .word def_814730E
...
jpt_814762C:    .word loc_8147748  // jump table for switch statement
    .word def_814762C
    .word loc_814775C
    .word loc_8147784
    .word def_814762C
...
jpt_8147C6A:    .word loc_8147DAC  // jump table for switch statement
    .word def_8147C6A
    .word loc_8147DC0
    .word def_8147C6A
    .word def_8147C6A
...
jpt_814825A:    .word loc_8148368  // jump table for switch statement
    .word def_814825A
    .word def_814825A
    .word def_814825A
    .word loc_8148380
...
jpt_8148934:    .word def_8148934  // jump table for switch statement
    .word def_8148934
    .word def_8148934
    .word def_8148934
    .word def_8148934
...
jpt_8148FDA:    .word def_8148FDA  // jump table for switch statement
    .word def_8148FDA
    .word def_8148FDA
    .word def_8148FDA
    .word def_8148FDA
...
loc_81495F4:
    ...
    cmp r1, #0x59 
    bls loc_81495F4
    ldr r0, [pc, #0x8149630-0x8149608-4] // =word_30000FA
    ldrh r0, [r0]
    cmp r3, r0
    bne loc_814963C
    mov r0, #0xc0
    lsl r0, r0, #0x12
    ldr r1, [pc, #0x8149634-0x8149614-4] // =dword_2010CC0
    ldr r1, [r1]
    mov r2, #0x5a 
    bl SWI_CpuSet
    ldr r0, [pc, #0x8149638-0x814961e-2] // =dword_2010CC4
    ldr r2, [r0]
    ldrb r1, [r2]
    mov r0, #0x80
    orr r0, r1
...
sub_814C10C:
    ...
    ldr r0, [pc, #0x814c138-0x814c120-4] // =sub_814CF54
    str r0, [r1]
...
loc_814C76C:
    ldr r2, [pc, #0x814c790-0x814c76c-4] // =dword_2010CCC
    ldr r1, [r2]
    mov r0, #1
    strb r0, [r1,#4]
    ldr r0, [r2]
...
loc_814CF7A:
    ...
    .word 0x12FFF1E
    lsl r1, r1, #9
    add.w r8, r0, r0,lsl#24
    .hword 0xE91B
dword_814CF8C:    .word 0xE12FFF1E
    add r0, #0x14
loc_814CF92:
    b loc_814CB36
...
loc_814D0A0:
    ...
    b loc_814CBBE
    mov r6, r2
    and.w r1, r0, r3,lsl#3
    add.w r0, r0, r2,lsl#2
    b loc_814D802
    lsl r5, r7, #5
    add.w r0, r0, sp,lsr#1
    and.w r0, r0, r0,lsl#12
    b loc_814CC06
    mov r2, r0
    b loc_814D778
...
loc_814D0F2:
    ...
    lsl r5, r0, #1
    lsr r0, r0, #8
    ldr r7, [pc, #0x814d254-0x814d128-4] // =0x64
loc_814D12A:
    b loc_814D86E
    orr r1, r0
loc_814D12E:
...
loc_814D4BE:
    b loc_814D042
    .hword 0x3 // mov r3, r0  // <mkdata>
    and.w r0, r0, r0,lsl#3
loc_814D4C6:
    add.w r0, r0, r4,asr#1
    b loc_814DC0E
    lsl r2, r7, #1
    add.w r0, r0, sp,lsr#1
    and.w r0, r0, r1
...
loc_814D4E2:
    ...
    mov r7, r4
    sub r0, r0, r0
    ldr r7, [pc, #0x814d628-0x814d4fc-4] // =0xF80
    b loc_814DC40+2
    orr r1, r0
    b loc_814DA0E
    sub r2, #5
...
loc_814D616:
    b loc_814D9BC
    mov r2, r0
    b SWI_LZ77UnCompReadNormalWrite8bit
    .byte 0xFC, 0xFF
loc_814D61E:
    ldrh r7, [r7,#0x16] // (dword_D8+3 - 0xc5)
loc_814D620:
    sub r2, r1, #5
    b loc_814DD66
    asr r1, r0, #0xc
...
dword_814D694:    .word 0x1AFFFFF7
    ...
    b loc_814D236
    ldr r0, [r0]
word_814D6B2:    .hword 0xE91B
    .word 0xE12FFF1E
off_814D6B8:    .word dword_2010CCC
// end of function sub_814D654
...
loc_814D7C2:
    b loc_814DB48
    ldr r0, [r6]
word_814D7C6:    .hword 0xE91B
    .byte 0x1E, 0xFF
// end of function sub_814D6BC
...
loc_814D80A:
    b loc_814DB4E
    stmia r0, {r0,r4,r5,r7}
    b loc_814DB18
    ldr r0, [r0]
    .hword 0xE91B
dword_814D814:    .word 0xE12FFF1E
    .word dword_2010CCC
// end of function sub_814D7CC
...
loc_814D89A:
    ...
    ldr r0, [r0]
    .hword 0xE91B
dword_814D8A0:    .word 0xE12FFF1E
off_814D8A4:    .word dword_2010CCC
    .word 0xE12FFF12, 0xE12FFF11, 0xE12FFF10
// end of function sub_814D81C

.thumb
SWI_CpuFastSet:
    svc 0xc  //   r0    Source address        (must be aligned by 4)
...
.thumb
SWI_CpuSet:
    svc 0xb  //   r0    Source address        (must be aligned by 4 for 32bit, by 2 for 16bit)
...
SWI_LZ77UnCompReadNormalWrite16bit:
    svc 0x12  //   r0  Source address, pointing to data as such:
       Data header (32bit)
         Bit 0-3   Reserved
...
SWI_LZ77UnCompReadNormalWrite8bit:
    svc 0x11  //   r0  Source address, pointing to data as such:
       Data header (32bit)
         Bit 0-3   Reserved
         Bit 4-7   Compressed type (must be 1 for LZ77)
         Bit 8-31  Size of decompressed data
...
.thumb
sub_814DBF4:
    .hword 0xa200 // adr r2, 0x814dbf8
    bx r2
loc_814DBF8:
    mov r1, #0x90
    b loc_814DD04
    .hword 0x0 // mov r0, r0  // <mkdata>
// end of function sub_814DBF4
...
loc_814DC88:
    ...
    beq loc_814DCE8
loc_814DC8E:
    .hword 0xa101 // adr r1, loc_814DC94
    bx r1
    .balign 4, 0x00
loc_814DC94:
    mov r2, r0
...
loc_814DD26:
    cmp r0, #0
    beq loc_814DD40
    ldr r1, [pc, #0x814dd3c-0x814dd2a-2] // =VerticalCounter_LY_
    ldrb r1, [r1]
    cmp r1, #0xa0
    bcs loc_814DD34
    add r1, #0xe4
...
loc_814DE14:
    ...
    ldr r2, [r4,#0x18]
    ldr r3, [r4,#0x28]
    .hword 0xa001 // adr r0, loc_814DE20
    bx r0
    .byte 0, 0
loc_814DE20:
    strh r0, [r0]
    b loc_814D940
    .hword 0xa00a // adr r0, loc_814DE50
    b loc_814D9D2
    add sp, sp, #0x2c
    b loc_814D9D6
    add r0, sp, #0x28
...
loc_814DF02:
    ...
    b loc_814DFAC
    .byte 0xFB, 0xFF
word_814DF1A:    .hword 0xEAFF
    asr r0, r2, #0x20
    pop.w {sp}
loc_814DF22:
    b loc_814E666
    .hword 0x3 // mov r3, r0  // <mkdata>
    and.w r0, r0, r0,lsr#8
    b sub_814DA68
    .hword 0x0 // mov r0, r0  // <mkdata>
    b loc_814E5D6
    add r0, #0xc
...
loc_814DF3E:
    ...
    b loc_814D868
    mov r6, r4
    and.w r0, r0, r0,lsr#4
word_814DF62:    .hword 0xE92D
    b loc_814DFA0
    b loc_814DA92
    asr r0, r4, #0x20
    b loc_814DA96
...
loc_814E012:
    ldr r0, [sp,#0x18]
    ldr r3, [pc, #0x814e028-0x814e014-4] // =0x68736D53
    str r3, [r0]
    add sp, sp, #0x1c
    pop {r0-r7}
    mov r8, r0
...
sub_814E8A0:
    push {r4-r6,lr}
    ldr r0, [pc, #0x814e8f4-0x814e8a2-2] // =loc_814DC88+1
    mov r1, #2
    neg r1, r1
    and r0, r1
...
loc_814F0E4:
    str r7, [r5,#0x24]
    ldr r0, [pc, #0x814f100-0x814f0e6-2] // =loc_814E260+1
    str r0, [r5,#0x20]
...
off_814F100:    .word loc_814E260+1
...
jpt_814FC28:    .word loc_814FC78  // jump table for switch statement
    .word loc_814FC7C
    .word loc_814FC84
    .word loc_814FC8C
    .word loc_814FC96
