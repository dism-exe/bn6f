...
loc_813C08C:
    ...
    tst r2, r2
    bne loc_813C0DE
    ldr r1, [pc, #0x813c140-0x813c0d0-4] // =0x35C3
    b loc_813C0DE
loc_813C0D4:
...
sub_813C334:
    ...
    beq loc_813C394
    lsr r3, r7, #2
    ldr r1, [pc, #0x813c398-0x813c346-2] // =0x813B522
    mov r2, #0xa
    mul r3, r2
    add r1, r1, r3
    add r4, r1, #0
...
sub_813C948:
    ...
    mov r0, #0
    mov r1, #0x27 
    ldr r2, [pc, #0x813c958-0x813c94e-2] // =0x2
    bl sub_801379E
    pop {pc}
    .balign 4, 0x00
...
sub_813D838:
    push {lr}
    ldr r0, [pc, #0x813d844-0x813d83a-2] // =0x2
    ldr r1, [r5,#0x1c]
    orr r1, r0
    str r1, [r5,#0x1c]
    pop {pc}
...
sub_813E07C:
    ...
    push {r0}
// memBlock
    ldr r0, [pc, #0x813e0a0-0x813e080-4] // =reqBBS_bxo_2001150
// numWords
    mov r1, #0x2c 
    bl CpuSet_ZeroFillWord
    pop {r0}
    ldr r5, [pc, #0x813e0a0-0x813e08a-2] // =reqBBS_bxo_2001150
...
reqBBS_cb_draw_813E0A4:
    ...
    mov r3, r12
    push {r1-r3}
    ldr r5, [pc, #0x813e0c4-0x813e0ae-2] // =reqBBS_bxo_2001150
    ldr r0, [pc, #0x813e0c8-0x813e0b0-4] // =reqBBS_jtDraw_813E0CC
    ldrb r1, [r5]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
...
reqBBS_jtDraw_813E0CC:    .word reqBBS_draw_813E0F8+1
...
reqBBS_draw_813E0F8:
    ...
    bl reqBBS_813E834
    bl reqBBS_813E890
.endfunc // reqBBS_draw_813E0F8

    bl reqBBS_uncomp_813E5A0
    ldrh r0, [r5,#0x24]
    bl sub_813E8CC
    bl sub_813EEF4
    mov r7, r10
...
reqBBS_init_s_2005780:
    ...
    push {r0}
// memBlock
    ldr r0, [pc, #0x813f400-0x813f3c4-4] // =sReqBBS_GUI
...
// numWords
    ...
    bl CpuSet_ZeroFillWord
    pop {r1-r3}
    ldr r0, [pc, #0x813f400-0x813f3dc-4] // =sReqBBS_GUI
    ...
    strb r3, [r0,r4]
    pop {r0}
    ldr r5, [pc, #0x813f400-0x813f3ec-4] // =sReqBBS_GUI
...
reqBBS_cb_813F404:
    ...
    mov r3, r12
    push {r1-r3}
    ldr r5, [pc, #0x813f424-0x813f40e-2] // =sReqBBS_GUI
    ldr r0, [pc, #0x813f428-0x813f410-4] // =jt_813F42C
    ldrb r1, [r5]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
...
sub_813F474:
    ...
    bl sub_802F164
    beq loc_813F4B6
    ldr r0, [pc, #0x813f548-0x813f480-4] // =sReqBBS_GUI
    ...
    bl zf_802F168
    beq loc_813F4B6
    ldr r0, [pc, #0x813f548-0x813f494-4] // =sReqBBS_GUI
    ...
    mov r1, #0x3a 
    bl sub_802F12C
    ldr r0, [pc, #0x813f548-0x813f4ae-2] // =sReqBBS_GUI
...
.endfunc // sub_813F474
    ...
    mov r1, #0x10
    bl engine_setScreeneffect
    ldr r0, [pc, #0x813f534-0x813f4f6-2] // =reqBBS_entriesGfx
    bl sub_80465A0
    ldrh r0, [r5,#0x1e]
    cmp r0, #0
    beq loc_813F508
...
loc_813FB40:
    ...
    ldr r1, [pc, #0x813fda4-0x813fb54-4] // =sReqBBS_GUI
...
// <mkdata>
    ...
    add r1, #3
    mov r2, #2
    ldr r3, [pc, #0x81400c4-0x814007e-2] // =pt_81400C8
    ldr r3, [r3,r4]
    mov r4, #2
    mov r5, #2
    bl drawTiles
...
loc_81400A6:
    ...
    mov r1, #0
    mov r2, #2
    ldr r3, [pc, #0x81400c4-0x81400b2-2] // =pt_81400C8
    ldr r3, [r3,r4]
    mov r4, #2
    mov r5, #2
    bl drawTiles
...
sub_814030C:
    push {r4-r7,lr}
    ldr r0, [pc, #0x8140344-0x814030e-2] // =sReqBBS_GUI
...
.endfunc // sub_8140414
    ...
    ldr r2, [pc, #0x8140480-0x814045a-2] // =0xD
    ldrb r1, [r5,r2]
...
reqBBS_setChatboxHeaderBasedOn_0F:
    push {r4-r7,lr}
    ldr r0, [pc, #0x8140550-0x814051e-2] // =sReqBBS_GUI
...
reqBBS_getTotalPointsIndex:
    push {r4-r7,lr}
    ldr r0, [pc, #0x81409a4-0x814079a-2] // =sReqBBS_GUI
...
reqBBS_81407A8:
    push {r4-r7,lr}
    ldr r1, [pc, #0x81409a8-0x81407aa-2] // =sReqBBS_GUI
...
reqBBS_81407B8:
    push {r4-r7,lr}
    ldr r0, [pc, #0x81409ac-0x81407ba-2] // =sReqBBS_GUI
    ldr r1, [pc, #0x81407c4-0x81407bc-4] // =0xD
    ldrb r0, [r0,r1]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
reqBBS_81407C8:
    push {r4-r7,lr}
    ldr r1, [pc, #0x81409b0-0x81407ca-2] // =sReqBBS_GUI
    ldr r2, [pc, #0x81407d4-0x81407cc-4] // =0xD
    strb r0, [r1,r2]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
reqBBS_81407D8:
    ...
    bl sub_802F164
    beq loc_8140814
    ldr r0, [pc, #0x81409b4-0x81407e4-4] // =sReqBBS_GUI
    ldr r1, [pc, #0x8140820-0x81407e6-2] // =0xF
    ldrb r0, [r0,r1]
    bl reqBBS_814084C
    tst r0, r0
    beq loc_8140814
    ldr r0, [pc, #0x81409b8-0x81407f2-2] // =sReqBBS_GUI
    ldr r1, [pc, #0x8140818-0x81407f4-4] // =0xD
    ...
    bgt loc_8140814
    add r2, #1
    ldr r0, [pc, #0x81409bc-0x814080a-2] // =sReqBBS_GUI
...
reqBBS_81408DC:
    push {r4-r7,lr}
    bl reqBBS_81408C8
    ldr r1, [pc, #0x81409c4-0x81408e2-2] // =sReqBBS_GUI
...
reqBBS_8140974:
    push {r4-r7,lr}
    ldr r0, [pc, #0x81409c8-0x8140976-2] // =sReqBBS_GUI
...
reqBBS_8140984:
    push {r4-r7,lr}
    ldr r0, [pc, #0x81409cc-0x8140986-2] // =sReqBBS_GUI
    mov r1, #0
    ldr r2, [pc, #0x8140998-0x814098a-2] // =0xD
    strb r1, [r0,r2]
...
loc_8143CA0:
    ...
    ldr r0, [r4,#4]
    str r0, [r1]
    ldr r0, [pc, #0x8143d48-0x8143cb2-2] // =0x16F1
    ldrb r1, [r4]
    sub r1, #1
    add r0, r0, r1
// <mkdata>
...
loc_8143CE0:
    ...
    mov r0, #0
    str r0, [r1]
    ldr r0, [pc, #0x8143d48-0x8143cf2-2] // =0x16F1
    ldrb r1, [r4]
    sub r1, #1
    add r0, r0, r1
// <mkdata>
...
sub_81444E4:
    ...
    ldr r3, [pc, #0x8144550-0x81444fe-2] // =0x995
    add r0, r1, r3
    ldrb r0, [r0]
    add r7, r1, #0
    cmp r0, #0
...
loc_81445A0:
    ...
    bls loc_8144564
    add r2, r7, #0
    ldr r3, [pc, #0x81445e8-0x81445aa-2] // =0x995
    add r1, r2, r3
    ldrb r0, [r1]
    sub r0, #1
    mov r3, #0
...
loc_8144714:
    ...
    ldr r2, [pc, #0x8144748-0x814472c-4] // =0x995
    add r1, r3, r2
    ldrb r1, [r1]
    strb r1, [r0]
loc_8144734:
...
loc_81449E0:
    ...
    add r1, r3, r2
    ldr r7, [pc, #0x8144a58-0x81449e4-4] // =0x995
    add r0, r3, r7
    ldrb r2, [r0]
    ldrb r1, [r1]
    add r0, r2, r1
...
loc_8144ABC:
    ...
    cmp r0, #0
    beq loc_8144AE4
    ldr r1, [pc, #0x8144af8-0x8144ad6-2] // =0x995
    add r0, r3, r1
    ldrb r1, [r0]
    add r1, #1
    strb r1, [r0]
...
dword_8144C70:    .word 0xEFFF
    ...
    ldr r2, [pc, #0x8144cd4-0x8144c78-4] // =0x995
    add r0, r1, r2
    mov r2, #0
    strb r2, [r0]
...
loc_814AC52:
    ...
    cmp r0, #0
    beq loc_814AC60
    ldr r0, [pc, #0x814ac5c-0x814ac58-4] // =0x402
    b loc_814ADD6
...
loc_814AEB8:
    ...
    beq loc_814AEE0
loc_814AECE:
    ldr r0, [pc, #0x814aedc-0x814aece-2] // =0x403
    b loc_814AF4C
    .balign 4, 0x00
...
loc_814AFEC:
    ...
    cmp r1, r0
    beq loc_814B00C
    ldr r0, [pc, #0x814b008-0x814affc-4] // =0x403
    b loc_814B060
...
sub_814BAF4:
    ...
    mov r0, #0x49 
    strh r0, [r3,#0xc]
    ldr r0, [pc, #0x814bb2c-0x814bb22-2] // =0x701
    strh r0, [r5,#2]
    b loc_814BB7E
...
loc_814BB30:
    ...
    cmp r0, #0
    beq loc_814BB54
    ldr r0, [pc, #0x814bb44-0x814bb3c-4] // =0x709
    strh r0, [r5,#2]
    b loc_814BB7E
    .balign 4, 0x00
...
loc_814BF38:
    ...
    mov r0, #0x49 
    strh r0, [r2]
    ldr r0, [pc, #0x814bf68-0x814bf54-4] // =0x702
    strh r0, [r2,#0x18]
...
loc_814BFC4:
    ...
    bic r0, r1
    strb r0, [r2,#5]
    ldr r0, [pc, #0x814c014-0x814bff2-2] // =0x701
    strh r0, [r4,#0x18]
    mov r0, #0x47 
    strh r0, [r4]
    add r0, r5, #0
...
loc_814CF1A:
    mov r0, #0
    ldr r1, [pc, #0x814cf4c-0x814cf1c-4] // =0x257
loc_814CF1E:
    add r0, #1
    lsl r0, r0, #0x10
    lsr r0, r0, #0x10
...
loc_814F8A0:
    ...
    ldr r0, [r4,#0x20]
    add r0, #1
    ldr r1, [pc, #0x814f8b8-0x814f8a8-4] // =0x7FE
loc_814F8AA:
    and r0, r1
    str r0, [r4,#0x20]
loc_814F8AE:
