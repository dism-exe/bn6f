...
triggerSomeUpdateForInternetOrRealWorld_8033948:
	push {r4-r7,lr}
	...
	bge .internet_8033964

  // trigger onUpdateInRealWorld_8033A96 via dispatch_80339CC
	mov r7, #1
	strb r7, [r5,#oS2011E30_Idx_04]
...
.internet_8033964:
	...
	strh r0, [r5,#oS2011E30_CurPETNaviMaxHP]

  // trigger onUpdateInInternet_8033B1E via dispatch_80339CC
	mov r0, #1
...
locret_8033A16:
	...
	.balign 4, 0
off_8033A18:
	.word JumpTable8033A1C
JumpTable8033A1C:
	.word noop_8033A7C+1 // (self: *const S2011E30 $r5) -> ()
	.word sub_8033A80+1 // (self: * S2011E30 $r5) -> ()
	.word onUpdateInRealWorld_8033A96+1 // (self: * S2011E30 $r5) -> ()
	...
	.word sub_8033A80+1 // (self: * S2011E30 $r5) -> ()
off_8033A48:
	.word JumpTableInternet8033A4C
JumpTableInternet8033A4C:
	.word noop_8033B08+1 // (self: * S2011E30 $r5) -> ()
	.word sub_8033B0C+1 // (self: * S2011E30 $r5) -> ()
	.word onUpdateInInternet_8033B1E+1 // (self: * S2011E30 $r5) -> ()
...
off_8033CC0:
	.word byte_8033CC4
byte_8033CC4:
	.byte 0x0, 0x0, 0x0, 0x20, 0x20, 0x20, 0x0, 0x0, 0x0, 0x20, 0x20, 0x20
...
off_8033F4C:
	.word byte_8033F50
byte_8033F50:
	.byte 0x80, 0xE2, 0x82, 0xE2, 0x84, 0xE2, 0x86, 0xE2, 0x88
...
off_8033FB0:
	.word byte_8033FB4
byte_8033FB4:
	.byte 0x6, 0x0, 0x24, 0x40, 0x0, 0x0, 0x30, 0x40
dword_8033FBC:
	.word 0xC7AC
...
a1:
	.word byte_8034370
byte_8034370:
	.byte 0x39, 0x0, 0x0, 0x0, 0x39, 0x1, 0x1, 0x0, 0x39, 0x2, 0x2, 0x0, 0x39
...
off_8034728:
	...
	.word off_807F21C
// JP 0x8035740
UnkInternetMapGroupJumptable_8034784:
	.word RobotControlComp_UnkFunction_806651c+1
...
byte_80349CC:
	...
	gfx_anim_data data=0x80003180 delay=0x0000001E
	gfx_anim_data data=0x800035A0 delay=0x0000001E
	gfx_anim_data data=0x800039C0 delay=0x0000001E
	gfx_anim_data data=0x80003DE0 delay=0x0000001E
	gfx_anim_data data=0x80004200 delay=0x0000001E
	gfx_anim_data data=0x80003DE0 delay=0x0000001E
	gfx_anim_data data=0x800039C0 delay=0x0000001E
	gfx_anim_data data=0x800035A0 delay=0x0000001E
	gfx_anim_loop
...
byte_8034A1C:
	gfx_anim_manual_pal_transform transform_type=0x00000004 ptr5=iPallete3001750 index=0x0D num_pals=0x0A
...
byte_8034A6C:
	gfx_anim_manual_pal_transform transform_type=0x00000004 ptr5=iPalette3001B60 index=0x0C num_pals=0x0D
	gfx_anim_data data=0x800039C0 delay=0x00000004
	gfx_anim_data data=0x80003180 delay=0x00000004
	gfx_anim_data data=0x80002940 delay=0x00000004
	gfx_anim_data data=0x80002100 delay=0x00000004
	gfx_anim_data data=0x800018C0 delay=0x00000004
	gfx_anim_data data=0x80001080 delay=0x00000004
	gfx_anim_data data=0x80000840 delay=0x00000004
	gfx_anim_data data=0x80000000 delay=0x00000004
	gfx_anim_end

byte_8034ABC:
	gfx_anim_manual_pal_transform transform_type=0x00000004 ptr5=iPallete3001750 index=0x0D num_pals=0x0A
	gfx_anim_data data=0x800014A0 delay=0x00000004
	gfx_anim_data data=0x80001080 delay=0x00000004
	gfx_anim_data data=0x80000C60 delay=0x00000004
	gfx_anim_data data=0x80000840 delay=0x00000004
	gfx_anim_data data=0x80000420 delay=0x00000004
	gfx_anim_data data=0x80000000 delay=0x00000004
	gfx_anim_end

byte_8034AFC:
	gfx_anim_manual_pal_transform transform_type=0x00000004 ptr5=iPalette3001B60 index=0x08 num_pals=0x01
	gfx_anim_data data=0x80003180 delay=0x0000001E
	gfx_anim_data data=0x800035A0 delay=0x0000001E
	gfx_anim_data data=0x800039C0 delay=0x0000001E
	gfx_anim_data data=0x80003DE0 delay=0x0000001E
...
endif_8034B8A:
  ...
  // *8 because each is a tuple of two pointers
	...
	.balign 4, 0
off_8034BAC:
	.word RealWorldMapScriptPointers // [*const [*const [*const MapScript]; 2]; REAL_WORLD_NUM_GROUPS]
off_8034BB0:
	.word InternetMapScriptPointers // [*const [*const [*const MapScript]; 2]; INTERNET_NUM_GROUPS]
off_8034BB4:
	.word unk_2011EA0
...
loc_8034CF6:
	...
	lsl r4, r4, #8
	orr r1, r4
	ldr r0, off_8034D60 // =CutsceneScriptJackIn_8098824 // CutsceneScript
...
loc_8034D44:
	...
	b loc_8034D52
loc_8034D4C:
	ldr r0, off_8034D64 // =CutsceneScriptAskJackOut_80988E4 // CutsceneScript
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
loc_8034D52:
	mov r0, #1
	pop {r4-r7,pc}
...
off_8034D5C:
	.word 0x100
off_8034D60:
	.word CutsceneScriptJackIn_8098824 // CutsceneScript
off_8034D64:
...
dword_8034D6C:
	.word 0x602
byte_8034D70:
	.byte 0x0, 0x0, 0xC, 0x0, 0xFF, 0x0, 0x0, 0x0, 0xFF, 0x0, 0x0, 0x0
...
sub_8034D7C:
	...
	bl TestEventFlagFromImmediate // (flag: u16) -> !zf
	bne loc_8034DA4
	ldr r0, off_8034DAC // =CutsceneScriptLMessage_80991F4 // CutsceneScript
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
	mov r0, #0
	pop {r4-r7,pc}
loc_8034DA4:
...
off_8034E28:
	.word eS200AC80
off_8034E2C:
	.word byte_8099EA0 // CutsceneScript
off_8034E30:
	.word byte_809A8A8 // CutsceneScript
off_8034E34:
	.word byte_809AA34 // CutsceneScript
off_8034E38:
	.word byte_809CAD8 // CutsceneScript
...
dword_8034E70:
	.word 0xFFFF
byte_8034E74:
	.byte 0x1, 0x4, 0x5, 0x1, 0x0, 0x0, 0x4, 0x0, 0x93, 0x1, 0x91, 0x0
dword_8034E80:
	.word 0xFFFF0401
dword_8034E84:
	.word 0xFFFF0401
...
off_8034EDC:
	...
	.word byte_8034EEF
byte_8034EE8:
	.byte 0xF7, 0xFB, 0xF8, 0xF8, 0xF4, 0xF4
byte_8034EEE:
	.byte 0xF9
byte_8034EEF:
	.byte 0xF8
...
.gotCoordInteractionTextIndices
	...
	cmp r1, #0xff
	beq .done
	ldr r0, off_8034F64 // =CutsceneScriptObjectInteract_8098358 // CutsceneScript
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
.done
	pop {r4-r7,pc}
	.balign 4, 0
...
off_8034F60:
	.word off_8034728
off_8034F64:
	.word CutsceneScriptObjectInteract_8098358 // CutsceneScript
...
sub_8034F68:
	...
	tst r0, r0
	beq locret_8034FA8
	ldr r0, off_8034FB0 // =CutsceneScriptEntranceInteract_8098384 // CutsceneScript
	ldr r1, [r3]
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
locret_8034FA8:
	pop {r4-r7,pc}
...
off_8034FAC:
	.word EVENT_16F0
off_8034FB0:
	.word CutsceneScriptEntranceInteract_8098384 // CutsceneScript
off_8034FB4:
	.word unk_2011EA0
...
loc_8034FCE:
	...
	bl IsCutsceneScriptNonNull // () -> !zf
	bne loc_8035004
	ldr r4, off_8035020 // =CutsceneScriptOnMapEnterAfterJackIn_809895C // CutsceneScript
	movflag EVENT_127
	bl TestEventFlagFromImmediate // (flag: u16) -> !zf
	beq loc_8034FEC
...
loc_8035004:
	...
	.balign 4, 0
off_8035020:
	.word CutsceneScriptOnMapEnterAfterJackIn_809895C // CutsceneScript
off_8035024:
	.word byte_80989C1 // CutsceneScript
...
locret_803504C:
	...
	.balign 4, 0
off_8035050:
	.word UnkInternetMapGroupJumptable_8034784
...
sub_8035054:
	...
	bl TestEventFlagFromImmediate // (flag: u16) -> !zf
	beq loc_803507A
	ldr r0, off_8035080 // =CutsceneScriptNotification_809AE68 // CutsceneScript
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
	mov r0, #0
	pop {r4-r7,pc}
loc_803507A:
	...
	.balign 4, 0
off_8035080:
	.word CutsceneScriptNotification_809AE68 // CutsceneScript
...
sub_8035084:
	...
	beq loc_803509E
	mov r1, r0
	ldr r0, off_80350A4 // =CutsceneScriptNotification_8098BB8 // CutsceneScript
	bl StartCutscene // (script: *const CutsceneScript, param: u32) -> ()
	mov r0, #0
	pop {r4-r7,pc}
loc_803509E:
	...
	.balign 4, 0
off_80350A4:
	.word CutsceneScriptNotification_8098BB8 // CutsceneScript
...
loc_8035126:
	...
	.balign 4, 0
off_803512C:
	.word byte_8099DC0 // CutsceneScript
off_8035130:
	.word byte_8099E04 // CutsceneScript
...
off_8035308:
	.word byte_803530C
byte_803530C:
	.byte 0x1, 0x0, 0xFF, 0x1, 0x2, 0x0, 0xFF, 0x1, 0x3, 0x0, 0xFF, 0x1, 0x4, 0x0
...
off_8035464:
	...
	.word byte_80354D4
byte_803546C:
	.byte 0x5, 0x8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x32
	...
	.byte 0x0, 0x0
byte_80354D4:
	.byte 0x5, 0x8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x42
...
off_80357EC:
	.word byte_80357F0
byte_80357F0:
	.byte 0x3C, 0x3D, 0x3E, 0x3F, 0x10, 0x11, 0x12, 0x13, 0x14
