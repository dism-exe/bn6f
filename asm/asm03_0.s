...
sub_802B060:
    push {lr}
    ldr r0, off_802B06C // =dword_802B070 
    bl sub_8000B30
    pop {pc}
    .balign 4, 0x00
...
jt_802F560:    .word sub_802F574+1
    .word sub_802F60C+1
    .word sub_802F63C+1
    .word sub_802F756+1
off_802F570:    .word sStartScr
.endfunc // Load_cb_802F544
...
sub_802F574:
    ...
    bl engine_setScreeneffect
    bl sub_8000784
    ldr r0, off_802F5EC // =off_802F5F0 
    bl sub_8002354
    mov r0, #4
    strb r0, [r5]
    mov r0, #0
...
sub_802F63C:
    push {lr}
    ldr r0, off_802F650 // =off_802F654 
    ldrb r1, [r5,#1]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
...
off_802FE34:    .word loc_30068E8+1
    push {r4,lr}
    ldr r4, off_802FE44 // =loc_3006920+1 
    mov lr, pc
    bx r4
    pop {r4,pc}
    .balign 4, 0x00
...
sub_8033978:
    ...
    pop {r4-r7,pc}
loc_8033998:
    ldr r0, off_80339C0 // =dword_86C1F80 
    ldr r1, dword_80339B4 // =0x6017200 
...
sub_8034218:
    push {lr}
    ldr r0, off_803422C // =off_8034230 
    ldrb r1, [r5,#1]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
...
sub_8035134:
    ...
    cmp r0, #0x80
    bge loc_8035150
    ldr r2, off_8035164 // =off_8034638 
    b loc_8035154
loc_8035150:
    ldr r2, off_8035168 // =off_80347E0 
    sub r0, #0x80
loc_8035154:
    lsl r0, r0, #2
    lsl r1, r1, #2
...
sub_803BB2C:
    ...
    bl chatbox_runScript_CpuSet_803FE74 // (u16 *scriptArr, u8 scriptID) -> void
    b locret_803BB64
loc_803BB4A:
