...
sub_8026622:
    ...
    cmp r1, r3
    bne loc_8026630
    ldr r2, [pc, #0x80267f0-0x802662e-2] // =0x802673A
loc_8026630:
...
loc_80268AC:
    ldr r0, [pc, #0x80269b0-0x80268ac-4] // =0xFFF
    and r0, r2
    ldrb r2, [r6,#4]
    lsl r2, r2, #0xc
    orr r2, r0
...
loc_802694C:
    ...
    mov r1, #4
loc_802696E:
    ldr r0, [pc, #0x80269b4-0x802696e-2] // =0x1FF
    push {r1}
    bl sub_80281D4
    ldr r0, [sp]
    mov r1, #0
...
loc_802748E:
    ...
    sub r1, #1
    strb r1, [r5,#8]
    ldr r0, [pc, #0x8027504-0x80274ae-2] // =0x1FF
    bl sub_80281D4
    ldrb r0, [r5,#8]
    mov r1, #0
    mov r2, #0
...
loc_8027884:
    ldr r0, [pc, #0x8027908-0x8027884-4] // =0xFFF
    and r0, r2
    ldrb r2, [r6,#4]
    lsl r2, r2, #0xc
    orr r2, r0
...
loc_802796A:
    ...
    bne loc_802798A
    mov r2, #0
    ldr r1, [pc, #0x80279c4-0x8027972-2] // =0x55
    add r1, r1, r4
    ldrb r0, [r5,r1]
    cmp r0, #0
    beq loc_802797E
...
loc_8027A0E:
    ldr r0, [pc, #0x8027a54-0x8027a0e-2] // =0xFFF
    and r0, r2
    ldrb r2, [r6,#4]
    lsl r2, r2, #0xc
    orr r2, r0
...
sub_80281A8:
    push {r1,r2,lr}
    ldr r2, [pc, #0x80283ac-0x80281aa-2] // =0x1FF
    and r0, r2
    cmp r0, r2
    bne loc_80281B6
...
sub_8028238:
    ...
    add r1, r1, r0
    ldr r0, [pc, #0x80283ac-0x8028242-2] // =0x1FF
    bl sub_80281C4
    pop {pc}
    .balign 4, 0x00
...
sub_8028284:
    ...
    cmp r0, #2
    bne loc_8028290
    ldr r0, [pc, #0x80283ac-0x802828c-4] // =0x1FF
    b loc_8028298
loc_8028290:
    ldr r0, [r4,#8]
    ldrh r0, [r0]
...
sub_80282E8:
    ...
    cmp r0, #2
    bne loc_80282F4
    ldr r0, [pc, #0x80283ac-0x80282f0-4] // =0x1FF
    b loc_80282FC
loc_80282F4:
    ldr r0, [r4,#8]
    ldrh r0, [r0]
...
sub_8028310:
    push {lr}
    ldr r0, [pc, #0x80283ac-0x8028312-2] // =0x1FF
    bl sub_80281C4
    mov r0, #0x1d
    bl sub_8028204
    pop {pc}
...
loc_8028400:
    ...
    ldrh r2, [r1,r2]
    ldr r1, [pc, #0x8028464-0x802840a-2] // =0x3FF
    ldrh r0, [r4]
    and r0, r1
    orr r0, r2
    strh r0, [r4]
...
.endfunc // sub_80284E2
    ...
    pop {r0-r7}
    ldr r0, [sp]
    ldr r1, [pc, #0x8028688-0x8028502-2] // =0x1FF
    and r0, r1
    push {r0}
    mov r1, r10
    ldr r1, [r1,#0x18]
...
.endfunc // sub_80285FE
    ...
    pop {r0-r7}
    ldr r1, [pc, #0x8028688-0x8028618-4] // =0x1FF
    and r0, r1
    bl sub_8021AA4
    add r4, r0, #0
    ldr r0, [r0,#0x24]
...
loc_8028ABA:
    ...
    bne locret_8028B66
    add r0, r4, #0
    ldr r1, [pc, #0x8028b70-0x8028acc-4] // =0x55
    add r1, r1, r0
    ldrb r0, [r5,r1]
    cmp r0, #1
    beq loc_8028AF8
...
loc_8029048:
    ldrb r0, [r5,#0x1b]
    ldr r1, [pc, #0x802910c-0x802904a-2] // =0x55
    add r1, r1, r0
    mov r0, #0
    strb r0, [r5,r1]
    mov r0, #0
...
loc_8029066:
    ...
    sub r1, #1
    strb r1, [r5,#8]
    ldr r0, [pc, #0x8029108-0x802907c-4] // =0x1FF
    bl sub_80281D4
    ldrb r0, [r5,#8]
    mov r1, #0
    mov r2, #0
...
loc_80290C2:
    ...
    sub r1, #1
    strb r1, [r5,#8]
    ldr r0, [pc, #0x8029108-0x80290c8-4] // =0x1FF
    bl sub_80281D4
    ldrb r0, [r5,#8]
    mov r1, #0
    mov r2, #0
...
sub_80293B0:
    ...
    ldrh r0, [r5,#0x3a]
    sub r0, #1
    ldr r1, [pc, #0x80293f0-0x80293b6-2] // =0xD
    add r0, r0, r1
    mov r1, #0
    mov r2, #3
    bl sub_8015952
...
loc_8029C22:
    mov r0, #0x57 
    sub r0, r0, r1
    ldr r1, [pc, #0x8029ca4-0x8029c26-2] // =0x1FF
    and r0, r1
    lsl r0, r0, #0x10
...
// <mkdata>
    ...
    add r2, r2, r6
    strb r4, [r5,r2]
    ldr r2, [pc, #0x8029f64-0x8029f32-2] // =0x55
    add r2, r2, r6
    mov r3, #0
    strb r3, [r5,r2]
    add r6, #1
...
sub_802A034:
    push {r1-r7,lr}
    ldr r0, [pc, #0x802a03c-0x802a036-2] // =0x13F
    pop {r1-r7,pc}
    .balign 4, 0x00
...
sub_802A0C8:
    push {lr}
    sub r0, #1
    ldr r1, [pc, #0x802a0e8-0x802a0cc-4] // =0xD
    add r0, r0, r1
    push {r5}
...
sub_802A53C:
    ...
    pop {r1-r7,pc}
loc_802A54A:
    ldr r0, [pc, #0x802a560-0x802a54a-2] // =0x3785
    pop {r1-r7,pc}
.endfunc // sub_802A53C
...
sub_802A54E:
    ...
    pop {r1-r7,pc}
loc_802A55C:
    ldr r0, [pc, #0x802a560-0x802a55c-4] // =0x3785
    pop {r1-r7,pc}
...
// <mkdata>
    ...
    bl zf_802F168
    beq loc_802B2CE
    ldr r1, [pc, #0x802b354-0x802b2c0-4] // =0x197
...
sub_802C0A4:
    ...
    push {r0-r2,r4,r6,r7}
    add r4, r1, #0
    ldr r1, [pc, #0x802c16c-0x802c0d0-4] // =0x136
    cmp r0, r1
    bgt loc_802C0E2
    bl sub_8021AA4
    ldr r1, [r0]
...
sub_802CA5C:
    ...
    lsl r0, r0, #3
    add r0, #0xd
    ldr r1, [pc, #0x802cb28-0x802ca66-2] // =0x1FF
    and r0, r1
    lsl r0, r0, #0x10
    add r0, #0x15
...
loc_802CC04:
    ...
    lsl r0, r0, #0x10
    lsr r0, r0, #0x10
    ldr r1, [pc, #0x802cc4c-0x802cc2e-2] // =0x270E
    svc 6
    strh r1, [r5,#0xc]
    lsr r0, r4, #0x10
    ldr r1, [pc, #0x802cc4c-0x802cc36-2] // =0x270E
    svc 6
    strh r1, [r5,#0xe]
    b loc_802CC42
loc_802CC3E:
...
loc_802CF30:
    ...
    cmp r0, #0xbb
    beq loc_802CF56
    ldr r1, [pc, #0x802d03c-0x802cf3e-2] // =0x157
    cmp r0, r1
    beq loc_802CF56
    push {r0}
    bl sub_801032C
...
.endfunc // sub_802D08C
    ...
    mov r3, #1
    eor r3, r0
    ldr r1, [pc, #0x802d218-0x802d0f4-4] // =0x17F
    ldr r2, [pc, #0x802d218-0x802d0f6-2] // =0x17F
    add r0, sp, #0
...
loc_802D524:
    ...
    strh r1, [r7,#0xa]
    ldrh r0, [r7,#0x14]
    ldr r1, [pc, #0x802d634-0x802d54a-2] // =0x153
    cmp r0, r1
    bne loc_802D55A
    mov r0, #0x52 
    bl sub_8021AA4
...
sub_802D65E:
    ...
    bl sub_802F164
    beq locret_802D68A
    ldr r1, [pc, #0x802d69c-0x802d66c-4] // =0x196
    add r1, r1, r4
    add r0, r1, #0
    bl zf_802F168
    bne locret_802D68A
...
sub_802D738:
    ...
    strb r0, [r5,#0x17]
    bl sub_800F2C6
    ldr r0, [pc, #0x802d798-0x802d762-2] // =0x1C41
    bl object_clearFlag
...
sub_802D950:
    ...
    strb r0, [r5,#0x17]
    bl sub_800F2C6
    ldr r0, [pc, #0x802dcb4-0x802d97a-2] // =0x1C41
    bl object_clearFlag
    mov r1, #0x10
    bl sub_801A176
    mov r0, #4
...
sub_802DACC:
    ...
    bl sub_801BB1C
    bl sub_801A074
    ldr r0, [pc, #0x802dcb4-0x802db0c-4] // =0x1C41
    bl object_clearFlag
    mov r1, #0x10
    bl sub_801A176
    mov r0, #2
...
.thumb_func
sub_802E1B4:
    ldr r2, [pc, #0x802e230-0x802e1b4-4] // =0x139
    cmp r0, r2
    ble locret_802E1BC
    mov r0, #0
locret_802E1BC:
...
loc_802E2D8:
    ...
    bl sub_802E558
    str r1, [sp]
    ldr r1, [pc, #0x802e428-0x802e2e0-4] // =0x1FF
    and r0, r1
    strh r0, [r7,#0x24]
    bl battle_isPaused
    tst r0, r0
...
sub_802F0D8:
    push {lr}
    ldr r0, [pc, #0x802f0ec-0x802f0da-2] // =0x2DE
    mov r1, r10
    ldr r1, [r1,#0x44]
    add r0, r0, r1
    ldr r1, [pc, #0x802f0f0-0x802f0e2-2] // =0x2
    bl sub_80008C0
    pop {pc}
    .balign 4, 0x00
...
sub_802F624:
    push {lr}
    ldr r0, [pc, #0x802f638-0x802f626-2] // =0x1741
    bl sub_8001778
    mov r0, #8
    strb r0, [r5]
    mov r0, #0
...
sub_802F668:
    ...
    strb r0, [r5,#0xe]
    strb r0, [r5,#0xf]
    ldr r0, [pc, #0x802f69c-0x802f670-4] // =0xA46
    strh r0, [r5,#4]
    mov r0, #1
    bl sub_80005F2
    mov r0, #0xa
...
loc_802F6E0:
    ldrh r0, [r5,#4]
    ldr r1, [pc, #0x802f700-0x802f6e2-2] // =0xA0A
    cmp r0, r1
    bge locret_802F6FA
    bl sub_803E928
    bne locret_802F6FA
...
loc_8031ABC:
    ...
    bgt loc_8031AFC
    push {r0-r2}
    ldr r1, [pc, #0x8031b78-0x8031ae4-4] // =0x16EF
    add r0, r0, r1
// <mkdata>
    .hword 0x1c00 // add r0, r0, #0
    bl zf_802F168
...
sub_8034268:
    ...
    bl sub_800183C
    bl sub_8034314
    ldr r0, [pc, #0x803429c-0x803427c-4] // =0x1341
    bl sub_8001778
...
loc_8034FCE:
    ...
    bl sub_802F164
    beq loc_8034FEC
    ldr r4, [pc, #0x8035024-0x8034fea-2] // =0x80989C1
loc_8034FEC:
    add r0, r4, #0
    bl sub_8036E90
    mov r0, #0x17
...
sub_8038A9C:
    push {lr}
    bl sub_8000EE4
    ldr r2, [pc, #0x8038acc-0x8038aa2-2] // =0xF6
    and r1, r2
    cmp r1, r2
    bne loc_8038ABC
// memBlock
...
sub_8038D94:
    ...
    strh r0, [r5,#4]
    bne locret_8038DAA
    ldr r0, [pc, #0x8038dac-0x8038d9e-2] // =0x99
    strh r0, [r5,#4]
    mov r0, #0x18
    strb r0, [r5,#2]
    bl sub_80468BA
...
sub_8038E14:
    ...
    mov r0, #0x28 
    strb r0, [r5,#2]
    ldr r0, [pc, #0x8038e44-0x8038e36-2] // =0xD6
    strh r0, [r5,#4]
locret_8038E3A:
    pop {pc}
...
sub_8038E5C:
    ...
    bne locret_8038E72
    bl sub_80390F8
    ldr r0, [pc, #0x8038e74-0x8038e6a-2] // =0x2D
    strh r0, [r5,#4]
    mov r0, #0x30 
    strb r0, [r5,#2]
locret_8038E72:
...
loc_8038EE6:
    ...
    ldr r0, [r0,#4]
    ldrh r0, [r0,#2]
    ldr r1, [pc, #0x8038f08-0x8038eec-4] // =0x3FF
    tst r0, r1
    beq loc_8038EFE
    mov r0, #0xc
    mov r1, #8
...
sub_8039024:
    push {r4,lr}
    ldr r2, [pc, #0x8039050-0x8039026-2] // =0x607
    mov r0, #0x3a 
    mov r1, #0
    bl sub_8046670
    mov r4, #4
...
loc_80390FC:
    ...
    mov r0, #0x3a 
    mov r1, #0xc
    ldr r2, [pc, #0x8039168-0x803912a-2] // =0x50D
    bl sub_8046670
loc_8039130:
    sub r4, #1
    bge loc_80390FC
...
sub_803916C:
    push {lr}
    ldr r2, [pc, #0x803917c-0x803916e-2] // =0xB
    mov r0, #0x3a 
    mov r1, #6
    bl sub_8046670
    pop {pc}
...
.endfunc // sub_803BA00
    ...
    orr r0, r1
    ldr r1, [pc, #0x803ba24-0x803ba14-4] // =0x41E
    mov r2, #2
    mov r3, #7
    bl sub_802FE28
    pop {r4-r7,pc}
...
sub_803C398:
    ...
    ldr r1, [pc, #0x803c3d4-0x803c39a-2] // =0x3E7
...
sub_803C3B6:
    ...
    ldr r1, [pc, #0x803c3d4-0x803c3b8-4] // =0x3E7
    ldrh r2, [r3,#0x4] // (word_2006774 - 0x2006770)
    add r2, #1
    cmp r2, r1
    ble loc_803C3C4
...
sub_803C730:
    ...
    strh r0, [r7,#0xa]
    bne loc_803C74A
    ldr r0, [pc, #0x803c750-0x803c73a-2] // =0x9
    bl sub_813D9A0
    mov r0, #0
    strb r0, [r7]
    mov r0, #1
...
sub_803C754:
    push {lr}
    ldr r0, [pc, #0x803c768-0x803c756-2] // =0x32
    bl sub_813D9A0
    mov r0, #0
    strb r0, [r7]
    mov r0, #1
...
sub_803C94C:
    ...
    bl sub_800A7D0
    bne loc_803C966
    ldr r0, [pc, #0x803c978-0x803c954-4] // =0x1
    bl sub_813D9A0
    mov r0, #0
    bl sub_813D934
    mov r0, #1
...
sub_803D080:
    ...
    ldr r2, [r2,#0x3c]
    ldr r1, [r2,#0x60]
    ldr r4, [pc, #0x803d0b0-0x803d08e-2] // =0x270F
    mov r3, #1
    cmp r1, r4
    beq loc_803D0A2
    mov r3, #0
...
loc_803EC3C:
    bl sub_803EF7C
    add r1, r0, #0
    ldr r0, [pc, #0x803ed18-0x803ec42-2] // =0xFE
    strh r0, [r1]
    bl sub_803EF7C
    mov r1, #0x10
    bl sub_803F00C
...
sub_803ECFC:
    ...
    bl sub_803EF7C
    add r1, r0, #0
    ldr r0, [pc, #0x803ed18-0x803ed04-4] // =0xFE
    strh r0, [r1]
    bl sub_803EF7C
    mov r1, #0x10
    bl sub_803F00C
...
loc_803F184:
    ...
    beq loc_803F1B8
    ldrb r1, [r0,r2]
    ldr r3, [pc, #0x803f1bc-0x803f18c-4] // =0xFE
    cmp r1, r3
    bne loc_803F19A
    add r2, #0xc
    cmp r2, #0xc
...
loc_803F3BC:
    ...
    mul r0, r7
    ldrh r1, [r3,r0]
    ldr r2, [pc, #0x803f3d4-0x803f3c2-2] // =0xFE
    cmp r1, r2
    bne loc_803F3D0
    add r7, #1
    cmp r7, #2
...
loc_803F5CA:
    ...
    b locret_803F5F2
loc_803F5DA:
    ldr r1, [pc, #0x803f5f8-0x803f5da-2] // =0x127
    sub r0, r3, r1
    ldrh r1, [r5,#0x3e]
    cmp r0, r1
    beq locret_803F5F2
