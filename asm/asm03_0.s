...
sub_8037DE0:
    ...
    mov r0, #0xd8
    mul r4, r0
    ldr r0, off_8037E14 // =sReqBBS_GUI+48 
    add r4, r4, r0
    ldr r0, [r4,#0x24]
    ldr r1, [r4,#0x28]
    ldr r2, [r4,#0x2c]
    ...
    .byte  0
    .byte  0
off_8037E14:    .word sReqBBS_GUI+0x30 // sReqBBS_GUI.unk_30
.endfunc // sub_8037DE0
...
sub_8037EFA:
    ...
    mov r1, #0xd8
    mul r1, r4
    ldr r4, off_8037FB4 // =sReqBBS_GUI+48 
    add r4, r4, r1
    ldr r0, [r4,#0x24]
    ldr r1, [r4,#0x28]
    ldr r2, [r4,#0x2c]
...
loc_8037FA8:
    ...
    mov r0, #1
    pop {pc}
off_8037FB4:    .word sReqBBS_GUI+0x30 // sReqBBS_GUI.unk_30
.endfunc // sub_8037F90
