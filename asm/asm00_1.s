...
sub_8006C22:
    ...
    ldr r3, off_8006CA0 // =sub_80014EC+1 
    mov lr, pc
    bx r3
    mov r0, r10
    mov r1, #0x3c 
...
loc_8007F04:
    ...
    add r1, r1, r4
loc_8007F08:
    ldr r0, off_8008014 // =dword_87370C0 
...
sub_80095C8:
    ...
    mov r1, #0x73 
    add r1, r1, r0
    ldr r0, off_8009618 // =dword_87370C0 
    bl chatbox_runScript // (u16 *scriptArr, u8 scriptID) -> void
    mov r0, #4
    strb r0, [r5,#3]
    b locret_80095F4
...
sub_8009966:
    ...
    mov r1, #0x73 
    add r1, r1, r0
    ldr r0, off_80099A0 // =dword_87370C0 
    bl chatbox_runScript // (u16 *scriptArr, u8 scriptID) -> void
    mov r0, #4
    strb r0, [r5,#3]
    b locret_8009992
...
sub_8009C56:
    ...
    mov r1, #0x73 
    add r1, r1, r0
    ldr r0, off_8009C90 // =dword_87370C0 
    bl chatbox_runScript // (u16 *scriptArr, u8 scriptID) -> void
    mov r0, #4
    strb r0, [r5,#3]
    b locret_8009C82
...
sub_8009F8A:
    ...
    mov r1, #0x73 
    add r1, r1, r0
    ldr r0, off_8009FC8 // =dword_87370C0 
    bl chatbox_runScript // (u16 *scriptArr, u8 scriptID) -> void
    mov r0, #4
    strb r0, [r5,#3]
    b locret_8009FB6
...
getBattleSettingsFromList1:
    mov r1, #0x10
    mul r1, r0
    ldr r0, off_800A944 // =battleSettingsList1+1424 
    add r0, r0, r1
    mov pc, lr
...
.endfunc // zf_checkSameSubsystem_800A732
...
loc_800B080:
    ...
    mov r1, #0xff
loc_800B088:
    bl sub_8006EE8 // (int a1, int a2) -> int
loc_800B08C:
    pop {r0}
    pop {r1-r7,pc}
.endfunc // sub_800B022
