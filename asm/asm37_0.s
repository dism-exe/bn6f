...
dword_813C148:
	.word 0x51E4
byte_813C14C:
	.byte 0x1D, 0x1C, 0x3E, 0x3D, 0x3C, 0x4D, 0x4C, 0x1E, 0x14
...
off_813C184:
	.word byte_813C1A4
byte_813C188:
	.byte 0x4, 0x31, 0x7B, 0x6F, 0x7B, 0x3, 0x3B, 0x62, 0x5B, 0x0
	.byte 0x5, 0x6E, 0x3, 0x3, 0xA9, 0x45, 0xFF, 0x7F, 0xFF, 0x13
	.byte 0xBF, 0x72, 0xDF, 0x10, 0x89, 0x7E, 0x87, 0x7
byte_813C1A4:
	.byte 0x4, 0x31, 0xF7, 0x5E, 0xF7, 0x2, 0xB7, 0x51, 0x17, 0x0
...
off_813C2E8:
	.word byte_813C308
byte_813C2EC:
	.byte 0x42, 0x41, 0x7B, 0x6F, 0x7B, 0x3, 0x3B, 0x62, 0x5B
	.byte 0x0, 0x5, 0x6E, 0x3, 0x3, 0xE4, 0x51, 0xFF, 0x7F
	.byte 0xFF, 0x13, 0xBF, 0x72, 0xDF, 0x10, 0x89, 0x7E, 0x87
	.byte 0x7
byte_813C308:
	.byte 0x42, 0x41, 0xF7, 0x5E, 0xF7, 0x2, 0xB7, 0x51, 0x17
...
off_813C4DC:
	...
	.word byte_813C550
byte_813C4E8:
	.byte 0x1D, 0x3F, 0x3E, 0x3D, 0x3C, 0x4C, 0x0, 0x1E, 0x14
...
byte_813C51C:
	.byte 0x1D, 0x3F, 0x3E, 0x3D, 0x3C, 0x4D, 0x4C, 0x1E, 0x14
	.byte 0x18, 0x34, 0x38, 0x54, 0x5F, 0x1F, 0x16, 0x1A, 0x36
	.byte 0x3A, 0x56, 0x5E, 0x2C, 0x24, 0x28, 0x44, 0x48, 0x58
...
byte_813D260:
	.byte 0x0, 0xFF, 0xF, 0x0, 0x2, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
...
byte_813D2CC:
	.byte 0x0, 0xFF, 0x10, 0x0, 0x2, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
...
byte_813D338:
	.byte 0x0, 0xFF, 0x11, 0x0, 0x2, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
...
byte_813D3A4:
	...
	.byte 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
byte_813D410:
	.byte 0x3E, 0x45, 0xCC, 0x86, 0x90, 0x18, 0x4F, 0x9, 0x61
	.byte 0xE9, 0x0, 0x0
...
off_813D79C:
	.word byte_813D7A0
byte_813D7A0:
	.byte 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0
	...
	thumb_func_start sub_813D78C
sub_813D78C:
	decomp_trampoline sub_813D78C_c, 12
byte_813D7A0:
	.byte 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0
	.byte 0x40, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0
	thumb_func_end sub_813D78C
...
off_813DBA8:
	.word byte_813DBAC
byte_813DBAC:
	.byte 0x0, 0x40, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0
off_813DBBC:
	.word eLinkState // eLinkState
...
sub_813DBC0:
	...
	pop {r4, pc}
	.pool
	thumb_func_end sub_813DBC0

byte_813DBDC:
	.byte 0x0, 0x0, 0x0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
tileIds_813DBE4:
	.hword 0x4200
...
tileIds_813DF44:
	.hword 0x61E0, 0x61E2, 0x61E4, 0x61E6, 0x61E8, 0x61EA, 0x61EC, 0x61EE
