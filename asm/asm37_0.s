...
byte_813C14C: .byte 0x1D, 0x1C, 0x3E, 0x3D, 0x3C, 0x4D, 0x4C, 0x1E, 0x14
	.byte 0x18, 0x34, 0x38, 0x54, 0x5F, 0x1F, 0x16, 0x1A
...
byte_813DEC4: .byte 0x0, 0x60, 0x0, 0x60, 0x0
a02468: .asciz "` `\"`$`&`(`*`,`.`0`2`4`6`8`:`<`"
aBDFHJL: .asciz "`>`@`B`D`F`H`J`L`"
	.byte 0x60, 0x0, 0x60, 0x0, 0x60, 0x0, 0x60, 0x0, 0x60, 0x0, 0x60
	.byte 0x0, 0x60, 0x0
a13579: .asciz "`!`#`%`'`)`+`-`/`1`3`5`7`9`;`=`"
aACEGIKM: .asciz "`?`A`C`E`G`I`K`M`"
	.byte 0x60, 0x0, 0x60, 0x0, 0x60, 0x0, 0x60, 0x0, 0x60
