...
sub_813C06C:
    ...
    sub sp, sp, #0xc
    str r2, [sp,#4]
    ldr r5, off_813C180 // =unk_813C188 
    mov r3, #0xe
    mul r2, r3
    add r5, r5, r2
    ldr r4, off_813C184 // =unk_813C1A4 
    add r4, r4, r2
    str r4, [sp]
    bl sub_813B9B4
    str r0, [sp,#8]
...
sub_813C1C0:
    ...
    sub sp, sp, #8
    str r0, [sp,#4]
    ldr r5, off_813C2E4 // =unk_813C2EC 
    mov r1, #0xe
    mul r0, r1
    add r5, r5, r0
    ldr r1, off_813C2E8 // =unk_813C308 
    add r1, r1, r0
    str r1, [sp]
    mov r6, r10
    ldr r6, [r6,#0x58]
...
sub_813C334:
    ...
    beq loc_813C394
    lsr r3, r7, #2
    ldr r1, dword_813C398 // =0x813B522 
    mov r2, #0xa
    mul r3, r2
    add r1, r1, r3
    add r4, r1, #0
...
loc_813C6CA:
    lsr r0, r4, #2
    lsl r0, r0, #2
    ldr r1, off_813C748 // =off_813C74C 
    ldr r1, [r1,r0]
    mov lr, pc
    bx r1
loc_813C6D6:
...
sub_813D41C:
    ...
    ldr r6, off_813D484 // =unk_813D410 
    add r4, r0, #0
    mov r5, #0
loc_813D426:
    ldrb r0, [r7]
