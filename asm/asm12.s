...
sub_806D8F8:
    push {r4-r7,lr}
    mov r7, r10
    ldr r0, [pc, #0x806d950-0x806d8fc-4] // =off_806D6B0
    ldr r1, [r7,#0x14]
    ldrb r2, [r5,#5]
    lsl r4, r2, #2
    add r0, r0, r4
    ...
    bl sub_802FF4C
    bl loc_8030472
    ldr r0, [pc, #0x806d954-0x806d930-4] // =unk_2037800
    bl sub_80028D4
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
    ldr r0, [pc, #0x806d958-0x806d93a-2] // =off_806D95C
    ldr r0, [r0,r1]
    bl sub_8002906
    bl sub_803FD08
    bl sub_806DCD4
...
.endfunc // end of function sub_806D8F8

.func .thumb
sub_806D9FC:
    push {lr}
    lsl r1, r1, #2
    ldr r0, [pc, #0x806da0c-0x806da00-4] // =off_806DA10
    ldr r0, [r0,r1]
    bl sub_8002354
    pop {pc}
    .balign 4, 0x00
...
off_806DA50:    .word unk_806D820
    .word 0xFFFFFFFF
.endfunc // end of function sub_806D9FC
...
sub_806DA58:
    ...
    ldrb r1, [r5,#5]
    lsl r1, r1, #4
    ldr r7, [pc, #0x806da8c-0x806da62-2] // =off_806DA90
    add r7, r7, r1
    ldr r0, [r7]
    ldr r1, [r7,#4]
    ldr r2, [r7,#8]
    ...
    orr r0, r1
    bl sub_8001778
    ldr r0, [pc, #0x806db90-0x806da7c-4] // =off_806DB94
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    bl sub_80304E8
...
off_806DBF0:    .word off_8616598
    ...
    .word 0x20
.endfunc // end of function sub_806DA58
...
loc_806DC0C:
    ...
    ldrb r6, [r5,#5]
    lsl r6, r6, #2
    ldr r7, [pc, #0x806dc34-0x806dc2a-2] // =off_806DC38
    ldr r7, [r7,r6]
    mov lr, pc
    bx r7
    pop {r4-r7,pc}
...
loc_806DC86:
    ...
    bl sub_802F110
    pop {pc}
.endfunc // end of function sub_806DC7A
...
loc_806DCA4:
    ...
    bl sub_802F110
    pop {pc}
.endfunc // end of function sub_806DC98
...
loc_806DCC2:
    ...
    bl sub_802F110
    pop {pc}
.endfunc // end of function sub_806DCB6
...
sub_806DCD4:
    ...
    ldrb r0, [r0,#5]
    lsl r0, r0, #2
    ldr r1, [pc, #0x806dce8-0x806dcde-2] // =pt_806DCEC
    ldr r0, [r1,r0]
    bl loc_8003570
    pop {pc}
...
pt_806DCEC:    .word dword_806DD2C
    ...
    .word dword_806DF44
    .word dword_806DF70
.endfunc // end of function sub_806DCD4
