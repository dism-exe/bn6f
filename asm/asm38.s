...
loc_81D62B2:
    ...
    ldr r1, [pc, #0x81d62d0-0x81d62c2-2] // =0x2005
    strh r1, [r0]
    mov r0, #1
    strh r0, [r4]
    pop {r4-r7,pc}
...
sub_81D63F0:
    ...
    ldr r1, [pc, #0x81d6430-0x81d6402-2] // =0x3DEF
    mov r8, r1
    sub r6, #2
loc_81D6408:
    mov r0, r12
...
sub_81D66E8:
    ...
    ldrb r6, [r5]
    push {r6}
    ldr r4, [pc, #0x81d6808-0x81d66f2-2] // =sCamera+76
    ldrb r4, [r4]
    ldrb r7, [r5,#2]
    lsr r7, r7, #4
    lsl r7, r7, #4
    ...
    mov lr, pc
    bx r2
    ldr r0, [pc, #0x81d6808-0x81d670a-2] // =sCamera+76
    ldrb r0, [r0]
    mov r10, r0
    mov r12, r7
    pop {r7}
...
sub_81D6904:
    push {lr}
    ldrh r3, [r0]
    ldr r2, [pc, #0x81d6920-0x81d6908-4] // =0x30
    sub r3, r3, r2
    add r3, r3, r4
...
loc_81D773E:
    ldr r0, [r7,#0x3c]
    ldr r4, [pc, #0x81d7a10-0x81d7740-4] // =0x202
    tst r0, r4
    beq loc_81D774E
    mov r1, #4
    tst r3, r1
...
loc_81D774E:
    ...
    tst r0, r4
    beq loc_81D775C
    ldr r4, [pc, #0x81d7a14-0x81d7754-4] // =0x202
    tst r3, r4
    bne loc_81D775C
    pop {r4,r6,r7,pc}
loc_81D775C:
    ldr r4, [pc, #0x81d7a18-0x81d775c-4] // =0x202
    tst r0, r4
    beq loc_81D776A
    ldr r4, [pc, #0x81d7a1c-0x81d7762-2] // =0x202
    tst r3, r4
    bne loc_81D776A
    pop {r4,r6,r7,pc}
loc_81D776A:
    ldr r4, [pc, #0x81d7a20-0x81d776a-2] // =0x202
    tst r0, r4
    beq loc_81D7772
    pop {r4,r6,r7,pc}
loc_81D7772:
    ...
    pop {r4,r6,r7,pc}
loc_81D7780:
    ldr r4, [pc, #0x81d7a10-0x81d7780-4] // =0x202
    tst r2, r4
    beq loc_81D7790
    ldr r3, [r7,#0x30]
    mov r1, #4
...
loc_81D7790:
    ...
    beq loc_81D77A0
    ldr r3, [r7,#0x30]
    ldr r4, [pc, #0x81d7a14-0x81d7798-4] // =0x202
    tst r3, r4
    bne loc_81D77A0
    pop {r4,r6,r7,pc}
loc_81D77A0:
    ldr r4, [pc, #0x81d7a18-0x81d77a0-4] // =0x202
    tst r2, r4
    beq loc_81D77B0
    ldr r3, [r7,#0x30]
    ldr r4, [pc, #0x81d7a24-0x81d77a8-4] // =0x202
    tst r3, r4
    bne loc_81D77B0
    pop {r4,r6,r7,pc}
loc_81D77B0:
    ldr r4, [pc, #0x81d7a20-0x81d77b0-4] // =0x202
    tst r2, r4
    beq loc_81D77B8
    pop {r4,r6,r7,pc}
loc_81D77B8:
...
loc_81D77C8:
    ...
    beq loc_81D780C
    ldr r1, [r7,#0x30]
    ldr r4, [pc, #0x81d7a28-0x81d77d0-4] // =0x202
    tst r1, r4
    bne loc_81D77DA
    mov r4, #2
    b loc_81D77DC
loc_81D77DA:
    ldr r4, [pc, #0x81d7a2c-0x81d77da-2] // =0x202
loc_81D77DC:
    tst r1, r4
    bne loc_81D780C
    mov r0, #1
    ...
    mov r2, #0x10
    bic r3, r2
    ldr r1, [pc, #0x81d7a30-0x81d77ee-2] // =0x202
    tst r3, r1
    bne loc_81D7804
    ldrb r2, [r7,#5]
    mov r0, #1
    ...
    orr r2, r0
    strb r2, [r6,#3]
    ldr r2, [pc, #0x81d7a34-0x81d7800-4] // =0x202
    orr r3, r2
loc_81D7804:
    ldr r2, [r6,#0x70]
    orr r2, r3
...
loc_81D780C:
    ldr r3, [r6,#0x30]
    ldr r4, [pc, #0x81d7a38-0x81d780e-2] // =0x202
    tst r3, r4
    beq loc_81D781E
    ldr r3, [r7,#0x30]
    ldr r4, [pc, #0x81d7a3c-0x81d7816-2] // =0x202
    tst r3, r4
    beq loc_81D781E
    pop {r4,r6,r7,pc}
loc_81D781E:
    ldr r3, [r6,#0x30]
    ldr r4, [pc, #0x81d7a3c-0x81d7820-4] // =0x202
    tst r3, r4
    beq loc_81D7830
    ldr r3, [r7,#0x30]
    ldr r4, [pc, #0x81d7a38-0x81d7828-4] // =0x202
    tst r3, r4
    beq loc_81D7830
    pop {r4,r6,r7,pc}
loc_81D7830:
