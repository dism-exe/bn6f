...
sub_81D63F0:
    ...
    ble locret_81D6418
    mov r12, r0
    ldr r1, dword_81D641C // =0x3005F20 
    ldr r2, [r1,r2]
    mov r9, r2
...
sub_81D6528:
    ...
    b locret_81D65E2
loc_81D6546:
    ldr r1, dword_81D65E4 // =0x30060E8 
    lsl r0, r0, #2
    add r0, r0, r1
    ldr r0, [r0]
    ldrh r6, [r0]
...
sub_81D6A94:
    ...
    beq loc_81D6AC4
    neg r1, r1
    ldr r3, dword_81D6BEC // =0x300670C 
    ldrb r4, [r2,#4]
    lsl r4, r4, #0x1c
    lsr r4, r4, #0x1a
    add r3, r3, r4
...
loc_81D6AC4:
    ...
    beq loc_81D6AE2
    neg r0, r0
    ldr r3, dword_81D6BF0 // =0x3006718 
    ldrb r4, [r2,#4]
    lsl r4, r4, #0x1c
    lsr r4, r4, #0x1a
    add r3, r3, r4
...
loc_81D6AFE:
    ...
    mov r3, #1
    ldrsb r3, [r2,r3]
    ldr r0, dword_81D6BE4 // =0x30066F4 
    ldrb r4, [r2,#4]
    lsl r4, r4, #0x1c
    lsr r4, r4, #0x1a
    add r0, r0, r4
    ...
    ldrb r0, [r6,#9]
    mul r3, r0
    ldr r0, off_81D6C28 // =dword_80065D0+16 
    ldrsh r0, [r0,r1]
    mul r3, r0
    mov r7, #2
    ldrsb r7, [r2,r7]
    ldr r0, dword_81D6BE8 // =0x3006700 
    ldrb r4, [r2,#4]
    lsl r4, r4, #0x1c
    lsr r4, r4, #0x1a
    add r0, r0, r4
    ...
    add r3, r3, r7
    asr r3, r3, #0xc
    ldr r0, dword_81D6BEC // =0x300670C 
    ldrb r1, [r2,#4]
    lsl r1, r1, #0x1c
    lsr r1, r1, #0x1a
    add r0, r0, r1
    ...
    add r3, r3, r7
    asr r3, r3, #0xc
    ldr r0, dword_81D6BF0 // =0x3006718 
    ldrb r1, [r2,#4]
    lsl r1, r1, #0x1c
    lsr r1, r1, #0x1a
    add r0, r0, r1
...
loc_81D743E:
    ...
    .balign 4, 0x00
    ldrb r7, [r0,#1]
    ldr r1, dword_81D7454 // =0x3006F58 
    ldrb r1, [r7,r1]
    add r0, r0, r1
    mov pc, lr
    .balign 4, 0x00
...
sub_81D7932:
    ...
    mul r0, r2
    add r0, r0, r1
    ldr r1, dword_81D7940 // =0x3007444 
    ldrb r0, [r1,r0]
    mov pc, lr
    .byte 0, 0
...
sub_81D7DE0:
    ...
    strb r1, [r0,#6]
    lsl r2, r1, #2
    ldr r3, dword_81D7E20 // =0x3007924 
    ldr r3, [r3,r2]
    orr r1, r3
    ldrb r2, [r0,#3]
    strb r2, [r0,#7]
