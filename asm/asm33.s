...
loc_81235E8:
    ...
    ldrh r0, [r0,#4]
    ldrb r1, [r5,#0xc]
    ldr r2, off_812363C // =unk_8123640 
    ldrb r3, [r2,r1]
    mov r1, #1
    mov r2, #0
    bl sub_811F91C
...
loc_8123888:
    ...
    ldr r2, off_81238DC // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_8123A40:
    ...
    bl chatbox_runScript_CpuSet_803FD9C // (u16 *scriptArr, u8 scriptID) -> void
    pop {pc}
...
sub_8123A50:
    push {r4-r7,lr}
    ldrb r0, [r5,#0xc]
    ldr r1, off_8123A78 // =unk_8123A7C 
    ldrb r0, [r1,r0]
    ldrh r3, [r5,r0]
...
sub_8123AB8:
    ...
    add r7, r5, #0
    ldrb r0, [r7,#0xc]
    ldr r1, off_8123BB8 // =unk_8123BBC 
    ldrb r0, [r1,r0]
    ldrh r0, [r7,r0]
...
sub_8123BC0:
    push {r4-r7,lr}
    ldr r0, off_8123BD8 // =unk_8123BDC 
    mov r1, #1
...
sub_8123BE0:
    push {r4-r7,lr}
    ldr r0, off_8123BF8 // =unk_8123BFC 
    mov r1, #0x20 
...
sub_8123C00:
    push {r4-r7,lr}
    ldr r0, off_8123C18 // =unk_8123C1C 
    mov r1, #0x40 
...
sub_8123F5C:
    push {lr}
    ldr r0, off_8123F6C // =off_8123F70 
    ldrb r1, [r5,#1]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
...
.endfunc // sub_8123F7C
    ...
    bl sub_8120C94
    bl sub_8124870
    ldr r0, off_8124074 // =dword_8123F34+12 
    bl sub_80465A0
    mov r0, #0
...
loc_81243CC:
    ...
    ldr r2, off_8124448 // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_81247EC:
    ...
    str r4, [sp]
loc_81247F4:
    ldr r1, off_8124860 // =unk_8124864 
    lsl r0, r4, #1
    ldrh r1, [r1,r0]
    ldr r0, off_8124820 // =dword_873D9FC 
    lsl r4, r4, #2
...
sub_8125280:
    ...
    mov r6, #0
    mov r7, #0
    ldr r5, off_812530C // =dword_8125310 
loc_812528A:
    ldr r0, [r5,r7]
    add r7, #4
    ldr r1, [r5,r7]
...
sub_8125D10:
    ...
    add r7, r5, #0
    ldrh r0, [r7,#0x18]
    ldr r1, off_8125D84 // =unk_2017A00 
    bl sub_81261FC
    ldr r0, [r7,#0x74]
    sub r0, #0xa0
    add r0, #0xc
    mov r1, #4
    ldr r2, off_8125D84 // =unk_2017A00 
    mov r3, #7
    bl sub_812625C
.endfunc // sub_8125D10
...
sub_8125D94:
    ...
    bne loc_8125E10
    ldrh r0, [r7,#0x22]
    ldr r1, off_8125E68 // =unk_2017A00 
    bl sub_81261FC
    ldr r0, [r7,#0x74]
    sub r0, #0x83
    add r0, #1
    mov r1, #4
    ldr r2, off_8125E68 // =unk_2017A00 
    mov r3, #7
    bl sub_812625C
    ldrh r0, [r7,#0x22]
...
sub_8125E78:
    ...
    bne loc_8125EF4
    ldrh r0, [r7,#0x2c]
    ldr r1, off_8125F4C // =unk_2017A00 
    bl sub_81261FC
    ldr r0, [r7,#0x74]
    sub r0, #0x71 
    add r0, #1
    mov r1, #4
    ldr r2, off_8125F4C // =unk_2017A00 
    mov r3, #5
    bl sub_812625C
    ldrh r0, [r7,#0x2c]
...
sub_8125F5C:
    ...
    bne loc_8125FD8
    ldrh r0, [r7,#0x36]
    ldr r1, off_8126104 // =unk_2017A00 
    bl sub_81261FC
    ldr r0, [r7,#0x74]
    sub r0, #0x5f 
    add r0, #1
    mov r1, #4
    ldr r2, off_8126104 // =unk_2017A00 
    mov r3, #7
    bl sub_812625C
    ldrh r0, [r7,#0x36]
...
sub_8126114:
    ...
    mov r0, #0x40 
    ldrh r0, [r7,r0]
    ldr r1, off_81261F4 // =unk_2017A00 
    bl sub_81261FC
    ldr r0, [r7,#0x74]
    sub r0, #0x4d 
    add r0, #1
    mov r1, #4
    ldr r2, off_81261F4 // =unk_2017A00 
    mov r3, #7
    bl sub_812625C
    mov r0, #0x40 
    ldrh r0, [r7,r0]
...
sub_81270D0:
    ...
    mov r6, #0
    mov r7, #0
    ldr r5, off_812715C // =dword_8127160 
loc_81270DA:
    ldr r0, [r5,r7]
    add r7, #4
    ldr r1, [r5,r7]
...
loc_81270EC:
    ...
    ldr r2, off_8127158 // =word_2013A00 
    bl sub_8123300
    pop {r4-r7,pc}
    .balign 4, 0x00
...
sub_812741C:
    ...
    ldr r4, off_81274E8 // =unk_2017A00 
    bl sub_8127578
    bl getPETNaviSelect
    mov r1, #2
    bl sub_80137B6
...
loc_812749A:
    ...
    cmp r0, #0
    beq loc_81274AE
    ldr r1, off_81274F4 // =unk_812756C 
    ldrb r0, [r1,r0]
    b loc_81274CE
loc_81274AE:
    bl getPETNaviSelect
    ...
    bl sub_80137B6
    mov r3, #0
    ldr r1, off_81274EC // =unk_81274F8 
loc_81274BC:
    ldrb r2, [r1,r3]
    cmp r0, r2
    beq loc_81274CA
...
loc_8127730:
    ...
    ldr r3, off_8127750 // =dword_873EA50 
...
loc_81277B0:
    ...
    ldr r3, off_81277D0 // =dword_873EA50 
...
loc_8127D08:
    ...
    ldr r2, off_8127D70 // =word_2013A00 
    bl sub_8123300
    // a1
    mov r0, #0
    // a2
...
sub_8127ED4:
    ...
    beq loc_8127EEA
    add r1, #0xa
    bl chatbox_runScript_CpuSet_803FDA4 // (u16 *scriptArr, u8 scriptID) -> void
    b locret_8127EEE
loc_8127EEA:
    bl chatbox_runScript_CpuSet_803FD9C // (u16 *scriptArr, u8 scriptID) -> void
locret_8127EEE:
...
loc_812802C:
    ...
    ldr r2, off_81280C0 // =unk_2017A20 
    add r2, r2, r7
...
loc_81281F2:
    ...
    add r0, r0, r1
    str r0, [sp,#4]
    ldr r3, off_812824C // =unk_8128250 
    lsl r2, r7, #2
    ldrh r1, [r3,r2]
    add r2, #2
    ldrh r0, [r3,r2]
...
sub_8128318:
    ...
    tst r2, r3
    beq loc_8128340
    bl chatbox_runScript_CpuSet_803FE10 // (u16 *scriptArr, u8 scriptID) -> void
    b loc_8128344
loc_8128340:
    bl chatbox_runScript_CpuSet_803FE08 // (u16 *scriptArr, u8 scriptID) -> void
loc_8128344:
    mov r0, #8
    strb r0, [r5,#2]
    pop {r4,pc}
...
loc_8128A60:
    ...
    mul r3, r5
    ldr r2, off_8128A98 // =unk_2017A00 
    add r2, r2, r3
    ldr r0, dword_8128AA0 // =0x6004020 
    add r3, r3, r0
    mov r4, #0xa
    ...
    ldr r0, off_8128A94 // =dword_873D9FC 
    mov r7, #0
    bl render_graphicalText_8045F8C
    pop {r4-r7}
    add r4, #1
...
loc_8128D4A:
    ...
    beq loc_8128D7C
    ldr r0, off_8128DB0 // =word_201BDB8 
    ldr r1, off_8128DB8 // =word_2013A00 
    bl sub_802B358
...
loc_8128E5C:
    ...
    ldr r1, off_8128EC8 // =word_2013A00 
    bl sub_802B358
loc_8128E64:
...
.endfunc // sub_81290A4
    ...
    mov r1, #0xc
    mov r2, #3
    ldr r3, off_81290FC // =unk_813565C 
    mov r4, #0xa
    mov r5, #6
    bl drawTiles // (int a1, int a2, int a3) -> void
locret_81290EA:
...
sub_8129400:
    ...
    bl engine_setScreeneffect
    ldrb r0, [r5,#0xd]
    ldr r1, off_812944C // =unk_8129450 
    ldrb r0, [r1,r0]
    bl sub_8132280
loc_8129438:
    bl sub_80465BC
...
loc_8129480:
    ...
    strb r2, [r5,#0xd]
loc_81294A8:
    ldr r1, off_8129524 // =unk_8129528 
    ldrb r0, [r1,r0]
    bl sub_8132280
    b loc_8129514
loc_81294B2:
...
sub_812AF84:
    ...
    ldr r2, off_812B01C // =word_2013A00 
    bl sub_8123300
    pop {pc}
.endfunc // sub_812AF84
...
sub_812B39C:
    push {lr}
    ldrb r0, [r5,#0x12]
    ldr r1, off_812B3AC // =unk_812B3B0 
    ldrb r0, [r1,r0]
    bl sub_8132280
    pop {pc}
    .balign 4, 0x00
...
sub_812B3CC:
    push {lr}
    ldrb r0, [r5,#0x12]
    ldr r1, off_812B3DC // =unk_812B3E0 
    ldrb r0, [r1,r0]
    bl sub_8132280
    pop {pc}
    .balign 4, 0x00
...
sub_812B3E4:
    push {lr}
    ldrb r0, [r5,#0x13]
    ldr r1, off_812B3F4 // =unk_812B3F8 
    ldrb r0, [r1,r0]
    bl sub_8132280
    pop {pc}
    .balign 4, 0x00
...
sub_812B3FC:
    push {lr}
    ldrb r0, [r5,#0xe]
    ldr r1, off_812B40C // =unk_812B410 
    ldrb r0, [r1,r0]
    bl sub_8132280
    pop {pc}
    .balign 4, 0x00
...
sub_812B430:
    ...
    mov r1, #0x20 
    ldr r2, off_812B494 // =unk_2017A00 
...
sub_812B530:
    ...
    ldr r0, [r1,r0]
    // dest
    ldr r1, off_812B568 // =word_2013A00 
    bl SWI_LZ77UnCompReadNormalWrite8bit // (void *src, void *dest) -> void
    ldr r0, off_812B568 // =word_2013A00 
    add r0, #4
...
sub_812B5C8:
    push {r4,lr}
    bl sub_803EAE4
    ldr r4, off_812B800 // =dword_203F7D8 
...
sub_812B640:
    push {lr}
    ldr r1, off_812B804 // =dword_203F7D8 
...
sub_812B698:
    ...
    tst r1, r0
    beq loc_812B6A8
    ldr r1, off_812B808 // =dword_203F7D8 
    mov r0, #4
