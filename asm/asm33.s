...
loc_812371A:
    ...
    mov r1, #0
    bl sub_811B314
    ldr r0, [pc, #0x8123770-0x8123726-2] // =0x182
    bl sound_play
    mov r0, #0
    bl sub_8119118
    b locret_8123760
...
.endfunc // sub_8123AB8
    ...
    mov r3, #0xb
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8123bac-0x8123b42-2] // =0x216
    orr r3, r4
    mov r5, #5
    bl sub_8120458
    mov r0, #0x18
    ...
    mov r3, #9
    lsl r3, r3, #0xc
    ldr r4, [pc, #0x8123bb4-0x8123b6c-4] // =0x34F
    orr r3, r4
    mov r5, #5
    bl sub_81204C4
    mov r0, #0x19
...
sub_81244EC:
    ...
    mov r3, #0x10
    mul r1, r3
    ldr r2, [pc, #0x8124528-0x81244fc-4] // =0x30
    add r1, r1, r2
    orr r0, r1
...
sub_81258E8:
    push {lr}
    ldr r0, [pc, #0x81258f4-0x81258ea-2] // =0x7A
    bl sound_play
    pop {pc}
    .balign 4, 0x00
...
loc_8125978:
    add r4, #1
    ldr r0, [pc, #0x8125990-0x812597a-2] // =0x13F
    cmp r4, r0
    ble loc_8125908
    add r0, r5, #0
    pop {r4-r7,pc}
...
loc_8125A26:
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125a28-4] // =0x13F
    cmp r4, r0
    ble loc_81259A6
...
loc_8125A52:
    add r6, #4
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125a56-2] // =0x13F
    cmp r4, r0
    blt loc_8125A34
    add r0, r5, #0
    pop {r4-r7,pc}
...
loc_8125AF6:
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125af8-4] // =0x13F
    cmp r4, r0
    ble loc_8125A7E
...
loc_8125B22:
    add r6, #4
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125b26-2] // =0x13F
    cmp r4, r0
    blt loc_8125B04
    add r0, r5, #0
    pop {r4-r7,pc}
...
loc_8125BC0:
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125bc2-2] // =0x13F
    cmp r4, r0
    ble loc_8125B4E
...
loc_8125BEC:
    add r6, #4
    add r4, #1
    ldr r0, [pc, #0x8125cfc-0x8125bf0-4] // =0x13F
    cmp r4, r0
    blt loc_8125BCE
    add r0, r5, #0
    pop {r4-r7,pc}
...
loc_8125CD6:
    add r6, #4
    add r4, #1
    ldr r0, [pc, #0x8125cf0-0x8125cda-2] // =0x13F
    cmp r4, r0
    blt loc_8125CB8
    add r0, r5, #0
    pop {r4-r7,pc}
...
loc_812658E:
    ...
    add r1, r1, r2
    orr r0, r1
    ldr r1, [pc, #0x81265d0-0x8126596-2] // =0x2
    ldr r2, [sp,#8]
    ldrb r2, [r5,r2]
    str r2, [sp,#0x14]
    mov r3, #0xf
...
sub_8126B6C:
    ...
    mov r0, #0xff
    strh r0, [r5,#0x26]
    ldr r0, [pc, #0x8126cac-0x8126bcc-4] // =0x1DA
    strh r0, [r5,#0x32]
    mov r0, #1
    strh r0, [r5,#0x38]
    mov r0, #3
...
sub_8127944:
    ...
    ldrsb r0, [r5,r1]
    lsl r0, r0, #3
    ldr r1, [pc, #0x8127970-0x812794c-4] // =0x22A
    add r0, r0, r1
    ldr r1, [pc, #0x8127974-0x8127950-4] // =0x6E
    mov r2, #0
    mov r3, #0x48 
...
sub_8127F90:
    ...
    add r1, r1, r2
    orr r0, r1
    ldr r1, [pc, #0x8127fe0-0x8127fa0-4] // =0x3
    ldrb r2, [r5,#0xf]
...
sub_81289C4:
    ...
    ldr r1, [pc, #0x8128a28-0x81289c8-4] // =0xDE
    bl sub_80008B4
    mov r6, #0
    mov r4, #0
loc_81289D2:
...
sub_8129104:
    ...
    add r7, r0, #0
    add r7, #0x16
    ldr r3, [pc, #0x8129138-0x812910e-2] // =0x1C2
    add r7, r7, r3
    mov r1, #0x1e
    add r4, r7, r1
    mov r5, #0
...
sub_812B7C4:
    ...
    ldrh r1, [r0,#8]
    add r1, #1
    ldr r2, [pc, #0x812b7fc-0x812b7d4-4] // =0x3E7
    cmp r1, r2
    bgt locret_812B7DC
    strh r1, [r0,#8]
locret_812B7DC:
...
sub_812B7E0:
    ...
    ldrh r1, [r0,#0xa]
    add r1, #1
    ldr r2, [pc, #0x812b7fc-0x812b7f0-4] // =0x3E7
    cmp r1, r2
    bgt locret_812B7F8
    strh r1, [r0,#0xa]
locret_812B7F8:
...
sub_812C0EC:
    ...
    bl sub_812C21C
    ldr r1, [pc, #0x812c184-0x812c100-4] // =0x30
    b loc_812C10C
loc_812C104:
...
sub_812C11C:
    ...
    tst r1, r1
    beq loc_812C12E
    ldr r1, [pc, #0x812c184-0x812c12a-2] // =0x30
    b loc_812C130
loc_812C12E:
...
sub_812C160:
    ...
    tst r1, r1
    beq loc_812C172
    ldr r2, [pc, #0x812c184-0x812c170-4] // =0x30
loc_812C172:
    ldr r1, [r5,#0x40]
    add r1, #8
    cmp r1, r2
