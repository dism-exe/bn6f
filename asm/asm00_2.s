...
loc_800F286:
    ...
    mov r1, #5
    mul r0, r1
    ldr r3, off_800F4D4 // =dword_8021220 
    add r3, r3, r0
    ldrb r0, [r3]
    ldrb r1, [r3,#1]
    ldrb r2, [r3,#2]
...
sub_800F35C:
    push {lr}
    ldr r0, off_800F368 // =unk_800F36C 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F378:
    push {lr}
    ldr r0, off_800F384 // =unk_800F388 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F394:
    push {lr}
    ldr r0, off_800F3A0 // =unk_800F3A4 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F3B0:
    push {lr}
    ldr r0, off_800F3BC // =unk_800F3C0 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F3CC:
    push {lr}
    ldr r0, off_800F3D8 // =unk_800F3DC 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F3E8:
    push {lr}
    ldr r0, off_800F3F4 // =unk_800F3F8 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
sub_800F404:
    push {lr}
    ldr r0, off_800F410 // =unk_800F414 
    bl loc_800F420
    pop {pc}
    .byte  0
    .byte  0
...
loc_800FC5C:
    ...
    mov r0, #0
    bl sub_80127C0
    ldr r1, dword_800FCB8 // =0x800FCD5 
    cmp r0, r1
    beq locret_800FC7A
    bl sub_8011688
    mov r0, #1
...
.thumb_func
sub_800FCFC:
    ldr r1, dword_800FEDC // =dword_8021220 
    ldrb r0, [r1,r0]
    ldrb r2, [r5,#4]
...
loc_800FF36:
    mov r2, #6
    mul r0, r2
    ldr r1, off_800FFE0 // =dword_8020354 
    add r0, r0, r1
    ldrb r1, [r0]
    strb r1, [r4,#4]
    ldrb r1, [r0,#1]
...
loc_8010050:
    ...
    cmp r0, #0xc
    beq loc_801006A
    ldr r1, dword_8010224 // =dword_8020354 
    ldrb r4, [r1,r0]
    b loc_801009E
loc_801006A:
    mov r1, #0xe
...
loc_8010350:
    ...
    mov r1, #0x2b 
    bl sub_8013774
    ldr r1, off_8010364 // =dword_8020FE0 
    add r1, r1, r4
    ldrb r0, [r1,r0]
locret_8010360:
    pop {r4,pc}
...
loc_8010892:
    bl sub_8019F8C
    ldr r4, dword_80108B4 // =0x80108D1 
    mov r1, #0x2c 
    bl sub_8013774
    cmp r0, #0
    bne loc_80108A8
...
sub_80182B4:
    mov r1, #3
    mul r1, r0
    ldr r0, off_80182C0 // =dword_80182C4 
    add r0, r0, r1
    mov pc, lr
    .byte 0, 0
...
loc_801C69E:
    ...
    sub r3, #1
    mul r3, r2
    ldr r0, off_801C6DC // =dword_86E1CD8 
    add r0, r0, r3
...
sub_801D344:
    ...
    mov r3, #0xa
    bl sub_801D3F8
    ldr r0, off_801D3F4 // =aBdfhjlnprtvxzB 
    mov r1, #0x1c
    b loc_801D3A2
loc_801D36C:
    bl refIndex_8021DA8 // (int idx) -> void*
...
loc_801DE8C:
    ...
    sub r0, #1
    mul r0, r2
    ldr r1, off_801DECC // =dword_86E1CD8 
    add r0, r0, r1
    ldr r1, off_801DEC8 // =unk_3001A80 
    mov r2, #0x20 
    bl loc_8000AC8
