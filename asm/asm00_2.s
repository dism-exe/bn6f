...
sub_800ED80:
    ldr r1, [r0,#0x7c]
    ldr r2, off_800ED8C // =dword_203F6A0 
    ldr r3, [r2]
    bic r3, r1
    str r3, [r2]
    mov pc, lr
...
loc_800F1BE:
    ...
    mul r1, r2
    add r0, r0, r1
    ldr r1, off_800F20C // =dword_8021300 
    ldrb r6, [r1,r0]
loc_800F1D4:
    add r0, r6, #0
    add r1, r7, #0
...
loc_800F286:
    ...
    mov r1, #5
    mul r0, r1
    ldr r3, off_800F4D4 // =unk_8021220 
    add r3, r3, r0
    ldrb r0, [r3]
    ldrb r1, [r3,#1]
    ldrb r2, [r3,#2]
...
sub_800F334:
    ...
    mov pc, lr
loc_800F346:
    ldr r0, off_800F350 // =dword_800F354 
    ldrb r0, [r0,r2]
    mul r0, r3
    mov pc, lr
    .byte 0, 0
...
sub_800F55C:
    ...
    sub r0, #1
    lsl r0, r0, #3
    ldr r3, off_800F584 // =off_800F588 
    add r3, r3, r0
    ldr r2, [r3]
    ldr r3, [r3,#4]
    add r0, r6, #0
...
loc_800F5DA:
    mov r1, #3
    mul r2, r1
    ldr r1, off_800F5F4 // =unk_800F604 
    add r2, r2, r1
    b loc_800F5E4
loc_800F5E4:
    mov r1, #0
...
loc_800F6F6:
    ldrb r0, [r5,#0x16]
    lsl r0, r0, #3
    ldr r6, off_800F744 // =dword_800F758 
    add r6, r6, r0
    ldr r2, [r6]
    ldr r3, [r6,#4]
...
loc_800F810:
    ...
    blt loc_800F810
loc_800F81E:
    ldr r0, off_800F824 // =unk_800F828 
    ldrb r0, [r0,r1]
    pop {pc}
...
sub_800F9DE:
    push {r4,lr}
    add r0, r0, r0
    ldr r4, off_800F9F8 // =unk_800FA14 
    add r4, r4, r0
    add r0, r1, #0
    bl sub_800E2C2
    mov r1, #0
...
loc_800FA88:
    ...
    tst r0, r1
    beq loc_800FA98
    ldr r2, off_800FAA0 // =unk_800FAA4 
    ldrb r6, [r2,r6]
loc_800FA98:
    add r0, r6, #0
    pop {r6,r7,pc}
...
.endfunc // sub_800FAF6
    ...
    tst r0, r0
    beq loc_800FB2C
    ldr r1, off_800FB48 // =unk_800FB4C 
    ldrb r2, [r5,#0x16]
    lsl r2, r2, #2
    ldr r1, [r1,r2]
    tst r0, r1
...
loc_800FC5C:
    ...
    mov r0, #0
    bl sub_80127C0
    ldr r1, off_800FCB8 // =unk_800FCD5 
    cmp r0, r1
    beq locret_800FC7A
    bl sub_8011688
    mov r0, #1
...
sub_800FC9E:
    cmp r0, #0
    bne loc_800FCAA
    ldr r0, off_800FCB4 // =dword_800FCBC 
    ldrb r2, [r0,r1]
    mov r1, #0
    mov pc, lr
loc_800FCAA:
...
.thumb_func
sub_800FCFC:
    ldr r1, off_800FEDC // =unk_80212BB 
    ldrb r0, [r1,r0]
    ldrb r2, [r5,#4]
    ldr r1, off_800FD58 // =unk_800FD5C 
    ldrb r1, [r1,r2]
    mul r0, r1
    mov pc, lr
.endfunc // sub_800FCFC
...
sub_800FD0A:
    ...
    mov r1, #0x29 
    bl sub_8013774
    ldr r1, off_800FEE0 // =unk_80212BB 
    ldrb r7, [r1,r0]
    ldrb r0, [r5,#0x16]
    bl sub_8015B54
    cmp r0, #2
...
off_800FEDC:    .word unk_80212BB
off_800FEE0:    .word unk_80212BB
unk_800FEE4:    .byte  0
    .byte  2
    .byte  0
    .byte  0
...
loc_8010050:
    ...
    cmp r0, #0xc
    beq loc_801006A
    ldr r1, off_8010224 // =unk_80203EA 
    ldrb r4, [r1,r0]
    b loc_801009E
loc_801006A:
    mov r1, #0xe
...
sub_8010230:
    ...
    mov r1, #0x18
    bl sub_8013774
    ldr r1, off_80102A0 // =unk_80102A4 
    ldrb r0, [r1,r0]
    tst r0, r0
    beq loc_8010264
    ldrb r3, [r4,#9]
...
sub_80102AC:
    ...
    mov r1, #0x19
    bl sub_80136CC
    ldr r1, off_80102F4 // =unk_80102F8 
    ldrb r6, [r1,r0]
    tst r6, r6
    beq locret_80102F0
    add r0, r4, #0
...
loc_8010350:
    ...
    mov r1, #0x2b 
    bl sub_8013774
    ldr r1, off_8010364 // =unk_8020FE0 
    add r1, r1, r4
    ldrb r0, [r1,r0]
locret_8010360:
    pop {r4,pc}
    .balign 4, 0x00
off_8010364:    .word unk_8020FE0
.endfunc // sub_8010332
...
sub_801086C:
    push {r4,lr}
    ldr r4, off_80108B0 // =dword_80108B8 
    mov r1, #0x29 
    bl sub_8013774
    cmp r0, #0
    bne loc_8010890
...
loc_8010892:
    bl sub_8019F8C
    ldr r4, off_80108B4 // =unk_80108D1 
    mov r1, #0x2c 
    bl sub_8013774
    cmp r0, #0
    bne loc_80108A8
...
sub_8010AE4:
    ...
    mov r2, #0x28 
    mul r2, r4
    ldr r3, off_8010D2C // =unk_203EB00 
    add r3, r3, r2
    add r2, r1, r1
    ldrh r0, [r3,r2]
    add r4, r1, #0
    bl sub_8000D84
    mov r1, #0
    ldr r2, off_8010B24 // =dword_8010B2C 
loc_8010B08:
    ldr r3, [r2]
    cmp r0, r3
    ble loc_8010B16
...
loc_8012F90:
    ...
    mul r1, r2
    add r1, r1, r3
    ldr r2, off_8012FC4 // =dword_8020404 
    ldrh r0, [r2,r1]
locret_8012FAA:
    pop {r4,r7,pc}
...
off_801340C:    .word unk_8013414
off_8013410:    .word unk_801341B
unk_8013414:    .byte  0
    .byte  1
    .byte  2
    .byte  3
...
sub_8013422:
    push {lr}
    ldr r2, off_8013434 // =unk_203CE00 
    mov r1, #0x64 
    mul r0, r1
    add r0, r0, r2
...
sub_8013682:
    mov r1, #0x64 
    mul r0, r1
    ldr r1, off_801368C // =unk_203CE00 
    add r0, r0, r1
    mov pc, lr
...
sub_8013690:
    mov r1, #0x64 
    mul r0, r1
    ldr r1, off_801369C // =unk_203CB10 
    add r0, r0, r1
    mov pc, lr
    .balign 4, 0x00
...
sub_8013854:
    mov r1, #0x64 
    mul r0, r1
    ldr r1, off_8013860 // =unk_203CCE0 
    add r0, r0, r1
    mov pc, lr
    .byte 0, 0
...
loc_8013B6E:
    ...
    mov r0, #0x10
    mul r0, r4
    ldr r6, off_8013CB4 // =unk_80210DD 
    add r6, r6, r0
    mov r1, #0x29 
    strb r4, [r7,r1]
    ldrb r0, [r6]
...
sub_8013BDA:
    ...
    mov r0, #0x10
    mul r0, r4
    ldr r6, off_8013CB8 // =unk_80210DD 
    add r6, r6, r0
    mov r1, #0x29 
    strb r4, [r7,r1]
    add r0, r4, r4
...
off_8013CB4:    .word unk_80210DD
off_8013CB8:    .word unk_80210DD
...
loc_8013D20:
    ...
    beq locret_8013D3C
    add r1, r4, r4
    ldr r0, off_8013D40 // =dword_8013D44 
    ldrh r0, [r0,r1]
    tst r0, r0
    beq locret_8013D3C
    bl sound_play // () -> void
...
loc_8013E00:
    ...
    cmp r0, #1
    beq loc_8013E34
    ldr r1, off_8013E40 // =unk_8013E54 
    ldrb r1, [r1,r0]
    ldrb r0, [r5,#0x16]
    bl sub_8015BEC
    b loc_8013E38
...
sub_8014178:
    ...
    mul r0, r1
    add r0, r0, r4
    ldr r4, off_801419C // =unk_80141A0 
    ldrb r0, [r4,r0]
    bl sub_801DF8C
    pop {r4,pc}
...
unk_801471D:    .byte 0x46 
    .byte 0xF7
unk_801471F:    .byte 0x46 
    .byte 0xF7
unk_8014721:    .byte 0x46 
    .byte 0xF7
unk_8014723:    .byte 0x46 
    .byte 0xF7
unk_8014725:    .byte 0x46 
    .byte 0xF7
unk_8014727:    .byte 0x46 
    .byte 0xF7
unk_8014729:    .byte 0x46 
.endfunc // sub_801469C
...
sub_8015CC0:
    ...
    ldrb r0, [r5,#0x16]
    lsl r0, r0, #2
    ldr r1, off_8015D74 // =unk_8015D78 
    ldr r0, [r1,r0]
    str r0, [sp,#0x14]
loc_8015CF4:
    ldr r0, [sp,#8]
...
unk_8016040:    .byte  0
    ...
    str r1, [sp,#0x30]
    lsl r0, r0, #3
    ldr r1, off_8016154 // =dword_8016158 
    add r1, r1, r0
    ldr r2, [r1]
    ldr r3, [r1,#4]
    add r7, sp, #0
...
sub_8016218:
    ...
    ldrb r0, [r5,#0x16]
    lsl r0, r0, #2
    ldr r1, off_8016288 // =unk_8016290 
    ldr r0, [r1,r0]
    str r0, [sp,#0xc]
    mov r4, #0
    str r1, [sp,#8]
...
sub_801632C:
    ...
    ldr r0, [r0,#0x18]
    lsl r1, r1, #2
    ldr r2, off_8016368 // =unk_801636C 
    ldr r1, [r2,r1]
    add r0, r0, r1
    mov r1, #0
    mov r6, #0
...
sub_80168C8:
    ...
    mov r1, #2
    and r0, r1
    ldr r1, off_80168E8 // =unk_80168EC 
    ldrh r0, [r1,r0]
    bl sub_8002ED0
locret_80168E6:
    pop {pc}
...
sub_801690A:
    ...
    mov r1, #2
    and r0, r1
    ldr r1, off_801692C // =unk_8016930 
    ldrh r0, [r1,r0]
    bl sub_8002ED0
locret_8016928:
    pop {pc}
...
loc_8016B9A:
    ...
    mov r0, #0x1f
    and r0, r1
    ldr r1, off_8016BD8 // =unk_8016BDC 
    ldrsb r0, [r1,r0]
    ldrh r1, [r4,#0x3c]
    add r0, r0, r1
    strh r0, [r5,#0x3e]
...
sub_8016CA4:
    ...
    mov r1, #2
    and r0, r1
    ldr r1, off_8016CE0 // =unk_8016CE4 
    ldrh r0, [r1,r0]
    bl sub_8002ED0
locret_8016CDE:
    pop {pc}
...
loc_8017802:
    ...
    mov r0, #0x1f
    and r0, r1
    ldr r1, off_8017864 // =unk_8017868 
    ldrsb r0, [r1,r0]
    lsl r0, r0, #0x10
    str r0, [r5,#0x3c]
    bl object_getFlag // () -> int
...
unk_8019B6E:    .byte  0
    ...
    .byte 0x7F 
    .byte  0
off_8019B78:    .word unk_80198E8
    .word unk_80198E9
    .word unk_80198EC
off_8019B84:    .word unk_80198F1
    .word unk_80198F4
    .word unk_80198FB
    .word unk_8019900
    .word unk_8019907
...
sub_801A00E:
    push {r4-r7,lr}
    ldr r0, off_801A0C8 // =loc_3007550+1 
    mov lr, pc
    bx r0
.endfunc // sub_801A00E
...
sub_801A7CC:
    ldr r3, [r5,#0x54]
    strb r0, [r3,#6]
    ldr r1, off_801A7F0 // =dword_8020B8C 
    ldrb r1, [r1,r0]
    strb r1, [r3,#0x14]
    mov r1, #6
    mul r0, r1
    ldr r1, off_801A7EC // =dword_8020B2C 
    add r0, r0, r1
    ldrh r1, [r0]
    strb r1, [r3,#0x16]
    ldrh r1, [r0,#2]
...
sub_801C368:
    ...
    bl sub_801C3A4
    pop {r0}
    ldr r1, off_801C454 // =unk_3001670 
    mov r2, #0
    bl sub_801C3EE
    mov r0, r10
    ldr r0, [r0,#0x18]
...
loc_801C69E:
    ...
    sub r3, #1
    mul r3, r2
    ldr r0, off_801C6DC // =unk_86E1CD8 
    add r0, r0, r3
...
sub_801C6EE:
    ...
    str r2, [sp,#8]
    bl sub_8027D10
    ldr r2, off_801C81C // =unk_203EBA0 
    ...
    mov r1, #0x13
    mov r2, #3
    ldr r3, off_801C82C // =unk_801D954 
    add r4, r7, #0
    bl sub_80018E0
    // idx
    ldr r0, [sp]
...
sub_801C9C8:
    push {r4,r5,lr}
    lsl r1, r1, #4
    ldr r3, off_801C9E0 // =unk_801D964 
    // tileRefs
    add r3, r3, r1
    // i
    mov r1, #2
...
loc_801CC24:
    ...
    add r0, r0, r1
loc_801CC2A:
    ldr r1, off_801CD78 // =unk_30016D0 
    mov r2, #0x20 
    bl loc_8000AC8
    pop {r0,r4,r6,r7,pc}
.func
...
sub_801CC34:
    ...
    ldr r1, dword_801CD68 // =0x6017680 
    bl loc_8000AC8
    ldr r0, off_801CDD4 // =unk_872D014 
    add r1, r1, r2
    mov r2, #0x80
    bl loc_8000AC8
    mov r0, #0xff
...
loc_801D070:
    ...
    mov r1, #2
    ldr r2, off_801D1C8 // =unk_203C4E0 
...
loc_801DE8C:
    ...
    sub r0, #1
    mul r0, r2
    ldr r1, off_801DECC // =unk_86E1CD8 
    add r0, r0, r1
    ldr r1, off_801DEC8 // =unk_3001A80 
    mov r2, #0x20 
    bl loc_8000AC8
...
loc_801E242:
    ...
    add r1, r7, #0
    ldr r2, off_801E43C // =unk_203C4E0 
...
sub_801E574:
    ...
    push {r0}
    pop {r0}
    ldr r2, off_801E5C8 // =unk_203EBA0 
...
loc_801E9FC:
    ...
    ldr r1, off_801EA94 // =unk_30016B0 
    mov r2, #0x20 
    bl loc_8000AC8
    // dataList
...
sub_801EA5A:
    ...
    cmp r2, #1
    beq loc_801EA66
    ldr r2, off_801EA98 // =unk_203EDA0 
    ldr r3, dword_801EA9C // =0x6016E00 
    mov pc, lr
loc_801EA66:
    ldr r2, off_801EAA4 // =unk_203EFA0 
...
off_801EBFC:    .word 0x100
    ...
    ldr r1, off_801EC28 // =unk_30016D0 
    mov r2, #0x20 
    bl loc_8000AC8
...
sub_801EC44:
    ...
    ldr r1, off_801EC80 // =unk_30016F0 
    mov r2, #0x20 
    bl loc_8000AC8
    mov r0, #1
    lsl r0, r0, #0x15
...
sub_801EC90:
    ...
    ldr r1, off_801ECAC // =unk_30016D0 
    mov r2, #0x20 
    bl loc_8000AC8
    mov r0, #1
    lsl r0, r0, #0x16
