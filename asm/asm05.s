...
sub_8052688:
    push {r4-r7,lr}
    mov r7, r10
    ldr r0, [pc, #0x80526e4-0x805268c-4] // =off_8052244
    ldr r1, [r7,#0x14]
    ldrb r2, [r5,#5]
    lsl r4, r2, #2
    add r0, r0, r4
    ...
    bl sub_802FF4C
    bl loc_8030472
    ldr r0, [pc, #0x80526e8-0x80526bc-4] // =unk_2037800
    bl sub_80028D4
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
    ldr r0, [pc, #0x80526f0-0x80526c6-2] // =off_80526F4
    ldr r0, [r0,r1]
    bl sub_8002906
    bl sub_803FD08
    bl sub_80527F0
    ldr r0, [pc, #0x80526ec-0x80526d6-2] // =off_8052EE8
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    str r0, [r5,#0x64]
...
.endfunc // end of function sub_8052688

.func .thumb
sub_8052764:
    push {lr}
    lsl r1, r1, #2
    ldr r0, [pc, #0x8052774-0x8052768-4] // =off_8052778
    ldr r0, [r0,r1]
    bl sub_8002354
    pop {pc}
    .balign 4, 0x00
...
.endfunc // end of function sub_8052764
...
sub_80527F0:
    ...
    ldrb r0, [r0,#5]
    lsl r0, r0, #2
    ldr r1, [pc, #0x8052804-0x80527fa-2] // =off_8052808
    ldr r0, [r1,r0]
    bl loc_8003570
    pop {pc}
...
// <endpool> <endfile>
    .word dword_8052D84
.endfunc // end of function sub_80527F0
