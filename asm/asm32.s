...
sub_810DC4C:
	...
	mov r0, #0xa
	strh r0, [r7,#0xa]
	ldr r1, dword_810DCB4 // =byte_810DCBC 
	ldrb r0, [r1,r2]
	strh r0, [r7,#0x10]
...
loc_810F0F4:
	...
	strh r0, [r7,#0xa]
	bl sub_810F1E6
	ldr r1, dword_810F184 // =byte_810F18C 
	ldrb r0, [r1,r0]
	strb r0, [r7,#0xc]
	ldrb r0, [r4,#0x16]
	strb r0, [r7,#0xd]
...
byte_810F18C: .byte 0xA, 0x1E, 0x50, 0x64, 0x32, 0x64, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1
	.byte 0x2, 0x2, 0x2, 0x2, 0x2, 0x2, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3
...
byte_810FA98: .byte 0x1, 0x0, 0x0, 0x0, 0xFF, 0xFF, 0xFF, 0xFF, 0xF0, 0xB5, 0x0
	.byte 0x22, 0x8C, 0x48, 0xA1, 0x7D, 0x89, 0x0, 0x40, 0x18, 0x5, 0xB4
	.byte 0x83, 0x5C, 0xB1, 0xF7, 0xA6, 0xFC, 0x5, 0xBC, 0x1, 0x32, 0x4
	.byte 0x2A, 0xF7, 0xD1, 0xF0, 0xBD, 0x0, 0x0, 0xC4, 0xFA, 0x10, 0x8
...
loc_8111E20:
	...
	strh r0, [r7,#0xa]
	ldrb r2, [r4,#0x16]
	ldr r1, dword_8111EEC // =byte_8111EFC 
	ldrb r0, [r1,r2]
	strh r0, [r7,#8]
	ldr r1, dword_8111EE4 // =byte_8111EF0 
	ldrb r0, [r1,r2]
	strh r0, [r7,#0x10]
...
byte_8111EF0: .byte 0x1, 0x4, 0x3, 0x2, 0x3, 0x1, 0x19, 0x19, 0x19, 0x19, 0x19, 0x19
byte_8111EFC: .byte 0x28, 0x23, 0x1E, 0x19, 0x1E, 0x14, 0x1E, 0x3C, 0x64
	.byte 0x78, 0x46, 0x82
.endfunc // sub_8111E14
...
loc_8112A9A:
	...
	ldrb r1, [r4,#0x16]
	strb r1, [r7,#3]
	ldr r0, dword_8112B7C // = 
	ldrb r0, [r1,r0]
	strh r0, [r7,#0x10]
	ldr r0, dword_8112B80 // = 
	ldrb r0, [r1,r0]
	strh r0, [r7,#0x12]
	ldr r0, dword_8112B84 // = 
	ldrb r0, [r1,r0]
	strh r0, [r7,#0x18]
	ldr r0, dword_8112B88 // = 
	ldrb r0, [r1,r0]
	strh r0, [r7,#8]
	mov r0, #0xa
	strh r0, [r7,#0xa]
...
loc_8116790:
	...
	lsl r4, r4, #8
	orr r4, r0
	ldr r6, dword_81167C4 // =byte_81167C8 
	ldrb r6, [r6,r0]
...
byte_81167C8: .byte 0x78, 0x64, 0x5A, 0x3C, 0x5A, 0x1E, 0x32, 0x46, 0x5A
	.byte 0x0
.endfunc // sub_811677A
...
loc_8119C36:
	add r0, r6, #0
	ldr r1, dword_8119C54 // =byte_80203EA 
	ldrb r0, [r1,r0]
loc_8119C3C:
	bl sub_8119C58
	add r7, r0, #0
...
loc_811C584:
	...
	bl sub_8002770 // (int a1, int a2) -> void
	lsr r1, r4, #2
	ldr r0, off_811C610 // =dword_811C618 
	ldrb r0, [r0,r1]
	bl sprite_setAnimation // (u8 a1) -> void
	bl sprite_loadAnimationData // () -> void
	bl sub_8002F90 // () -> void
	...
	ldr r0, [r0,r4]
	bl sub_800306C
	ldr r0, dword_811C614 // =dword_811C618 
	lsr r1, r4, #2
	ldrb r0, [r0,r1]
	bl sub_800304A
	mov r0, #3
...
loc_811F576:
	ldrb r0, [r5,#0xe]
	str r0, [sp]
	ldr r6, off_811F5B4 // =byte_811F5B8 
	add r7, r5, #0
loc_811F57E:
	mov r0, #0x10
	ldrsh r0, [r7,r0]
...
loc_811F598:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
off_811F5B4: .word byte_811F5B8
byte_811F5B8: .byte 0x1C, 0xB2, 0x6C, 0x8, 0x40, 0xB2, 0x6C, 0x8, 0x64, 0xB2
	.byte 0x6C, 0x8, 0x88, 0xB2, 0x6C, 0x8, 0xAC, 0xB2, 0x6C, 0x8
	.byte 0xD0, 0xB2, 0x6C, 0x8, 0xF4, 0xB2, 0x6C, 0x8, 0x18, 0xB3
	.byte 0x6C, 0x8, 0x3C, 0xB3, 0x6C, 0x8
...
off_811FC9C: .word byte_811FCA0
byte_811FCA0: .byte 0x40, 0xAC, 0x6D, 0x8
.endfunc // sub_811FB84
...
loc_812010A:
	...
	cmp r1, r2
	bne loc_812012E
	ldr r0, dword_8120190 // =unk_200119E 
	pop {r2}
	b loc_8120140
loc_8120128:
	ldr r0, dword_812018C // =unk_2001186 
	pop {r2}
	b loc_8120140
loc_812012E:
	pop {r2}
...
loc_812031C:
	...
	bgt loc_812031C
	mov r6, #0
	ldr r1, off_8120340 // =byte_86CF4AC 
	lsl r0, r0, #1
	ldrh r0, [r1,r0]
	add r0, r0, r1
	ldr r4, [sp]
