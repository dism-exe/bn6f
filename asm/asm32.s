...
locret_810FC0A:
    ...
    ldr r3, [r5,#0x3c]
    mov r3, #0
    ldr r4, [pc, #0x810fc2c-0x810fc22-2] // =0x2
    orr r4, r0
    bl sub_80E05F6
locret_810FC2A:
    pop {r4-r7,pc}
...
loc_811698A:
    strb r0, [r5,#9]
    strb r1, [r5]
    ldr r0, [pc, #0x81169a8-0x811698e-2] // =0xB0
...
sub_8116DEC:
    ...
    mov r1, #0
    bl sub_800308A
    ldr r2, [pc, #0x8116e04-0x8116df6-2] // =0x11A
    cmp r0, r2
    blt locret_8116E00
    mov r0, #8
    strb r0, [r5,#8]
...
loc_8116FA8:
    ...
    ldrh r0, [r5,#0xe]
    bl sub_81170C0
    ldr r0, [pc, #0x8116fd0-0x8116fb4-4] // =sSubmenu
    ldrb r0, [r0]
    cmp r0, #0x18
    beq loc_8116FC0
    cmp r0, #8
...
loc_8117016:
    ...
    cmp r0, #0x38 
    bge loc_8117042
    ldr r0, [pc, #0x8117080-0x811702c-4] // =sSubmenu
    ldrb r0, [r0]
    cmp r0, #0x18
    beq loc_8117038
    cmp r0, #8
...
sub_8117CD4:
    push {r7,lr}
    ldr r7, [pc, #0x8117d00-0x8117cd6-2] // =sSubmenu
    bl sub_81355D8
    beq loc_8117CE4
    bl sub_81312F4
    add r7, r0, #0
...
sub_8117DE0:
    push {r7,lr}
    ldr r7, [pc, #0x8117e1c-0x8117de2-2] // =sSubmenu
...
sub_8117FF8:
    ...
    cmp r0, #0
    bne locret_811800A
    ldr r0, [pc, #0x8118310-0x8118004-4] // =sSubmenu
    mov r1, #0
...
sub_8118030:
    ...
    mov r0, #0
    strb r0, [r5,#0xa]
    ldr r0, [pc, #0x8118310-0x8118046-2] // =sSubmenu
...
loc_8118068:
    ...
    strb r0, [r5,#0xa]
    mov r3, #1
    ldr r2, [pc, #0x8118310-0x811807e-2] // =sSubmenu
...
loc_81180A4:
    ...
    mov r0, #0
    strb r0, [r5,#0xa]
    ldr r0, [pc, #0x8118310-0x81180c0-4] // =sSubmenu
    mov r1, #0
...
sub_81180E0:
    ...
    bl sub_8118134
    bl sub_81181DC
    ldr r0, [pc, #0x8118310-0x81180f2-2] // =sSubmenu
    mov r1, #0
    strb r1, [r0,#0xc] // (ssubmenu.unk_0c - 0x2009a30)
    pop {pc}
    .balign 4, 0x00
...
sub_8118104:
    push {lr}
    ldr r2, [pc, #0x8118310-0x8118106-2] // =sSubmenu
    ldrh r0, [r2,#0x24] // (ssubmenu.unk_24 - 0x2009a30)
    cmp r0, #1
    blt loc_8118110
    mov r0, #1
...
sub_8118134:
    push {r4-r7,lr}
    ldr r6, [pc, #0x8118310-0x8118136-2] // =sSubmenu
...
sub_81181DC:
    push {r4-r7,lr}
    ldr r6, [pc, #0x8118310-0x81181de-2] // =sSubmenu
    ldrh r0, [r6,#0x24] // (ssubmenu.unk_24 - 0x2009a30)
    ldrb r1, [r5,#4]
    add r0, r0, r1
    sub r0, #2
...
sub_8118234:
    ...
    mov r6, #0xa
    mov r7, #0
    ldr r2, [pc, #0x8118310-0x811823c-4] // =sSubmenu
...
sub_81182A4:
    ...
    add r3, r0, #0
    mov r7, #0
    ldr r0, [pc, #0x8118310-0x81182ae-2] // =sSubmenu
...
loc_8118344:
    push {lr}
    ldr r6, [pc, #0x8118364-0x8118346-2] // =sSubmenu
...
loc_81187E8:
    push {lr}
    ldr r6, [pc, #0x8118808-0x81187ea-2] // =sSubmenu
...
loc_8118BA4:
    push {lr}
    ldr r6, [pc, #0x8118bc4-0x8118ba6-2] // =sSubmenu
...
loc_8118D60:
    push {lr}
    ldr r6, [pc, #0x8118d80-0x8118d62-2] // =sSubmenu
...
loc_8118E84:
    push {lr}
    ldr r6, [pc, #0x8118ea4-0x8118e86-2] // =sSubmenu
...
loc_8119520:
    ...
    tst r0, r0
    beq loc_8119542
    ldr r0, [pc, #0x811969c-0x811952c-4] // =sSubmenu
    ldrb r1, [r0]
    cmp r1, #0x18
    bne loc_8119542
...
sub_8119880:
    ...
    ldrb r0, [r1,r0]
    beq locret_811989E
    ldr r6, [pc, #0x81198a8-0x811988a-2] // =sSubmenu
    bl sub_81355D8
    beq loc_8119898
    bl sub_81312F4
    add r6, r0, #0
...
sub_81198B0:
    ...
    cmp r0, #5
    beq loc_81198DE
    ldr r6, [pc, #0x81198e4-0x81198c8-4] // =sSubmenu
    bl sub_81355D8
    beq loc_81198D6
    bl sub_81312F4
    add r6, r0, #0
...
loc_811997C:
    push {lr}
    ldr r6, [pc, #0x811999c-0x811997e-2] // =sSubmenu
...
sub_811A24C:
    ...
    cmp r0, #3
    beq locret_811A260
    ldr r6, [pc, #0x811a264-0x811a258-4] // =sSubmenu
...
sub_811A268:
    ...
    ldr r6, [pc, #0x811a294-0x811a26c-4] // =sSubmenu
    ldrb r0, [r6]
    cmp r0, #8
    beq loc_811A276
...
sub_811A434:
    ...
    ldr r0, [pc, #0x811a4b4-0x811a43e-2] // =sSubmenu
...
loc_811A448:
    ...
    ldr r0, [pc, #0x811a4b4-0x811a452-2] // =sSubmenu
    ldrb r0, [r0,#0x1] // (ssubmenu.jo_01 - 0x2009a30)
    cmp r0, #0x1c
    bne loc_811A45C
...
loc_811A640:
    push {r4-r7,lr}
    ldr r7, [pc, #0x811a664-0x811a642-2] // =sSubmenu
...
loc_811B338:
    push {lr}
    ldr r6, [pc, #0x811b358-0x811b33a-2] // =sSubmenu
...
loc_811BE64:
    ...
    bl sub_8002E14
    ldrb r1, [r5,#0xc]
    ldr r0, [pc, #0x811bf04-0x811be76-2] // =0x811BFB6
    ldrb r0, [r0,r1]
    bl sub_8003060
    ldrb r2, [r5,#0xc]
    lsl r2, r2, #2
...
sub_811D148:
    push {lr}
    ldr r0, [pc, #0x811d158-0x811d14a-2] // =0xCF
    strh r0, [r5,#0xc]
    mov r0, #4
    strb r0, [r5,#9]
    mov r0, #0
...
sub_811D15C:
    ...
    cmp r0, #0
    bne loc_811D18A
    ldr r0, [pc, #0x811d194-0x811d184-4] // =0x1C6
    bl sound_play
loc_811D18A:
    mov r0, #8
    strb r0, [r5,#9]
...
.endfunc // sub_811D464
    ...
    bl sub_8002F90
    ldr r1, [pc, #0x811d518-0x811d488-4] // =0x811D526
    ldrb r0, [r5,#5]
    ldrb r0, [r1,r0]
    bl sprite_setPallete
    mov r0, #2
...
loc_811D7E6:
    ...
    bl sub_800304A
    ldrb r1, [r5,#5]
    ldr r0, [pc, #0x811d868-0x811d804-4] // =0x811D88E
    ldrb r0, [r0,r1]
    bl sprite_setPallete
...
sub_811DA00:
    ...
    bl sub_8002E14
    ldrb r1, [r5,#5]
    ldr r0, [pc, #0x811da80-0x811da50-4] // =0x811DA8E
    ldrb r0, [r0,r1]
    bl sub_8003060
    mov r0, #0x80
    mov r1, #0x90
...
.endfunc // sub_811DA94
    ...
    mov r0, #1
    bl sub_8003060
    ldr r0, [pc, #0x811daec-0x811dacc-4] // =0x193
    bl sound_play
    mov r0, #0xf3
    bl sound_play
    mov r0, #0xc0
...
loc_811FE8C:
    ...
    tst r1, r1
    beq loc_811FEB0
    ldr r0, [pc, #0x811ff4c-0x811fe9c-4] // =0x137
    cmp r7, r0
    beq loc_811FF34
    ldrb r1, [r5,#7]
    cmp r1, #2
...
sub_811FF80:
    ...
    beq loc_811FFAC
    ldrh r2, [r0,#0x1a]
    ldr r1, [pc, #0x811ffbc-0x811ff9a-2] // =0x3E7
    cmp r2, r1
    ble loc_811FFA8
    add r0, r4, #0
    bl sub_8010C76
...
loc_811FFC4:
    ...
    bl sub_8021AA4
    add r5, r0, #0
    ldr r1, [pc, #0x8120010-0x811ffcc-4] // =0x136
    cmp r7, r1
    bgt loc_811FFFC
    ldr r1, [pc, #0x812000c-0x811ffd2-2] // =0x137
    cmp r7, r1
    beq loc_811FFE6
...
loc_812010A:
    ...
    push {r2}
    ldr r2, [pc, #0x8120184-0x8120116-2] // =0x137
    cmp r1, r2
    beq loc_8120128
    ldr r2, [pc, #0x8120188-0x812011c-4] // =0x139
    cmp r1, r2
    bne loc_812012E
...
loc_81208F0:
    add r7, #1
    ldr r0, [pc, #0x81208fc-0x81208f2-2] // =0x13F
    cmp r7, r0
    ble loc_81208A0
    add r0, r6, #0
    pop {r4-r7,pc}
...
sub_8120A38:
    ...
    bl sub_8120898
    str r0, [sp,#4]
    ldr r0, [pc, #0x8120a84-0x8120a50-4] // =0x137
    bl sub_8021BD8
    tst r0, r0
    beq loc_8120A60
    ldr r1, [sp,#8]
