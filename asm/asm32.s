...
.endfunc // sub_810FA4C
    ...
    strb r3, [r5,r2]
    lsl r3, r3, #1
    ldr r2, off_810FCD4 // =unk_80065E0 
    ldrh r0, [r2,r3]
    mov r1, #0xc
    mul r0, r1
    lsl r0, r0, #8
...
loc_8111E20:
    ...
    strh r0, [r7,#0xa]
    ldrb r2, [r4,#0x16]
    ldr r1, dword_8111EEC // = 
    ldrb r0, [r1,r2]
    strh r0, [r7,#8]
    ldr r1, dword_8111EE4 // = 
    ldrb r0, [r1,r2]
    strh r0, [r7,#0x10]
...
loc_8114E60:
    ...
    add r0, r0, r1
    str r0, [r5,#0x34]
    ldr r0, off_81150A0 // =unk_80065E0 
    mov r1, #0x6e 
    ldrh r1, [r5,r1]
    lsr r1, r1, #8
    lsl r1, r1, #1
...
sub_81174C0:
    ...
    str r1, [r5,#0x10]
    ldrh r1, [r0,#4]
    ldr r2, off_81175C8 // =unk_80065E0 
    lsl r3, r1, #1
    ldrsh r2, [r2,r3]
    str r2, [r5,#0x14]
...
loc_8119478:
    ...
    add r1, r1, r0
    mov r2, #0x20 
    ldr r0, off_8119668 // =unk_86E587C 
    bl CpuSet_copyWords // (u32 *src, u32 *dest, int size) -> void
    ldrb r0, [r7,#6]
    mov r1, #0x80
    mul r0, r1
...
loc_8119C36:
    add r0, r6, #0
    ldr r1, dword_8119C54 // =unk_80203EA 
    ldrb r0, [r1,r0]
loc_8119C3C:
    bl sub_8119C58
    add r7, r0, #0
...
loc_811CB12:
    bl sub_811CC68
    ldrh r1, [r0,#4]
    ldr r2, off_811CC6C // =unk_80065E0 
    lsl r3, r1, #1
    ldrsh r2, [r2,r3]
    str r2, [sp]
