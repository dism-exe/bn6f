...
sub_8119018:
	...
	mov r7, #0
	ldr r1, off_811907C // =byte_3006B18 
	mov lr, pc
	bx r1
	pop {r4-r7,pc}
	.balign 4, 0x00
...
sub_811AA4C:
	...
	mov r7, #0
	ldr r1, off_811AAB4 // =byte_3006B18 
	mov lr, pc
	bx r1
	pop {r4-r7,pc}
	.byte 0, 0
...
loc_811AC40:
	...
	mov r7, #0
	ldr r1, off_811AC94 // =byte_3006B18 
	mov lr, pc
	bx r1
	pop {r4-r7,pc}
	.balign 4, 0x00
...
loc_812031C:
	...
	bgt loc_812031C
	mov r6, #0
	ldr r1, off_8120340 // =dword_86CF4AC 
	lsl r0, r0, #1
	ldrh r0, [r1,r0]
	add r0, r0, r1
	ldr r4, [sp]
