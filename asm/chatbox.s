...
off_803FDF4:    .word 0x280
    .word 0x380
off_803FDFC:    .word unk_86BFE20
off_803FE00:    .word unk_3001B40
off_803FE04:    .word unk_86BFE40
...
loc_803FE14:
    ...
    cmp r4, #1
    beq loc_803FE32
    ldr r0, off_803FE68 // =unk_86C0900 
    ldr r1, off_803FE6C // =unk_3001B40 
    mov r2, #0x20 
    bl CpuFastSet_byteCount // (u32 *src, u32 *dest, int byteCount) -> void
    b loc_803FE3C
loc_803FE32:
    ldr r0, off_803FE70 // =unk_86C0920 
    ldr r1, off_803FE6C // =unk_3001B40 
    mov r2, #0x20 
    bl CpuFastSet_byteCount // (u32 *src, u32 *dest, int byteCount) -> void
loc_803FE3C:
...
off_803FE60:    .word 0x320
    .word 0x380
off_803FE68:    .word unk_86C0900
off_803FE6C:    .word unk_3001B40
off_803FE70:    .word unk_86C0920
...
chatbox_runScript_803FE74:
    ...
    bl CpuFastSet_byteCount // (u32 *src, u32 *dest, int byteCount) -> void
    pop {r4,r5,pc}
dword_803FE90:    .word 0x803FE94, 0x83007E, 0x81007F
...
chatbox_copyTiles_8040344:
    push {lr}
    ldr r3, off_804036C // =unk_8045CEC 
...
loc_8040CDA:
    ...
    mov r0, #4
    mul r4, r0
    ldr r0, off_8040D58 // =unk_8045DD4 
    ldr r4, [r0,r4]
    push {r4,r6,r7}
    ldr r0, [r4,#8]
    ldr r1, [r4,#0xc]
...
chatbox_jt_ctrlCmds:    .word chatbox_E5_nop+1, chatbox_E6_end+1, chatbox_E7_buttonhalt+1, chatbox_E8_msgbox+1
    ...
    .word chatbox_F1_textspeed+1, chatbox_F2_clearmsgbox+1, chatbox_F3_control+1, chatbox_F4_unk+1
    .word chatbox_F5_mugshot+1, chatbox_F6_textcolor+1, chatbox_F7_movebox+1, chatbox_F8_playeranimation+1
    .word chatbox_F9_storebyte+1, chatbox_FA_print+1, chatbox_FB_special+1, chatbox_FC_interface+1
    .word chatbox_FD_sound+1, chatbox_FE_numberinput+1, chatbox_FF_copytext+1
...
loc_8040FA0:
    ...
    beq loc_8040FBA
    lsl r3, r3, #2
    ldr r0, off_8040FD8 // =unk_8045DCC 
    add r0, r0, r3
    ldrh r1, [r0]
    ldrh r2, [r0,#2]
...
chatbox_804222C:
    ...
    ldrb r0, [r4,#2]
    lsl r0, r0, #3
    ldr r1, off_8042288 // =unk_8043B54 
    add r0, r0, r1
    ldr r2, [r0,#4]
    push {r2}
    ldr r0, [r0]
...
off_80447F0:    .word dword_8740E90
    ...
    .word dword_8741D04
    .word dword_8742318
off_8044800:    .word byte_8044814
    .word unk_8044828
    .word byte_804483C
    .word unk_8044850
    .word off_8044864
byte_8044814:    .byte 0x74, 0x29, 0x77, 0x8, 0x68, 0x30, 0x77, 0x8
    .byte 0x30, 0x37, 0x77, 0x8, 0x6C, 0x41, 0x77, 0x8
    .byte 0x30, 0x45, 0x77, 0x8
unk_8044828:    .byte 0x48 
    .byte 0x4F 
    .byte 0x77 
    .byte  8
    .byte  8
    ...
    .byte  0
    .byte 0x5E, 0x77, 0x8
byte_804483C:    .byte 0x20, 0x6A, 0x77, 0x8, 0x50, 0x6C, 0x77, 0x8
    .byte 0x78, 0x70, 0x77, 0x8, 0x28, 0x74, 0x77, 0x8
    .byte 0x7C, 0x76, 0x77, 0x8
unk_8044850:    .byte  0
    .byte 0x84, 0x77, 0x8
    .word dword_87786EC
    .word dword_8778810
...
off_8044900:    .word off_877E554
    ...
    .word dword_877E56C
    .word dword_877E620
off_8044914:    .word unk_875B4B0
    .word unk_875B934
    .word unk_875BCB4
    .word unk_875BE5C
    .word unk_875BF80
off_8044928:    .word unk_8743F6C
    .word 0x8743F6C
    .word 0x87444C8
    .word 0x8744B38
...
chatbox_8045ED0:
    push {r1,lr}
    ldr r1, off_8045ED8 // =unk_8043CA4 
    ldrb r0, [r1,r0]
    pop {r1,pc}
off_8045ED8:    .word unk_8043CA4
