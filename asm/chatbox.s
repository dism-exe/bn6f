...
loc_803FF56:
    ...
    sub r1, #0xe5
    lsl r1, r1, #2
    ldr r2, off_8040020 // =chatbox_jt_ctrl 
    ldr r1, [r2,r1]
    mov lr, pc
    bx r1
    cmp r0, #2
...
loc_803FF9E:
    ...
    ldr r3, off_8040038 // =loc_3006F8C+1 
    mov lr, pc
    bx r3
    add r4, #1
    bl chatbox_8040C44
...
loc_8040070:
    ...
    sub r1, #0xe5
    lsl r1, r1, #2
    ldr r2, dword_8040120 // =chatbox_jt_ctrl 
    ldr r1, [r2,r1]
    mov lr, pc
    bx r1
    bl chatbox_8040C9C
...
loc_8040088:
    ...
    mov r0, #0
    ldr r6, [r5,#0x7c]
    ldr r3, off_8040138 // =loc_3006F8C+1 
    mov lr, pc
    bx r3
    bl chatbox_8040C9C
    add r4, #1
...
loc_8040242:
    ...
    lsl r0, r0, #0x10
    orr r0, r1
    ldr r1, off_804033C // =unk_8040340 
    ldrb r1, [r1,r7]
    mov r2, r9
    add r1, r1, r2
    orr r0, r1
...
chatbox_8040344:
    push {lr}
    ldr r3, off_804036C // =dword_8045CEC 
...
loc_8040CDA:
    ...
    mov r0, #4
    mul r4, r0
    ldr r0, off_8040D58 // =dword_8045CEC+232 
    ldr r4, [r0,r4]
    push {r4,r6,r7}
    ldr r0, [r4,#8]
    ldr r1, [r4,#0xc]
...
loc_8040D64:
    sub r0, #1
    lsl r0, r0, #2
    ldr r2, off_8040D94 // =unk_8040D98 
    ldr r0, [r2,r0]
    mov r3, #0
loc_8040D6E:
    sub r1, r1, r0
...
off_8040E00:    .word unk_200BEA0
    ...
    .word 0xFF3EF7FF
    .word 0xBD20
chatbox_jt_ctrl:    .word chatbox_8040E90+1, chatbox_8040E98+1, chatbox_8040EF4+1
    .word chatbox_8040F70+1, chatbox_8041134+1, chatbox_8041160+1
    .word chatbox_8041244+1, chatbox_8041288+1, chatbox_80412C8+1
    .word chatbox_80414A8+1, chatbox_ho_804156C+1, chatbox_8041ADC+1
    .word chatbox_8041BA4+1, chatbox_8041BD8+1, chatbox_8041C54+1
    .word chatbox_static_8041C84+1, chatbox_8041CF4+1, chatbox_8041DBC+1
    .word chatbox_8042830+1, chatbox_8041E80+1, chatbox_8042FD8+1
    .word chatbox_8041F68+1, chatbox_8042388+1, chatbox_8042610+1
    .word chatbox_8042290+1, chatbox_ctrl_8042CF8+1, chatbox_8043020+1
...
loc_8040FA0:
    ...
    beq loc_8040FBA
    lsl r3, r3, #2
    ldr r0, off_8040FD8 // =dword_8045CEC+224 
    add r0, r0, r3
    ldrh r1, [r0]
    ldrh r2, [r0,#2]
    strb r1, [r5,#0x1a]
...
chatbox_8041670:
    push {lr}
    ldr r0, off_8041690 // =dword_8043C84 
    ldrb r1, [r4,#2]
    lsl r1, r1, #2
    ldr r1, [r0,r1]
    ldrb r1, [r1]
...
loc_8041C80:
    mov r0, #1
    pop {pc}
.endfunc // chatbox_8041C54

.func
.thumb_func
// () ->
chatbox_static_8041C84:
    push {lr}
    ldrb r0, [r4,#1]
    lsr r1, r0, #4
    lsl r1, r1, #4
...
.endfunc // chatbox_static_8041C84
...
chatbox_8041F68:
    push {lr}
    ldr r0, off_8041F78 // =off_8041F7C 
    ldrb r1, [r4,#1]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    mov lr, pc
...
off_8041F7C:    .word chatbox_8041FB4+1
...
chatbox_804222C:
    ...
    ldrb r0, [r4,#2]
    lsl r0, r0, #3
    ldr r1, off_8042288 // =dword_8043B0C+72 
    add r0, r0, r1
    ldr r2, [r0,#4]
    push {r2}
    ldr r0, [r0]
...
chatbox_80426A8:
    ...
    ldrb r0, [r4,#2]
    lsl r0, r0, #2
    ldr r1, off_80426C0 // =off_8043B00 
    ldr r1, [r1,r0]
    ldrb r0, [r4,#3]
    mov lr, pc
    bx r1
...
chatbox_80427B4:
    push {lr}
    ldr r0, off_8042A94 // =sReqBBS_GUI 
...
chatbox_80427E4:
    push {lr}
    ldr r0, off_8042A98 // =sReqBBS_GUI 
...
chatbox_8042804:
    push {lr}
    ldr r0, off_8042818 // =sReqBBS_GUI 
...
chatbox_8042830:
    push {lr}
    ldr r0, off_8042840 // =loc_8042844 
    ldrb r1, [r4,#1]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    mov lr, pc
...
loc_8042844:
    ...
    cmp r1, #0xd9
    lsr r4, r0, #0x20
    ldr r0, off_804289C // =dword_80428A0 
    ldrb r3, [r4,#4]
    strb r3, [r5,#0x15]
    lsl r3, r3, #3
    add r0, r0, r3
