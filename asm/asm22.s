...
loc_8086F2E:
    ldrb r0, [r0,#5]
loc_8086F30:
    ldr r1, [pc, #0x8086f54-0x8086f30-4] // =unk_8086F58
    ldrb r7, [r1,r0]
...
loc_8086F72:
    ldrb r0, [r0,#5]
loc_8086F74:
    ldr r1, [pc, #0x8086f98-0x8086f74-4] // =unk_8086F9C
    ldrb r7, [r1,r0]
...
loc_8087004:
    ...
    mov r1, #0xf2
    bl sub_802F110
    ldr r0, [pc, #0x80870f8-0x8087028-4] // =dword_8086A54+716
    b loc_80870F2
loc_808702C:
    mov r0, #5
    mov r1, #0xf4
    ...
    mov r1, #0xf4
    bl sub_802F12C
    ldr r0, [pc, #0x80870f8-0x8087044-4] // =dword_8086A54+716
    b loc_80870F2
loc_8087048:
    ldr r0, [pc, #0x80870fc-0x8087048-4] // =dword_8086A54+732
    b loc_80870F2
loc_808704C:
    bl sub_80871C0
    bne loc_808705C
...
loc_808705C:
    add r1, r4, #0
    ldr r0, [pc, #0x8087100-0x808705e-2] // =dword_8086D5C
    b loc_80870F2
loc_8087062:
    add r1, r4, #0
    ldr r0, [pc, #0x8087104-0x8087064-4] // =unk_8086D74
    b loc_80870F2
loc_8087068:
    mov r0, #0
    strb r0, [r5,#1]
    ...
    mov r1, #0xe1
    bl sub_802F110
    ldr r0, [pc, #0x8087108-0x808708e-2] // =dword_8086260+244
    b loc_80870F2
loc_8087092:
    cmp r0, #1
    bne loc_80870AC
    ...
    mov r1, #0xe2
    bl sub_802F110
    ldr r0, [pc, #0x808710c-0x80870a8-4] // =dword_8086260+328
    b loc_80870F2
loc_80870AC:
    mov r0, #5
    mov r1, #0xe3
    ...
    mov r1, #0xe3
    bl sub_802F110
    ldr r0, [pc, #0x8087110-0x80870be-2] // =dword_8086260+412
    b loc_80870F2
loc_80870C2:
    mov r0, #0xf
    mov r1, #0xc0
    ...
    mov r1, #0xc0
    bl sub_802F110
    ldr r0, [pc, #0x8087114-0x80870d4-4] // =dword_8086260+520
    b loc_80870F2
loc_80870D8:
    mov r1, r10
    ldr r1, [r1,#0x3c]
