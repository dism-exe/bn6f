...
sub_807544C:
    push {r4-r7,lr}
    mov r7, r10
    ldr r0, [pc, #0x80754a4-0x8075450-4] // =off_8074F30
    ldr r1, [r7,#0x14]
    ldrb r2, [r5,#5]
    lsl r4, r2, #2
    add r0, r0, r4
    ...
    bl sub_802FF4C
    bl loc_8030472
    ldr r0, [pc, #0x80754a8-0x8075484-4] // =unk_2037800
    bl sub_80028D4
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
...
dword_80754C8:    .word 0x491C0E1C, 0x4B1C4A1C, 0x491CFFFF, 0x4B1C4A1C, 0xE1C381C
    .word 0x251C951C
    .byte 0xFF, 0xFF
// end of function sub_807544C

.thumb
sub_80754E2:
    push {lr}
    lsl r1, r1, #2
    ldr r0, [pc, #0x80754f0-0x80754e6-2] // =off_80754F4
    ldr r0, [r0,r1]
    bl sub_8002354
    pop {pc}
...
sub_8075530:
    ...
    ldrb r1, [r5,#5]
    lsl r1, r1, #4
    ldr r7, [pc, #0x8075564-0x807553a-2] // =off_8075568
    add r7, r7, r1
    ldr r0, [r7]
    ldr r1, [r7,#4]
    ldr r2, [r7,#8]
    ...
    orr r0, r1
    bl sub_8001778
    ldr r0, [pc, #0x8075598-0x8075554-4] // =off_807559C
    ldrb r1, [r5,#5]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    bl sub_80304E8
...
loc_80755C4:
    ...
    ldrb r6, [r5,#5]
    lsl r6, r6, #2
    ldr r7, [pc, #0x80755d8-0x80755ce-2] // =off_80755DC
    ldr r7, [r7,r6]
    mov lr, pc
    bx r7
    pop {r4-r7,pc}
...
sub_80755EE:
    ...
    ldrb r0, [r0,#5]
    lsl r0, r0, #2
    ldr r1, [pc, #0x8075604-0x80755f8-4] // =off_8075608
    ldr r0, [r1,r0]
    bl loc_8003570
    pop {pc}
    .balign 4, 0x00
off_8075604:    .word off_8075608
off_8075608:    .word dword_8075614  // <endpool>
// end of function sub_80755EE

    .word dword_8075708
    .word dword_807575C  // <endfile>
