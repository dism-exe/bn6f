...
byte_808BF8C: .byte 0x3C, 0x0, 0x40, 0x15
	.word byte_808BF43
	.byte 0x3F 
	.byte  0
	.byte  6
...
byte_808C228: .byte 0x3C, 0x0, 0x40, 0x15
	.word byte_808C1D3
...
byte_808CA44: .byte 0x40, 0xB, 0x0, 0x2
...
sub_808CA68:
	push {r5,lr}
	ldr r0, off_808CB9C // =byte_808CA44 
	ldr r0, [r0]
	mov r5, r0
	mov r1, #0x98
...
loc_808CABE:
	bl sub_808CE28
	mov r0, #0x1f
	ldr r1, byte_808CAD0 // =0x0 
	bl sound_8000672
	mov r0, #0
	pop {r5,pc}
	.byte 0, 0
byte_808CAD0: .byte 0x0, 0x1, 0x0, 0x0
...
sub_808CB0C:
	push {r4-r7,lr}
	ldr r5, off_808CB9C // =byte_808CA44 
	ldr r5, [r5]
	mov r0, #9
	mov r1, #0xd6
	bl TestEventFlagFromImmediate // (int entryIdx, int byteFlagIdx) -> zf
...
locret_808CB96:
	pop {r4-r7,pc}
byte_808CB98: .byte 0x3B, 0x1, 0x0, 0x0
off_808CB9C: .word byte_808CA44
...
sub_808CBD8:
	...
	beq loc_808CC06
	mov r0, #0x1f
	ldr r1, byte_808CC0C // =0x3b 
	bl sound_8000672
loc_808CC06:
	mov r0, #0
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_808CC0C: .byte 0x3B, 0x1, 0x0, 0x0
...
sub_808CD04:
	push {r4-r7,lr}
	ldr r5, off_808D030 // =byte_808CA44 
	ldr r5, [r5]
	mov r4, #0
	bl reqBBS_81409E4
	cmp r0, #0xc0
...
loc_808CFAC:
	...
	pop {r4,pc}
	.balign 4, 0x00
byte_808CFB4: .byte 0x22, 0x1, 0x0, 0x0
...
loc_808CFDA:
	...
	add r0, #1
	ldr r1, byte_808D02C // =0xff 
	cmp r0, r1
	blt loc_808D00A
	mov r0, r1
loc_808D00A:
	strh r0, [r5,#0x6] // (word_2000B46 - 0x2000b40)
	ldr r0, byte_808D028 // =0x1b 
	bl sound_play // () -> void
	mov r0, #0x69 
	bl sound_play // () -> void
	mov r4, #2
...
loc_808D020:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_808D028: .byte 0x1B, 0x1, 0x0, 0x0
byte_808D02C: .byte 0xFF, 0xFF, 0x0, 0x0
off_808D030: .word byte_808CA44
...
sub_808D11C:
	push {r4-r7,lr}
	ldr r5, off_808D16C // =byte_808CA44 
	ldr r5, [r5]
	mov r6, #0
	mov r7, #0
loc_808D126:
