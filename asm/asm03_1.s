...
loc_8045FEE:
    ...
    strb r3, [r2,#4]
    lsr r0, r1, #0x10
    ldr r1, dword_8046030 // =0x3006B84 
    ldr r0, [r1,r0]
    str r0, [r2,#0x38]
    pop {r0-r3}
    lsl r1, r1, #0x10
...
loc_804618E:
    ...
    sub r1, #0xe5
    lsl r1, r1, #2
    ldr r7, off_80461C8 // =dword_80460F4 
    ldr r1, [r7,r1]
    mov lr, pc
    bx r1
    b loc_804618E
...
sub_8046CC8:
    ...
    ldr r2, off_8046CF0 // =dword_8046A70+296 
    mov r0, #0x10
    mul r0, r4
    add r0, r0, r2
...
.endfunc // sub_8046D4C
    ...
    bl sub_804758C
    bl sub_8047800
    ldr r0, off_8046DD8 // =dword_8046A70+284 
    bl sub_80465A0
    ldr r0, [r5,#0x24]
    mov r1, #0
...
uncomp_80471F8:
    ...
    // src
    ldr r0, off_804721C // =dword_873DE4C 
    // dest
    ldr r1, off_8047220 // =unk_202BA00 
    bl SWI_LZ77UnCompReadNormalWrite8bit // (void *src, void *dest) -> void
    // src
    ldr r0, off_8047224 // =dword_873ECC8 
    // dest
...
sub_804760E:
    ...
    mul r4, r0
    push {r4,r5}
    ldr r0, off_804764C // =dword_873D9FC 
    ldr r2, off_8047650 // =word_2013A00 
...
sub_8047664:
    ...
    mul r4, r0
    push {r1-r4,r7}
    ldr r0, off_80476E0 // =dword_80476E4 
    ldr r2, off_80476EC // =word_2013A00 
...
loc_8047698:
    ...
    mov r3, #0x1b
loc_80476C4:
    ldr r0, off_80476F4 // =a8Bdfhjlnprtvxz 
    add r1, r3, #0
...
sub_8047708:
    ...
    mul r4, r0
    push {r4,r5}
    ldr r0, off_8047748 // =dword_873EA50 
    lsr r1, r1, #2
    ldr r2, off_804774C // =word_2013A00 
...
sub_8047760:
    ...
    ldr r0, [r5,#0x24]
    mov r1, #0x10
    ldr r2, off_8047784 // =word_2013A00 
...
sub_8047834:
    ...
    bne loc_804787A
    bl sub_80478B8
    ldr r0, off_80478A4 // =dword_8046A70+260 
    bl sub_80465A0
    ldrh r0, [r7,#2]
    ldrb r1, [r7,#4]
    mov r2, #0
...
loc_804788C:
    ...
    bl chatbox_runScript // (u16 *scriptArr, u8 scriptID) -> void
    bl sub_80478B8
    ldr r0, off_80478B4 // =dword_8046A70+276 
    bl sub_80465A0
locret_80478A0:
    pop {r4-r7,pc}
    .balign 4, 0x00
...
.endfunc // sub_80478D4
    ...
    mov r1, #2
    mov r2, #0
    ldr r3, off_8047940 // =dword_8046A70+232 
    mov r4, #7
    mov r5, #2
    bl drawTiles // (int a1, int a2, int a3) -> void
    mov r1, #0xe
...
loc_8047AB2:
    ...
    add r1, r2, #0
    add r2, r3, #0
    bl chatbox_set_8045EFC // (int unk_4C, int unk_50, int unk_54, int unk_58) -> void
    pop {r0-r7}
    ldr r2, [r5,#0x1c]
    ldr r2, [r2]
    cmp r2, #2
...
sub_8048C24:
    push {r4-r7,lr}
    ldr r2, off_8048F98 // =dword_8046A70+296 
    mov r1, #0x10
    mul r0, r1
    add r2, r2, r0
    ldr r4, [r2,#0xc]
...
sub_8048CCC:
    ...
    push {r4-r6}
    add r6, r1, #0
    ldr r7, off_8048F98 // =dword_8046A70+296 
    mov r1, #0x10
    mul r0, r1
    add r7, r7, r0
    ldr r5, [r7,#0xc]
...
sub_804A61C:
    ...
    mov r6, #0
    mov r7, #0
    ldr r5, off_804A698 // =dword_804A69C 
loc_804A62A:
    ldr r0, [r5,r7]
    add r7, #4
    ldr r1, [r5,r7]
...
.endfunc // sub_804A7C0
    ...
    ldr r3, off_804A8C8 // =dword_804A264 
...
sub_804A9A0:
    ...
    mov r2, #0x2a 
    mov r3, #0x13
    ldr r4, off_804A9BC // =dword_804A264+56 
...
.endfunc // sub_804A9A0
    ...
    mov r2, #0
    mov r3, #0x12
    ldr r4, off_804A9E4 // =dword_804A264+64 
...
loc_804AA0E:
    ...
    sub r1, #1
    bne loc_804AA3C
    ldr r1, off_804AA54 // =dword_804A264+72 
    bl sub_8120CC8
    ldr r2, [sp,#8]
    strb r0, [r5,r2]
loc_804AA3C:
...
sub_804AE04:
    ...
    cmp r2, r3
    beq loc_804AE34
    ldr r1, dword_804AE48 // =0x30069A0 
    ldrb r3, [r1,r2]
    mov r1, #4
    eor r3, r1
    strb r3, [r0,r4]
...
sub_804AE68:
    ...
    mov r3, #0xf
    and r2, r3
    ldr r3, off_804AEB8 // =dword_804A264+56 
    ...
    sub r1, #1
    bne loc_804AE9E
    ldr r1, off_804AEC0 // =dword_804A264+72 
    bl sub_8120CC8
    mov r2, #0x15
    strb r0, [r5,r2]
loc_804AE9E:
...
sub_804AF10:
    push {lr}
    add r1, r0, #0
    ldr r0, off_804AF1C // =dword_86C580C 
...
sub_804AF84:
    push {r4-r7,lr}
    ldr r0, off_804AFB0 // =dword_804A264+76 
    bl sub_80465A0
    mov r6, #0
loc_804AF8E:
    add r0, r6, #0
...
loc_804BF50:
    ...
    ble loc_804BF2C
loc_804BF56:
    ldr r0, off_804BF8C // =dword_804B068 
    mov r1, #2
    push {r3,r4}
    bl sub_804BD7C
    pop {r3,r4}
    ...
    beq loc_804BF7C
loc_804BF6A:
    ldr r0, dword_804BF90 // =dword_804B068 
    add r1, r3, #0
    bl sub_804BD7C
    add r0, #0x38 
    ldrb r1, [r5,r0]
