...
byte_8033804: .byte 0x0, 0x0, 0x0, 0x0
byte_8033808: .byte 0x0, 0x0, 0x0, 0x0, 0x0, 0x0
word_803380E: .hword 0x404
...
word_803384D: .hword 0x404
byte_803384F: .byte 0x4, 0x4, 0x4
byte_8033852: .byte 0x4, 0x4, 0x4, 0x4
byte_8033856: .byte 0x4, 0x4, 0x4, 0x0, 0x0, 0x0
...
byte_80338F0: .byte 0x6, 0x6, 0x6, 0x6
...
byte_803393E: .byte 0x5, 0x5, 0x5, 0x5
...
byte_80339B4: .byte 0x0, 0x72, 0x1, 0x6
...
sub_8033B80:
	...
	ldrb r1, [r1,r0]
	ldr r0, byte_8033BAC // =0x3 
	lsl r1, r1, #0x10
	add r0, r0, r1
	ldr r1, byte_8033BB0 // =0x90 
	mov r2, #1
	mov r3, #0
...
loc_8033BA8:
	strb r0, [r5,#5]
	pop {pc}
byte_8033BAC: .byte 0x3, 0x80, 0x2, 0x80
byte_8033BB0: .byte 0x90, 0xC7, 0x0, 0x0
...
loc_8033C02:
	...
	lsl r4, r4, #2
	ldr r0, [r1,r4]
	ldr r1, byte_8033C58 // =0x80 
	ldr r2, off_8033C5C // =0x80 
	bl loc_8000AC4
	ldr r0, byte_8033C60 // =0x6 
	ldr r1, byte_8033C64 // =0x9c 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	pop {pc}
...
off_8033C24: .word byte_86C1B20
	...
	.word byte_86C1EA0
	.word byte_86C1E20
byte_8033C58: .byte 0x80, 0x73, 0x1, 0x6
off_8033C5C: .word 0x80
byte_8033C60: .byte 0x6, 0x0, 0x12, 0x40
byte_8033C64: .byte 0x9C, 0xC7, 0x0, 0x0
...
loc_8033C8E:
	strb r0, [r5,#6]
	ldr r0, byte_8033CE4 // =0xfd 
	ldr r1, byte_8033CE8 // =0xa0 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	ldr r0, byte_8033CEC // =0xd 
	ldr r1, byte_8033CE8 // =0xa0 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
...
byte_8033CD8: .byte 0x0, 0x74, 0x1, 0x6
off_8033CDC: .word 0x100
	.word byte_30016D0
byte_8033CE4: .byte 0xFD, 0x40, 0x17, 0x80
byte_8033CE8: .byte 0xA0, 0xC7, 0x0, 0x0
byte_8033CEC: .byte 0xD, 0x40, 0x17, 0xA0
...
loc_8033D0C:
	strb r0, [r5,#6]
	ldr r0, byte_8033D7C // =0xfd 
	ldr r1, byte_8033D80 // =0xa0 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	ldr r0, byte_8033D84 // =0xd 
	ldr r1, byte_8033D80 // =0xa0 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
...
off_8033D2C: .word byte_86C0EA0
	...
	.word byte_86C13A0
	.word byte_86C13A0
byte_8033D74: .byte 0x0, 0x74, 0x1, 0x6
off_8033D78: .word 0x100
byte_8033D7C: .byte 0xFD, 0x40, 0x17, 0x80
byte_8033D80: .byte 0xA0, 0xC7, 0x0, 0x0
byte_8033D84: .byte 0xD, 0x40, 0x17, 0xA0
...
loc_8033E9E:
	...
	sub r7, #4
	bge loc_8033E7A
	ldr r0, byte_8033ED8 // =0x0 
	ldr r1, byte_8033EE0 // =0x90 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	ldr r0, byte_8033EE4 // =0x0 
	ldr r1, byte_8033EE0 // =0x90 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
...
byte_8033ED8: .byte 0x0, 0x80, 0x0, 0x0
byte_8033EDC: .byte 0x92, 0xC7, 0x0, 0x0
byte_8033EE0: .byte 0x90, 0xC7, 0x0, 0x0
byte_8033EE4: .byte 0x0, 0x80, 0x28, 0x10
...
byte_8033F3C: .byte 0x0, 0xD0, 0x0, 0x6
...
sub_8033F80:
	...
	ldr r1, byte_8033FAC // =0x80 
	mov r2, #0x80
	bl loc_8000AC8
	ldr r0, off_8033FB0 // =byte_8033FB4 
	lsl r4, r4, #2
	ldr r0, [r0,r4]
	ldr r1, byte_8033FBC // =0xac 
	mov r2, #1
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
locret_8033FA4:
...
sub_8034268:
	...
	bl sub_80343B0 // () -> void
	pop {pc}
byte_803429C: .byte 0x41, 0x13, 0x0, 0x0
...
decompJackInAnimationGfx_8034314:
	...
	mov r0, #0
	strb r0, [r5,#3]
	ldr r0, [r3,#0x8] // (byte_8034408 - 0x8034400)
	strh r0, [r5,#6]
	bl sub_8046664 // () -> void
	// a1
	ldr r0, off_803436C // =byte_8034370 
...
sub_80343B0:
	...
	bne loc_80343CA
	mov r0, #0
	ldr r1, [r7,#0x8] // (byte_8034408 - 0x8034400)
	b loc_80343D0
loc_80343CA:
	add r0, #0xc
	add r3, r7, r0
...
loc_80343D0:
	...
	mov r2, #1
	// tileRefs
	ldr r3, off_803445C // =byte_2017A04 
	mov r4, #0x20 
	mov r5, #0x14
	bl copyTiles // (int j, int i, int cpyOff, u16 *tileRefs) -> void
	bl sub_80465BC
...
off_8034400: .word byte_2017A04
	.word byte_86C22C0
byte_8034408: .byte 0x2, 0x0, 0x0, 0x0
	.word byte_2017A04
	.word byte_86C22E0
	.word 0x2
	.word byte_2017A04
...
byte_8034474: .byte 0x0, 0x0, 0x0, 0x0
...
off_80348FC: .word byte_8034908
	.word byte_8034920
	.word 0xFFFFFFFF
byte_8034908: .byte 0xC, 0x0, 0x0, 0x0
	.word unk_3001B60
	.word 0xFF0E0F0C
	.word 0x80004210
	.word 0x1
	.word 0x0
byte_8034920: .byte 0xC, 0x0, 0x0, 0x0
	.word byte_3001750
	.word 0xFF0C0E0C
	.word 0x80004210
	.word 0x1
	.word 0x0
off_8034938: .word byte_8034944
	.word byte_803495C
	.word 0xFFFFFFFF
byte_8034944: .byte 0x8, 0x0, 0x0, 0x0
	.word unk_3001B60
	.word 0xFF0E0F0C
	.word 0x80004210
	.word 0x1
	.word 0x0
byte_803495C: .byte 0x8, 0x0, 0x0, 0x0
	.word byte_3001750
	.word 0xFF0C0E0C
	.word 0x80004210
	.word 0x1
	...
	.word byte_803497C
	.word 0xFFFFFFFF
byte_803497C: .byte 0xC, 0x0, 0x0, 0x0
	.word unk_3001B60
	.word 0xFF010F0C
	.word 0x80004210
	.word 0x1
	...
	.word byte_803499C
	.word 0xFFFFFFFF
byte_803499C: .byte 0xC, 0x0, 0x0, 0x0
	.word unk_3001B60
	.word 0xFF010F0C
	.word 0x80001084
	.word 0x2
...
sub_8034CB6:
	...
	cmp r7, #0x80
	bge loc_8034D4C
	ldr r3, off_8034D68 // =byte_8034D6C 
loc_8034CE2:
	ldr r0, [r3]
	mov r6, #0
	cmp r0, #0xff
...
loc_8034D44:
	...
	b loc_8034D52
loc_8034D4C:
	ldr r0, off_8034D64 // =byte_80988E4 
	bl init_s_02011C50_8036E90
loc_8034D52:
	mov r0, #1
	pop {r4-r7,pc}
...
off_8034D64: .word byte_80988E4
off_8034D68: .word byte_8034D6C
byte_8034D6C: .byte 0x2, 0x6, 0x0, 0x0
...
sub_8034D7C:
	...
	bl TestEventFlagFromImmediate // (int entryIdx, int byteFlagIdx) -> zf
	bne loc_8034DA4
	ldr r0, off_8034DAC // =byte_80991F4 
	bl init_s_02011C50_8036E90
	mov r0, #0
	pop {r4-r7,pc}
loc_8034DA4:
...
off_8034E64: .word byte_8034E74
	.word byte_8034E80
	.word byte_8034E84
byte_8034E70: .byte 0xFF, 0xFF, 0x0, 0x0
byte_8034E74: .byte 0x1, 0x4, 0x5, 0x1, 0x0, 0x0, 0x4, 0x0, 0x93, 0x1, 0x91, 0x0
byte_8034E80: .byte 0x1, 0x4, 0xFF, 0xFF
byte_8034E84: .byte 0x1, 0x4, 0xFF, 0xFF
...
sub_80351B4:
	push {r4-r7,lr}
	ldr r0, off_80351C0 // =byte_80351C4 
	bl sub_8030A60
	pop {r4-r7,pc}
	.byte 0, 0
off_80351C0: .word byte_80351C4
byte_80351C4: .byte 0xFF, 0x0, 0x0, 0x0
...
off_8035808: .word sub_8035920+1
	.word sub_8035924+1
	.word sub_8035932+1
	.word sub_8035962+1
	.word sub_8035992+1
...
sub_8035924:
	push {lr}
	mov r6, #1
	bl sub_80360C8 // () -> void .spoils R4, R6
	mov r7, r4
	mov r0, #1
	pop {pc}
...
off_80360E4: .word byte_80362A4
	...
	.byte 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0
	.byte 0x0
byte_80362A4: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80362EC: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036334: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036394: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80363F4: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036454: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80364B4: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA1C
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036514: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036574: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80365FC: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D100
	.word 0xFFFFFF01
	.word byte_804EA1C
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036684: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_803670C: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80367AC: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_803684C: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA1C+5
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_80368EC: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_803698C: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036A34: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA0D
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036ADC: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D100
	.word 0xFFFFFF01
	.word byte_804EA1C
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036B84: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036C2C: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D100
	.word 0xFFFFFF01
	.word byte_804EA1C
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036CD4: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FE
	.word 0xFFFFFF01
	.word byte_804EA12
	.word 0xFFFFFF02
	...
	.word 0xFFFFFFFF
	.word 0xFFFFFFFF
byte_8036D8C: .byte 0x0, 0xFF, 0xFF, 0xFF
	.word byte_804D0FC
	.word 0xFFFFFF01
	.word byte_804EA08
	.word 0xFFFFFF02
...
init_s_02011C50_8036E90:
	...
	str r1, [r5,#4]
	ldr r0, off_8036F20 // =byte_8037690 
...
sub_8036ED4:
	...
	bl ClearEventFlagFromImmediate // (u8 entryIdx, u8 byteFlagIdx) -> void
	pop {r4-r7,pc}
	thumb_func_end sub_8036ED4

	thumb_func_start sub_8036EFE
sub_8036EFE:
	push {r4-r7,lr}
	mov r1, r10
	ldr r1, [r1,#oToolkit_S2011c50_Ptr]
...
sub_8036F24:
	...
	mov r0, #0
	str r0, [r1,#0x1c] // s_02011C50.ptr_1C
	str r0, [r1,#0x40] // s_02011C50.unk_40
locret_8036F34:
	mov pc, lr
...
loc_8036F50:
	tst r2, r2
	mov pc, lr
off_8036F54: .word byte_80991F4
	thumb_func_end s_2011C50_8036F40
...
loc_8036F68:
	tst r2, r2
	mov pc, lr
off_8036F6C: .word byte_80988E4
	thumb_func_end sub_8036F58
...
loc_80370B0:
	mov r0, #1
	pop {pc}
	thumb_func_end sub_803705A

	thumb_local_start
sub_80370B4:
	mov r0, #0
	mov pc, lr
	thumb_func_end sub_80370B4
...
jt_big_803749C: .word sub_80376C4+1
	...
	.word sub_80384DC+1
	.word sub_80384F8+1
byte_8037690: .byte 0x11, 0x0, 0x0, 0x0
...
sub_80378EE:
	push {lr}
	ldr r0, off_8037900 // =byte_8037690 
	mov r6, #1
	bl sub_8036094
	str r0, [r5,r4]
	add r7, #2
...
loc_803856A:
	...
	beq loc_80385AE
	str r0, [r5,#0x1c]
	ldr r0, off_80385BC // =byte_8037690 
	mov r0, #0
	str r0, [r5,#0x38]
	mov r0, #0
	bl sub_80385D0
...
sub_8038630:
	...
	pop {r4-r7,pc}
	.byte 0, 0
byte_8038670: .byte 0x40, 0x13, 0x0, 0x0
...
byte_8038ACC: .byte 0xF6, 0x0, 0x0, 0x0
...
sub_8038B04:
	...
	pop {pc}
	.balign 4, 0x00
byte_8038B5C: .byte 0x40, 0x1F, 0x0, 0x0
...
loc_8038CA2:
	...
	ldrb r0, [r5,#6]
	bl sub_8039084
	ldr r0, byte_8038CEC // =0x95 
	strh r0, [r5,#4]
locret_8038CE8:
	pop {r4,pc}
	.balign 4, 0x00
byte_8038CEC: .byte 0x95, 0x0, 0x0, 0x0
...
sub_8038DB0:
	...
	strh r0, [r5,#4]
	bne locret_8038DDE
	ldr r0, byte_8038DC4 // =0xf 
	strh r0, [r5,#4]
	mov r0, #0x1c
	strb r0, [r5,#2]
	pop {pc}
byte_8038DC4: .byte 0xF, 0x0, 0x0, 0x0
loc_8038DC8:
	push {lr}
	ldrh r0, [r5,#4]
	sub r0, #1
...
sub_8038E14:
	...
	mov r0, #0x28 
	strb r0, [r5,#2]
	ldr r0, byte_8038E44 // =0xd6 
	strh r0, [r5,#4]
locret_8038E3A:
	pop {pc}
off_8038E3C: .word byte_80387FC
off_8038E40: .word byte_803888C
byte_8038E44: .byte 0xD6, 0x0, 0x0, 0x0
...
loc_8038EFE:
	...
	bl sub_8039198
	pop {pc}
byte_8038F08: .byte 0xFF, 0x3, 0x0, 0x0
...
byte_8038F94: .byte 0x0, 0x50, 0x0, 0x6
...
loc_8039032:
	...
	bl SWI_LZ77UnCompReadNormalWrite8bit // (void *src, void *dest) -> void
	pop {r4,pc}
byte_8039050: .byte 0x7, 0x6, 0x0, 0x0
...
sub_80390D8:
	...
	bl sub_8046670
	pop {pc}
byte_80390F0: .byte 0x8, 0x0, 0x0, 0x0
...
byte_8039168: .byte 0xD, 0x5, 0x0, 0x0
	thumb_func_end sub_80390F8

	thumb_local_start
sub_803916C:
	push {lr}
	ldr r2, byte_803917C // =0xb 
	mov r0, #0x3a 
	mov r1, #6
	bl sub_8046670
	pop {pc}
	.balign 4, 0x00
byte_803917C: .byte 0xB, 0x0, 0x0, 0x0
...
byte_80394CC: .byte 0x0, 0x0, 0x0, 0x0
...
locret_8039706:
	pop {r4-r7,pc}
byte_8039708: .byte 0x40, 0x1F, 0x0, 0x0
...
sub_8039864:
	...
	strb r0, [r5,#2]
	pop {r4-r7,pc}
byte_8039880: .byte 0x40, 0x12, 0x0, 0x0
...
sub_80398B0:
	...
	strb r0, [r5,#2]
	pop {r4-r7,pc}
byte_80398D8: .byte 0x40, 0x1F, 0x0, 0x0
...
sub_803993A:
	push {r4-r7,lr}
	ldr r7, off_8039958 // =byte_80394CC 
	bl sub_8046664 // () -> void
loc_8039942:
	ldr r0, [r7]
	cmp r0, #2
...
sub_8039A58:
	...
	pop {r4-r7,pc}
	.byte 0, 0
byte_8039AB0: .byte 0x40, 0x1F, 0x0, 0x0
...
loc_8039C6A:
	...
	bl sub_803A5F4
	beq loc_8039C7C
	ldr r1, off_8039C88 // =byte_8039C8C 
	lsl r0, r0, #2
	ldr r0, [r0,r1]
	mov lr, pc
	bx r0
loc_8039C7C:
	...
	bl sub_803CB0C
	pop {r4-r7,pc}
off_8039C88: .word byte_8039C8C
byte_8039C8C: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_8039C9C+1
	.word sub_8039CB4+1
	.word sub_8039CB4+1
...
sub_8039ECC:
	push {r4-r7,lr}
	ldr r0, off_8039EE0 // =byte_8039EE4 
	ldrb r1, [r5,#0x14]
	lsl r1, r1, #2
	ldr r0, [r0,r1]
	mov lr, pc
	...
	bl sub_803F9E4
	pop {r4-r7,pc}
off_8039EE0: .word byte_8039EE4
byte_8039EE4: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_8039F10+1
	.word sub_8039F24+1
	.word sub_8039F38+1
	.word sub_8039F48+1
...
sub_803A25C:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803A298: .byte 0x40, 0x1F, 0x0, 0x0
...
loc_803A31C:
	...
	mov r0, #1
	pop {r4-r7,pc}
byte_803A324: .byte 0x40, 0x7F, 0x0, 0x0
...
loc_803A3FC:
	...
	mov r0, #0
	pop {r4-r7,pc}
byte_803A404: .byte 0x40, 0x1F, 0x0, 0x0
...
sub_803A524:
	...
	beq loc_803A546
	bl sub_813D978
	ldr r3, off_803A550 // =byte_803A554 
	ldrb r0, [r3,r4]
	strb r0, [r5,#1]
	bl sub_8147F98
	mov r0, #1
...
loc_803A546:
	...
	pop {r4-r7,pc}
	.byte 0, 0
off_803A550: .word byte_803A554
byte_803A554: .byte 0x0, 0x50, 0x58, 0x0
...
sub_803A558:
	...
	beq loc_803A584
	bl sub_813D978
	ldr r3, off_803A5C0 // =byte_803A5C4 
	lsl r4, r4, #3
	add r3, r3, r4
	ldr r0, [r3]
	strb r0, [r5,#1]
...
loc_803A5B6:
	...
	pop {r4-r7,pc}
	.byte 0, 0
off_803A5C0: .word byte_803A5C4
byte_803A5C4: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_803C34E+1
	.word 0x50
	.word sub_813D750+1
	.word 0x58
...
sub_803A6E4:
	...
	strb r0, [r5,#1]
	pop {r4-r7,pc}
byte_803A73C: .byte 0x40, 0x1F, 0x0, 0x0
...
sub_803A9E6:
	...
	bl sub_803AFC2
	beq loc_803A9FA
	ldr r1, off_803AA08 // =byte_803AA0C 
	lsl r0, r0, #2
	ldr r0, [r1,r0]
	mov lr, pc
	bx r0
loc_803A9FA:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
off_803AA08: .word byte_803AA0C
byte_803AA0C: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_803AA24+1
	.word sub_803AA40+1
	.word sub_803ABF4+1
	.word sub_803AB6C+1
...
sub_803ACC6:
	...
	bl sub_803AFC2
	beq loc_803ACDA
	ldr r1, off_803ACE8 // =byte_803ACEC 
	lsl r0, r0, #2
	ldr r0, [r1,r0]
	mov lr, pc
	bx r0
loc_803ACDA:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
off_803ACE8: .word byte_803ACEC
byte_803ACEC: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_803AD04+1
	.word sub_803AD20+1
	.word sub_803AED8+1
	.word sub_803AE50+1
...
sub_803B184:
	...
	pop {r4-r7,pc}
	.byte 0, 0
byte_803B1C0: .byte 0x40, 0x1F, 0x0, 0x0
...
loc_803B86C:
	add sp, sp, #0xc
	pop {r4-r7,pc}
byte_803B870: .byte 0x0, 0x10, 0x0, 0x40
...
sub_803B8F8:
	...
	lsl r0, r0, #0x10
	orr r0, r1
	ldr r1, byte_803B914 // =0x0 
	orr r0, r1
	ldr r1, byte_803B918 // =0x80 
	add r1, r1, r4
	mov r2, #0
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803B914: .byte 0x0, 0x90, 0x0, 0x0
byte_803B918: .byte 0x80, 0xC0, 0x0, 0x0
...
loc_803B9DA:
	...
	bge loc_803B9DA
	pop {r4-r7,pc}
byte_803B9F8: .byte 0x0, 0x10, 0x0, 0x0
...
sub_803BA00:
	...
	lsl r0, r0, #0x10
	orr r0, r1
	ldr r1, byte_803BA20 // =0x0 
	orr r0, r1
	ldr r1, byte_803BA24 // =0x1e 
	mov r2, #2
	mov r3, #7
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	pop {r4-r7,pc}
byte_803BA20: .byte 0x0, 0x50, 0x0, 0x0
byte_803BA24: .byte 0x1E, 0x4, 0x0, 0x0
...
sub_803BAE2:
	push {r4-r7,lr}
	ldr r4, off_803BB24 // =byte_803BB28 
	lsl r0, r0, #1
	add r4, r4, r0
	ldrb r0, [r5,#0x13]
	add r0, #1
...
locret_803BB20:
	pop {r4-r7,pc}
	.balign 4, 0x00
off_803BB24: .word byte_803BB28
byte_803BB28: .byte 0x50, 0x10, 0xB0, 0x11
...
sub_803BBA4:
	...
	lsl r0, r0, #0x10
	orr r1, r0
	ldr r0, byte_803BBD4 // =0x0 
	orr r0, r1
	ldrb r2, [r5,#7]
	lsl r2, r2, #1
	ldr r1, off_803BBD8 // =byte_803BBDC 
	ldrh r1, [r1,r2]
	ldr r2, byte_803BC00 // =0x0 
	orr r1, r2
	mov r2, #2
	mov r3, #7
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
...
loc_803BBCE:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803BBD4: .byte 0x0, 0x10, 0x0, 0x40
...
sub_803BC02:
	...
	lsl r0, r0, #0x10
	orr r1, r0
	ldr r0, byte_803BC4C // =0x0 
	orr r0, r1
	ldr r6, byte_803BC50 // =0x0 
	orr r6, r1
	ldrb r2, [r5,#7]
	lsl r2, r2, #1
...
loc_803BC46:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803BC4C: .byte 0x0, 0x10, 0x0, 0x40
byte_803BC50: .byte 0x0, 0x90, 0x0, 0x0
...
loc_803BCD2:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803BCD8: .byte 0x0, 0x90, 0x0, 0x0
byte_803BCDC: .byte 0x0, 0x90, 0x0, 0x0
...
loc_803C3D0:
	strh r2, [r3,#0x6] // (word_2006776 - 0x2006770)
	mov pc, lr
byte_803C3D4: .byte 0xE7, 0x3, 0x0, 0x0
...
sub_803C59C:
	...
	lsl r0, r0, #0x10
	orr r1, r0
	ldr r0, byte_803C5F0 // =0x0 
	orr r0, r1
	ldr r1, byte_803C5F4 // =0xf4 
	mov r2, #0
	mov r3, #0
	bl sub_802FE28 // (u32 a1, u16 a2, int notUsed, int a4) -> void
	ldrb r0, [r5]
...
loc_803C5DE:
	...
	add r0, r0, r1
	ldr r1, byte_803C5FC // =0x80 
	mov r2, #0x80
	bl loc_8000AC8
locret_803C5EC:
	pop {r4-r7,pc}
	.byte 0, 0
byte_803C5F0: .byte 0x0, 0x0, 0x0, 0x40
byte_803C5F4: .byte 0xF4, 0xE3, 0x0, 0x0
off_803C5F8: .word dword_86A5300
byte_803C5FC: .byte 0x80, 0x7E, 0x1, 0x6
...
sub_803C620:
	...
	beq loc_803C642
	lsl r0, r0, #2
	ldr r1, off_803C64C // =byte_803C650 
	ldr r0, [r1,r0]
	mov lr, pc
	bx r0
loc_803C642:
...
off_803C64C: .word byte_803C650
byte_803C650: .byte 0x0, 0x0, 0x0, 0x0
	.word sub_803C6A8+1
	.word sub_803C6C0+1
	.word sub_803C6D8+1
	.word sub_803C6F4+1
...
loc_803C74A:
	...
	mov r1, #0
	pop {pc}
byte_803C750: .byte 0x9, 0x0, 0x0, 0x0
	thumb_func_end sub_803C730

	thumb_func_start sub_803C754
sub_803C754:
	push {lr}
	ldr r0, byte_803C768 // =0x32 
	bl sub_813D9A0
	mov r0, #0
	strb r0, [r7]
	mov r0, #1
	...
	pop {pc}
	.balign 4, 0x00
byte_803C768: .byte 0x32, 0x0, 0x0, 0x0
...
loc_803C966:
	...
	pop {pc}
	.balign 4, 0x00
byte_803C978: .byte 0x1, 0x0, 0x0, 0x0
...
sub_803CBD0:
	...
	pop {r4-r7,pc}
	.byte 0, 0
byte_803CC10: .byte 0x40, 0x1F, 0x0, 0x0
...
copyData_803CC60:
	...
	bl sub_800183C
	// initRefs
	ldr r0, off_803CC84 // =byte_803CC88 
	bl decompAndCopyData_8000B30 // (u32 *initRefs) -> void
	// j
	mov r0, #0
	// i
	...
	bl copyTiles // (int j, int i, int cpyOff, u16 *tileRefs) -> void
	pop {r4-r7,pc}
off_803CC84: .word byte_803CC88
byte_803CC88: .byte 0x80, 0x69, 0x7E, 0x88, 0x20, 0x0, 0x0, 0x6
	.word decomp_2013A00
...
sub_803CCFC:
	...
	pop {r4-r7,pc}
	.balign 4, 0x00
byte_803CD3C: .byte 0x40, 0x1F, 0x0, 0x0
...
loc_803D024:
	mov r0, #1
	pop {r4-r7,pc}
byte_803D028: .byte 0x3F, 0x42, 0xF, 0x0
...
loc_803D0AC:
	mov r0, #1
	pop {r4-r7,pc}
byte_803D0B0: .byte 0xF, 0x27, 0x0, 0x0
...
loc_803D25E:
	...
	pop {pc}
	.byte 0, 0
byte_803D270: .byte 0x40, 0x1F, 0x0, 0x0
...
copyData_803D2B8:
	...
	bl sub_800183C
	// initRefs
	ldr r0, off_803D2EC // =byte_803D2F0 
	bl decompAndCopyData_8000B30 // (u32 *initRefs) -> void
	// j
	mov r0, #0
	// i
	...
	bl copyTiles // (int j, int i, int cpyOff, u16 *tileRefs) -> void
	pop {r4-r7,pc}
off_803D2EC: .word byte_803D2F0
byte_803D2F0: .byte 0x28, 0x35, 0x6C, 0x88, 0x20, 0x0, 0x0, 0x6
	.word unk_2014A00
...
off_803DC78: .word word_2036780
	...
	.word unk_201F5A0
	.byte 0, 0, 0, 0
	thumb_func_end copyData_803D2B8
...
loc_803E04A:
	...
	.word byte_803E0FE
	.word byte_803E108
byte_803E088: .byte 0x14, 0x3, 0x49, 0x44, 0x28, 0x25, 0x44, 0x29, 0x0
byte_803E091: .byte 0x14, 0x4, 0x50, 0x4C, 0x20, 0x4E, 0x55, 0x4D, 0x28
	.byte 0x25, 0x44, 0x29, 0x0
byte_803E09E: .byte 0x14, 0x2, 0x53, 0x49, 0x4F, 0x20, 0x57, 0x41, 0x49
	.byte 0x54, 0x0
byte_803E0A9: .byte 0x14, 0x2, 0x53, 0x49, 0x4F, 0x20, 0x4F, 0x46, 0x46
	.byte 0x0
byte_803E0B3: .byte 0x14, 0x2, 0x53, 0x49, 0x4F, 0x20, 0x4F, 0x4E, 0x0
byte_803E0BC: .byte 0x14, 0x2, 0x53, 0x49, 0x4F, 0x20, 0x45, 0x52, 0x52
	.byte 0x4F, 0x52, 0x0
byte_803E0C8: .byte 0x14, 0x2, 0x53, 0x49, 0x4F, 0x20, 0x45, 0x52, 0x52
	.byte 0x4F, 0x52, 0x32, 0x0
byte_803E0D5: .byte 0x14, 0xA, 0x53, 0x54, 0x3A, 0x30, 0x78, 0x25, 0x58
	.byte 0x0
byte_803E0DF: .byte 0x14, 0x5, 0x52, 0x4E, 0x4F, 0x3A, 0x30, 0x78, 0x25
	.byte 0x58, 0x0
byte_803E0EA: .byte 0x14, 0xD, 0x52, 0x45, 0x43, 0x56, 0x3A, 0x25, 0x58
	.byte 0x0
byte_803E0F4: .byte 0x14, 0xE, 0x52, 0x45, 0x43, 0x56, 0x3A, 0x25, 0x58
	.byte 0x0
byte_803E0FE: .byte 0x14, 0xF, 0x52, 0x45, 0x43, 0x56, 0x3A, 0x25, 0x58
	.byte 0x0
byte_803E108: .byte 0xA, 0x6, 0x53, 0x3A, 0x25, 0x44, 0x2C, 0x52, 0x3A, 0x25
	.byte 0x44, 0x0
...
sub_803E268:
	push {r4-r7,lr}
	ldr r4, off_803E278 // =byte_200F360 
...
loc_803E2A8:
	...
	mov r1, #1
	mul r1, r3
	ldr r5, off_803E340 // =byte_803E344 
	mov r6, #0
loc_803E2C4:
	ldrh r0, [r4,r1]
	ldrh r3, [r5,r6]
	and r3, r0
	push {r1}
	ldr r1, byte_803E338 // =0x0 
	cmp r3, r1
	pop {r1}
	beq loc_803E2DE
	push {r1}
	ldr r1, byte_803E33C // =0x0 
	cmp r3, r1
	pop {r1}
	bne loc_803E330
loc_803E2DE:
...
loc_803E330:
	...
	pop {pc}
	.balign 4, 0x00
byte_803E338: .byte 0x0, 0x20, 0x0, 0x0
byte_803E33C: .byte 0x0, 0x10, 0x0, 0x0
off_803E340: .word byte_803E344
byte_803E344: .byte 0x0, 0x20, 0x0, 0x10
byte_803E348: .byte 0x4A, 0x42, 0x52, 0x42
...
loc_803E3FE:
	...
	mov r0, #1
	pop {pc}
byte_803E404: .byte 0x10, 0x10, 0x0, 0x0
byte_803E408: .byte 0x4A, 0x42, 0x52, 0x42
...
loc_803E53A:
	...
	pop {r4-r7,pc}
	.word byte_803E544
byte_803E544: .byte 0x0, 0x20, 0x10, 0x10
...
sub_803E7A4:
	...
	mov r7, r0
	bl sub_803DD30
	ldr r1, off_803E7C8 // =byte_803E7D4 
	ldrb r0, [r1,r0]
	cmp r0, #0xff
	beq loc_803E7C2
	mov r1, #8
...
locret_803E7C6:
	pop {r4-r7,pc}
off_803E7C8: .word byte_803E7D4
off_803E7CC: .word byte_2009940
	.word sCamera+0x50 // sCamera.unk_50
byte_803E7D4: .byte 0x2, 0xFF, 0xFF, 0x4
...
sub_803EA58:
	...
	thumb_func_start sub_803EA60
sub_803EA60:
	ldr r1, off_803EBF8 // =byte_200BC30 
	ldrb r0, [r1]
	mov pc, lr
	.balign 4, 0x00
	thumb_func_end sub_803EA60

	thumb_func_start sub_803EA68
sub_803EA68:
	push {lr}
	bl sub_803EA60
	pop {pc}
	thumb_func_end sub_803EA68

	thumb_func_start sub_803EA70
sub_803EA70:
	ldr r1, off_803EBF8 // =byte_200BC30 
	strb r0, [r1]
	mov pc, lr
	.balign 4, 0x00
	thumb_func_end sub_803EA70
...
sub_803EA98:
	...
	ldr r1, byte_803EAB4 // =0xc0 
	str r1, [r0]
	pop {pc}
	.byte 0, 0
off_803EAB0: .word dword_200F444
byte_803EAB4: .byte 0xC0, 0xA6, 0x0, 0x0
...
sub_803EBEC:
	...
	thumb_func_start sub_803EBF4
sub_803EBF4:
	ldr r0, off_803EBF8 // =byte_200BC30 
	mov pc, lr
off_803EBF8: .word byte_200BC30
	thumb_func_end sub_803EBF4
...
sub_803ECFC:
	...
	pop {pc}
	.word dword_200B1B0
byte_803ED18: .byte 0xFE, 0x0, 0x0, 0x0
...
byte_803EE8C: .byte 0x0, 0x8, 0x0, 0x0
off_803EE90: .word sSubmenu
byte_803EE94: .byte 0x0, 0x10, 0x0, 0x0
...
loc_803F1B8:
	mov r0, r7
	pop {r4-r7,pc}
byte_803F1BC: .byte 0xFE, 0x0, 0x0, 0x0
...
loc_803F3D0:
	mov r0, r4
	pop {r4-r7,pc}
byte_803F3D4: .byte 0xFE, 0x0, 0x0, 0x0
...
byte_803F5F8: .byte 0x27, 0x1, 0x0, 0x0
...
locret_803F65C:
	pop {r4,pc}
	.balign 4, 0x00
byte_803F660: .byte 0xC0, 0xA6, 0x0, 0x0
...
sub_803F6B0:
	...
	mov r0, #0
	mov r1, #0
	ldr r2, off_803F730 // =byte_803F734 
	lsl r4, r4, #2
	ldr r2, [r2,r4]
	bl byte_813DBC0
...
sub_803F6F4:
	...
	bl SetEventFlagFromImmediate // (u8 entryIdx, u8 byteFlagIdx) -> void
	pop {r4,r5,pc}
off_803F730: .word byte_803F734
byte_803F734: .byte 0x0, 0x40, 0x0, 0x0
...
loc_803F7C2:
	...
	ldr r1, byte_803F890 // =0x10 
	bl sub_8006DF6
	mov r7, #0
loc_803F7DC:
	ldr r0, off_803F888 // =timer_2000000 
	ldr r1, byte_803F88C // =0x0 
	ldr r2, byte_803F890 // =0x10 
	push {r0-r2}
	bl sub_814D954
	pop {r0-r2}
	push {r0-r3,r7}
...
byte_803F88C: .byte 0x0, 0x1, 0x0, 0xE
byte_803F890: .byte 0x10, 0x67, 0x0, 0x0
...
byte_803F8F0: .byte 0xF, 0x67, 0x0, 0x0
...
byte_803F9D8: .byte 0x0, 0x7E, 0x0, 0xE
...
byte_803FAA8: .byte 0x80, 0x7E, 0x0, 0xE
...
byte_803FB20: .byte 0x80, 0x7F, 0x0, 0xE
...
sub_803FB64:
	...
	strh r0, [r5,#4]
	pop {pc}
byte_803FB98: .byte 0x40, 0x1F, 0x0, 0x0
...
byte_803FC10: .byte 0x0, 0x0, 0x40, 0xA2
...
copyData_803FC64:
	...
	bl sub_80027C4
	// initRefs
	ldr r0, off_803FCA0 // =byte_803FCA4 
	bl decompAndCopyData_8000B30 // (u32 *initRefs) -> void
	bl sub_800183C
	// j
	mov r0, #0
	...
	mov r2, #2
	// tileRefs
	ldr r3, off_803FCD8 // =byte_2017A04 
	mov r4, #0x1e
	mov r5, #0x14
	bl copyTiles // (int j, int i, int cpyOff, u16 *tileRefs) -> void
	pop {r5,pc}
	.byte 0, 0
off_803FCA0: .word byte_803FCA4
byte_803FCA4: .byte 0xD0, 0x41, 0x6C, 0x88, 0x0, 0x0, 0x0, 0x6
	.word decomp_2013A00
	.word dword_86C4660
	.word byte_3001960
	.word 0x20
...
byte_803FCE4: .byte 0x0, 0x2A, 0x0, 0x0, 0x0, 0x54, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0
	thumb_func_end copyData_803FC64

	thumb_func_start sub_803FCF0
sub_803FCF0:
	push {lr}
	mov r0, r10
	// memBlock
