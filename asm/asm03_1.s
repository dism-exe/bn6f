...
sub_8034D7C:
	...
	bl isActiveFlag_2001C88_entry // (int entryIdx, int byteFlagIdx) -> zf
	bne loc_8034DA4
	ldr r0, off_8034DAC // =dword_80991F4 
	bl init_s_02011C50_8036E90
	mov r0, #0
	pop {r4-r7,pc}
loc_8034DA4:
...
off_8034DAC: .word dword_80991F4
...
sub_8034F68:
	...
	tst r0, r0
	beq locret_8034FA8
	ldr r0, off_8034FB0 // =unk_8098384 
	ldr r1, [r3]
	bl init_s_02011C50_8036E90
locret_8034FA8:
	pop {r4-r7,pc}
...
sub_8035054:
	...
	bl isActiveFlag_2001C88_entry // (int entryIdx, int byteFlagIdx) -> zf
	beq loc_803507A
	ldr r0, off_8035080 // =unk_809AE68 
	bl init_s_02011C50_8036E90
	mov r0, #0
	pop {r4-r7,pc}
loc_803507A:
...
init_s_02011C50_8036E90:
	push {r5,lr}
	mov r5, r10
	ldr r5, [r5,#0x10] // s_02011C50.unk_10
	push {r0,r1}
	add r0, r5, #0
	mov r1, #0x90
	bl CpuSet_ZeroFillWord // (void *memBlock, int size) -> void
...
sub_8036ED4:
	push {r4-r7,lr}
	mov r1, r10
	ldr r1, [r1,#0x10] // Toolkit.s_2011C50
	mov r0, #1
	...
	mov r1, r10
	ldr r1, [r1,#0x40] // s_02011C50.unk_40
	mov r0, #0
...
sub_8036EFE:
	push {r4-r7,lr}
	mov r1, r10
	ldr r1, [r1,#0x10] // s_02011C50.unk_10
	mov r0, #1
	str r0, [r1,#0x1c] // s_02011C50.ptr_1C
	ldr r0, off_8036F20 // =dword_8037690 
	str r0, [r1,#0x20] // s_02011C50.ptr_20
...
s_2011C50_8036F40:
	...
	ldr r1, off_8036F54 // =dword_80991F4 
	cmp r0, r1
	beq loc_8036F50
	mov r2, #0
loc_8036F50:
	tst r2, r2
	mov pc, lr
off_8036F54: .word dword_80991F4
...
ho_803851C:
	...
	push {r4,r5}
	mov r5, r10
	ldr r5, [r5,#0x10] // Toolkit.s_2011C50
	mov r0, #0
	strb r0, [r5,#0x12]
	mov r0, #0x1c
	mov r8, r0
...
loc_8038C54:
	...
	strb r0, [r5,#2]
	bl sub_8039074
	ldr r0, off_8038C70 // =unk_803875C 
	bl sub_8001B1C
	mov r0, #4
	strh r0, [r5,#4]
locret_8038C6C:
...
sub_803B522:
	...
	ldrb r4, [r7,#1]
	ldrb r5, [r7,#2]
	ldr r6, off_803B638 // =unk_86ACD60 
	ldr r7, [r7,#8]
	mov r0, r8
	cmp r0, #0xa
	bge loc_803B562
...
loc_803BE4C:
	...
	mov r4, #1
	mov r5, #1
	ldr r6, off_803BEBC // =unk_86ACD60 
	bl sub_8045FD0
	pop {r4-r7}
	add r4, #8
	add r6, #0x80
