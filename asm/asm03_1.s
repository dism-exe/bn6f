...
sub_8034D7C:
    ...
    bl isActiveFlag_2001C88_entry // (int entryIdx, int byteFlagIdx) -> zf
    bne loc_8034DA4
    ldr r0, dword_8034DAC // =dword_80991F4 
    bl init_s_02011C50_8036E90
    mov r0, #0
    pop {r4-r7,pc}
loc_8034DA4:
...
sub_8035924:
    push {lr}
    mov r6, #1
    bl sub_80360C8 // () -> void .spoils R4, R6, R7
    add r7, r4, #0
    mov r0, #1
    pop {pc}
.endfunc // sub_8035924
...
loc_8037BEA:
    ...
    mov r6, #1
    bl sub_8036094
    ldr r3, off_8037C30 // =unk_8037C34 
    ldr r3, [r3,r4]
    mov lr, pc
    bx r3
    .hword 0x7C28
    .word 0x74283801, 0x2008DC05, 0xFCD6F000, 0x2001370A
    .byte 0x0, 0xBD
loc_8037C2A:
    mov r0, #0
    pop {pc}
    .byte  0
    .byte  0
off_8037C30:    .word unk_8037C34
unk_8037C34:    .byte 0xA5
    .byte 0xE1
    .byte  9
    .byte  8
    .byte 0x89
...
loc_8037C76:
    ...
    lsl r0, r0, #8
    add r1, r0, #0
    ldr r4, off_8037CB0 // =unk_8037CB4 
    lsl r3, r3, #1
    ldrsb r2, [r4,r3]
    mul r0, r2
    add r3, #1
...
loc_8037CAA:
    ...
    .byte  0
    .byte  0
off_8037CB0:    .word unk_8037CB4
unk_8037CB4:    .byte 0x10
    .byte 0xF0
    .byte 0x10
    .byte  0
    .byte  8
...
sub_8039864:
    ...
    mov r0, #0
    bl sub_803BB7C
    ldr r0, off_8039884 // =unk_80393A4 
    str r0, [r5,#0x2c]
    mov r0, #4
    strb r0, [r5,#2]
    pop {r4-r7,pc}
dword_8039880:    .word 0x1240
off_8039884:    .word unk_80393A4
.endfunc // sub_8039864
...
sub_8039A58:
    ...
    bl sub_8046664 // () -> void
    // a1
    ldr r0, off_8039AB4 // =unk_8039390 
    bl sub_80465A0 // (void *a1) -> void
    bl sub_803C40C
    mov r0, #0xf0
    mov r1, #0x30 
