...
sub_8034DB0:
    ...
    cmp r0, #0
    beq loc_8034DCA
    ldr r0, off_8034E30 // =unk_809A8A8 
    bl init_s_02011C50_8036E90
    mov r0, #0
    pop {r4-r7,pc}
loc_8034DCA:
...
loc_8034DEE:
    ...
    bl sub_8034E88
    bne loc_8034E08
    ldr r0, off_8034E34 // =unk_809AA34 
    bl init_s_02011C50_8036E90
    mov r0, #0
    pop {r4-r7,pc}
loc_8034E08:
...
off_8034E30:    .word unk_809A8A8
off_8034E34:    .word unk_809AA34
...
unk_8034EEE:    .byte 0xF9
unk_8034EEF:    .byte 0xF8
.endfunc // sub_8034E88
...
loc_8034F42:
    ...
    cmp r1, #0xff
    beq locret_8034F56
    ldr r0, off_8034F64 // =unk_8098358 
    bl init_s_02011C50_8036E90
locret_8034F56:
    pop {r4-r7,pc}
...
sub_8035084:
    ...
    beq loc_803509E
    add r1, r0, #0
    ldr r0, off_80350A4 // =unk_8098BB8 
    bl init_s_02011C50_8036E90
    mov r0, #0
    pop {r4-r7,pc}
loc_803509E:
...
loc_80352A6:
    ...
    bl isActiveFlag_2001C88_bitfield // (u16 entryFlagBitfield) -> zf
    bne loc_80352CE
    ldr r0, off_8035328 // =unk_80990B8 
    ldr r1, [r5]
    bl init_s_02011C50_8036E90
    b locret_80352D4
loc_80352CE:
...
off_8036EC4:    .word LCDControl
    .word 0x0, 0x0, 0x0
.endfunc // init_s_02011C50_8036E90
...
s_2011C50_ptr_1C_isNull:
    ...
    tst r0, r0
    mov pc, lr
.endfunc // s_2011C50_ptr_1C_isNull
...
.endfunc // sub_8038B04
    ...
    bl sub_80468BA
    bl sub_8046664 // () -> void
    ldr r0, off_8038B60 // =unk_80386E8 
    bl sub_80467FC
    bl chatbox_8040818
    mov r0, #8
    mov r1, #8
...
sub_8038F9C:
    ...
    mov r2, #3
    // tileRefs
    ldr r3, off_8038FB0 // =unk_8038700 
    mov r4, #0x17
    mov r5, #2
    bl copyTiles // (int j, int i, int cpyOff, u16 *tileRefs) -> void
.endfunc // sub_8038F9C
...
sub_803993A:
    push {r4-r7,lr}
    ldr r7, off_8039958 // =unk_80394CC 
    bl sub_8046664 // () -> void
loc_8039942:
    ldr r0, [r7]
    cmp r0, #2
...
sub_803A2CC:
    ...
    mov r0, #0x11
    strb r0, [r3,#0xa]
    ldr r0, off_803A328 // =unk_80392A8 
    bl sub_8001B1C
...
loc_803B828:
    ...
    ldr r2, [sp]
    add r1, r2, #0
    ldr r3, off_803B878 // =unk_80391A8 
    ldrb r3, [r3,r0]
    lsl r3, r3, #3
    ...
    orr r0, r1
    ldr r1, [sp,#8]
    ldr r2, off_803B878 // =unk_80391A8 
    ldrb r3, [r7]
    ldrb r2, [r2,r3]
    lsl r2, r2, #2
    add r1, r1, r2
