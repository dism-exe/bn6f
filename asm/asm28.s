...
.endfunc // sub_809A334
    ...
    mov r5, #2
    bl drawTiles // (int a1, int a2, int a3) -> void
    ldr r0, off_809A3AC // =dword_86C580C 
    mov r1, #0x40 
...
loc_809A64E:
    ...
    bl sub_809A308
    bl sub_8046664
    ldr r0, dword_809A6A0 // =0x8099E90 
    bl sub_80465A0
    ldr r0, [r5,#0x7c]
    mov r1, #0x80
    ldr r1, [r5,r1]
...
.endfunc // sub_809A80C
    ...
    mov r1, #2
    mov r2, #0
    ldr r3, dword_809A854 // =0x8099E78 
    mov r4, #6
    mov r5, #2
    bl drawTiles // (int a1, int a2, int a3) -> void
...
.endfunc // sub_809A880
    ...
    mov r0, #0
    strb r0, [r5,#4]
    ldr r0, off_809A988 // =dword_809A898 
    bl sub_80465A0
    ldr r0, [r5,#0x7c]
    mov r1, #0x80
    ldr r1, [r5,r1]
...
sub_809CF2C:
    ...
    ldr r1, off_809CF58 // =sReqBBS_GUI 
...
loc_809DFDC:
    ...
    ldrb r0, [r5,r3]
    ldrb r2, [r5,#0x10]
    ldr r7, off_809DFF8 // =unk_809DFFC 
    ldrb r1, [r7,r2]
    orr r0, r1
    strb r0, [r5,r3]
    cmp r0, #0xf
...
sub_809E01C:
    push {lr}
    ldr r7, off_809E044 // =sReqBBS_GUI+48 
...
loc_809E570:
    push {lr}
    ldr r7, dword_809E58C // =0x809E580 
    ldrb r0, [r5,#8]
    ldr r7, [r7,r0]
    mov lr, pc
    bx r7
...
loc_809E6DC:
    push {lr}
    ldr r7, dword_809E700 // =0x809E6F0 
    ldrb r0, [r5,#0xa]
    ldr r7, [r7,r0]
    mov lr, pc
    bx r7
...
sub_809E8CC:
    push {lr}
    ldr r7, off_809E8F8 // =off_809E8E0 
    ldrb r0, [r5,#0xa]
    ldr r7, [r7,r0]
    mov lr, pc
    bx r7
...
loc_809EBDE:
    ...
    ldrb r0, [r6]
    lsl r0, r0, #2
    ldr r7, off_809EC2C // =off_809EC30 
    ldr r7, [r7,r0]
    mov lr, pc
    bx r7
    str r6, [r5,#0x4c]
...
off_809EFF8:    .word 0x100
    push {lr}
    bl getPETNaviSelect
    ldr r1, dword_809F018 // =unk_809D328 
    ldrb r0, [r1,r0]
    strh r0, [r5,#0x3c]
    mov r0, #0x18
    str r0, [r5,#0x78]
...
.endfunc // sub_809F656
    ...
    push {r7}
    mov r3, #0x10
    ldr r7, off_809F688 // =sReqBBS_GUI+48 
loc_809F672:
    ldrb r1, [r7,#0x10]
    cmp r1, r0
    beq loc_809F680
...
sub_809F68C:
    push {lr}
    ldr r3, off_809F6A4 // =sReqBBS_GUI+48 
