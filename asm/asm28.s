...
sub_809CF2C:
    ...
    tst r0, r0
    beq locret_809CF4E
    ldr r0, [pc, #0x809cf50-0x809cf3c-4] // =loc_809CEB4
...
sub_809D270:
    ...
    strb r0, [r5]
    bl getPETNaviSelect
    ldr r4, [pc, #0x809d324-0x809d27a-2] // =loc_809D328
    ldrb r4, [r4,r0]
    mov r6, #0x18
    mov r7, r10
    ldr r7, [r7,#0x3c]
...
loc_809DFDC:
    ...
    ldrb r0, [r5,r3]
    ldrb r2, [r5,#0x10]
    ldr r7, [pc, #0x809dff8-0x809dfe2-2] // =loc_809DFFC
    ldrb r1, [r7,r2]
    orr r0, r1
    strb r0, [r5,r3]
    cmp r0, #0xf
...
loc_809E6DC:
    ...
    b off_809E6A8+2
    lsr r1, r1, #0x20
    strex.w r8, r0, loc_809E720
    ldrd.w r0, r8, [r9],#-0x24
...
loc_809E872:
    ...
    sub r0, #1
    strb r0, [r5,#4]
    ldr r0, [pc, #0x809e8c0-0x809e884-4] // =loc_809E8C4
    ldrb r1, [r5,#6]
    lsl r1, r1, #1
    ldrb r2, [r0,r1]
    add r1, #1
...
sub_809E95E:
    ...
    ldrb r3, [r5,r3]
    lsl r3, r3, #1
    ldr r2, [pc, #0x809e9b4-0x809e974-4] // =loc_809E9B8
    ldrb r0, [r2,r3]
    add r3, #1
    ldrb r1, [r2,r3]
    mov r3, #7
...
loc_809E9B8:
    ...
    ldrb r3, [r5,r3]
    lsl r3, r3, #1
    ldr r2, [pc, #0x809ea30-0x809e9f0-4] // =loc_809EA34
    ldrb r0, [r2,r3]
    add r3, #1
    ldrb r1, [r2,r3]
    mov r3, #7
...
off_809EFF8:    .word 0x100
    push {lr}
    bl getPETNaviSelect
    ldr r1, [pc, #0x809f018-0x809f002-2] // =loc_809D328
    ldrb r0, [r1,r0]
    strh r0, [r5,#0x3c]
    mov r0, #0x18
    str r0, [r5,#0x78]
