...
sub_809CF2C:
    ...
    ldr r1, [pc, #0x809cf58-0x809cf3e-2] // =sReqBBS_GUI
...
sub_809E01C:
    push {lr}
    ldr r7, [pc, #0x809e044-0x809e01e-2] // =sReqBBS_GUI+48
...
sub_809E704:
    ...
    bl SWI_Div
    pop {r5}
    ldr r1, [pc, #0x809e7d4-0x809e732-2] // =0xFFF
    add r0, r0, r1
    lsr r0, r0, #0xc
    strh r0, [r5,#0x20]
    ldr r7, [pc, #0x809e7c0-0x809e73a-2] // =0x809E79E
    ldrb r0, [r5,#0xe]
    add r0, r0, r0
    add r7, r7, r0
    ldrb r4, [r5,#4]
...
sub_809F612:
    ...
    strb r0, [r5,#0xa]
    ldr r0, [r5,#0x60]
    ldr r1, [pc, #0x809f6b4-0x809f622-2] // =0x1002
    tst r0, r1
    bne loc_809F632
    ldrb r0, [r5,#0x14]
    bl sprite_setAnimation
...
.endfunc // sub_809F656
    ...
    push {r7}
    mov r3, #0x10
    ldr r7, [pc, #0x809f688-0x809f670-4] // =sReqBBS_GUI+48
loc_809F672:
    ldrb r1, [r7,#0x10]
    cmp r1, r0
    beq loc_809F680
...
sub_809F68C:
    push {lr}
    ldr r3, [pc, #0x809f6a4-0x809f68e-2] // =sReqBBS_GUI+48
