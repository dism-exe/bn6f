...
loc_808F8A6:
    ...
    pop {r4-r7,pc}
    .balign 4, 0x00
.endfunc // end of function sub_808F810
...
.endfunc // end of function sub_808F8AC

    bl sub_8002F90
    bl anim_80026C4
    ldr r1, [pc, #0x808f8fc-0x808f8d6-2] // =off_808F5D4
    ldr r1, [r1]
...
off_808F8FC:    .word off_808F5D4
    push {r4-r7,lr}
    ldr r5, [pc, #0x808fb48-0x808f902-2] // =off_808F5D4
    ldr r5, [r5]
    ldrb r4, [r5,#0x2] // (byte_2000312 - 0x2000310)
    cmp r4, #0
    bgt loc_808F92C
...
sub_808F990:
    ...
    bl sprite_setAnimation
    bl sprite_loadAnimationData_80026A4
.endfunc // end of function sub_808F990
...
sub_808F9C4:
    push {r4-r7,lr}
    ldr r5, [pc, #0x808fb48-0x808f9c6-2] // =off_808F5D4
    ldr r5, [r5]
    mov r4, #0
    bl sub_808FA38
    bl sub_809E1AE
    add r6, r0, #0
    add r7, r1, #0
    ldr r2, [pc, #0x808fa34-0x808f9d8-4] // =0x10000
    add r0, r6, #0
...
.endfunc // end of function sub_808F9C4

.func .thumb
sub_808FA38:
    push {r4,r5,lr}
    ldr r5, [pc, #0x808fb48-0x808fa3a-2] // =off_808F5D4
    ldr r5, [r5]
    bl sub_809E1AE
    add r2, r0, #0
    add r3, r1, #0
    ...
    beq locret_808FA6E
    add r4, r0, #0
    ldr r0, [pc, #0x808fa70-0x808fa5c-4] // =dword_808FA74
    ldrb r0, [r0,r4]
    add r4, r0, #0
...
.endfunc // end of function sub_808FA38
...
sub_808FA7C:
    ...
    b loc_808FA90
    .balign 4, 0x00
.endfunc // end of function sub_808FA7C
...
sub_808FA84:
    ...
    b loc_808FA90
    .balign 4, 0x00
.endfunc // end of function sub_808FA84
...
sub_808FA8C:
    ...
    mov r0, #2
loc_808FA90:
    ldr r5, [pc, #0x808fb48-0x808fa90-4] // =off_808F5D4
    ldr r5, [r5]
    mov r4, r10
    ldr r4, [r4,#0x3c]
    ldrb r3, [r4,#4]
...
loc_808FAA4:
    ...
    cmp r0, #0
    bne loc_808FAB0
    ldr r0, [pc, #0x808fadc-0x808faac-4] // =off_808FAE8
    b loc_808FABC
loc_808FAB0:
    cmp r0, #1
    bne loc_808FAB8
    ldr r0, [pc, #0x808fae0-0x808fab4-4] // =off_808FAF8
    b loc_808FAC2
loc_808FAB8:
    ldr r0, [pc, #0x808fae4-0x808fab8-4] // =loc_808FB08
    b loc_808FAC2
loc_808FABC:
    mov r1, #8
    mul r1, r6
...
.endfunc // end of function sub_808FA8C
...
loc_808FB08:
    ...
    bl sub_808F990
    bl sub_809E23C
    ldr r1, [pc, #0x808fb48-0x808fb3a-2] // =off_808F5D4
    ldr r1, [r1]
    mov r0, #0
...
sub_808FBA0:
    ...
    pop {pc}
    .byte 0, 0
.endfunc // end of function sub_808FBA0

    push {r5,lr}
    ldr r5, [pc, #0x808fce0-0x808fbc2-2] // =off_808F5D4
    ldr r5, [r5]
    mov r0, #0
    bl sub_80301B2
    ...
    pop {r5,pc}
    push {r5,lr}
    ldr r5, [pc, #0x808fce0-0x808fbee-2] // =off_808F5D4
    ldr r5, [r5]
    mov r0, #0
    bl sub_80301B2
    mov r0, r10
...
loc_808FC08:
    lsl r1, r1, #2
    ldr r2, [pc, #0x808fc20-0x808fc0a-2] // =dword_808FC24
    ldrh r0, [r2,r1]
    lsl r0, r0, #0x10
    add r1, #2
    ldrh r1, [r2,r1]
...
off_808FCE0:    .word off_808F5D4
    ...
    pop {pc}
    push {r5,lr}
    ldr r5, [pc, #0x808fd60-0x808fcf2-2] // =off_808F5D4
    ldr r5, [r5]
    bl sub_809E2B8
    ldr r1, [pc, #0x808fd10-0x808fcfa-2] // =loc_808FD14
    ldrb r0, [r1,r0]
...
loc_808FD14:
    ...
    lsl r3, r0, #0xc
    push {r4,r5,lr}
    ldr r5, [pc, #0x808fd60-0x808fd1e-2] // =off_808F5D4
    ldr r5, [r5]
...
loc_808FD76:
    lsl r1, r1, #3
    ldr r4, [pc, #0x808fd94-0x808fd78-4] // =dword_808FD98
    add r4, r4, r1
    ldrh r0, [r4]
    lsl r0, r0, #0x10
    ldrh r1, [r4,#2]
...
.endfunc // end of function sub_808FD64

    push {r5,lr}
    ldr r5, [pc, #0x808fea0-0x808fdc2-2] // =off_808FDB8
    ldr r5, [r5]
    mov r0, #0xb
    mov r1, #0xfb
    bl sub_802F164
    bne loc_808FE10
    ldr r0, [pc, #0x808fea0-0x808fdd0-4] // =off_808FDB8
    ldr r0, [r0]
    mov r1, #0x60 
...
loc_808FE10:
    ...
    .balign 4, 0x00
    push {r5,lr}
    ldr r5, [pc, #0x808fea0-0x808fe36-2] // =off_808FDB8
    ldr r5, [r5]
    mov r0, #0xb
    mov r1, #0xfb
    bl sub_802F164
    bne loc_808FE4E
    ldr r0, [pc, #0x808fea0-0x808fe44-4] // =off_808FDB8
    ldr r0, [r0]
    mov r1, #0x60 
    bl CpuSet_ZeroFillWord
loc_808FE4E:
...
// numWords
    ...
    mov r0, #0
    pop {pc}
.endfunc // end of function sub_808FE64

    push {r4-r7,lr}
    ldr r5, [pc, #0x808fea0-0x808fe76-2] // =off_808FDB8
    ldr r5, [r5]
...
off_808FEA0:    .word off_808FDB8
    ...
    bne locret_808FED0
loc_808FEBA:
    ldr r5, [pc, #0x808fed4-0x808feba-2] // =off_808FDB8
    ldr r5, [r5]
    bl sub_808FF44
...
loc_808FEE2:
    ...
    mov r0, #0
    pop {r4-r7,pc}
.endfunc // end of function sub_808FED8
...
unk_808FF2C:    .byte 1
    ...
    .byte 2
    .byte 2
.endfunc // end of function sub_808FF00
...
sub_808FF30:
    ...
    mov r0, #0
    pop {pc}
.endfunc // end of function sub_808FF30
...
locret_808FF6C:
    pop {pc}
    .byte 0, 0
.endfunc // end of function sub_808FF44
...
loc_808FF74:
    ...
    blt loc_808FF74
    pop {r4,pc}
.endfunc // end of function sub_808FF70
...
loc_808FF98:
    tst r0, r0
    pop {pc}
.endfunc // end of function sub_808FF8C
...
sub_808FF9C:
    ...
    pop {r4-r7,pc}
    .byte 0, 0
.endfunc // end of function sub_808FF9C
...
loc_808FFD2:
    lsl r0, r0, #2
    ldr r1, [pc, #0x808fff0-0x808ffd4-4] // =off_808FFF4
    ldr r4, [r1,r0]
    ldrb r1, [r5,#0xe]
    mov r2, #8
    mul r1, r2
...
off_808FFF4:    .word dword_81434E4
    ...
    .word dword_81434E4+0x48
    .word dword_81434E4+0x80
.endfunc // end of function sub_808FFC0
...
loc_809001A:
    ...
    tst r0, r0
    pop {r4,pc}
.endfunc // end of function sub_8090004
...
loc_8090034:
    ...
    pop {r4,pc}
    .balign 4, 0x00
.endfunc // end of function sub_8090020
...
locret_8090058:
    pop {r4,pc}
    .balign 4, 0x00
.endfunc // end of function sub_809003C
...
loc_80900C2:
    ...
    tst r0, r0
    pop {r4,pc}
.endfunc // end of function sub_809005C
...
sub_80900C8:
    ...
    bl sub_802F110
    pop {pc}
.endfunc // end of function sub_80900C8
...
sub_8090104:
    ...
    bl sub_8090004
    beq loc_8090114
    ldr r4, [pc, #0x8090180-0x8090110-4] // =dword_808F668
    b loc_809017C
loc_8090114:
    bl sub_8090020
    beq loc_809011E
    ldr r4, [pc, #0x8090184-0x809011a-2] // =dword_808F668+20
    b loc_809017C
loc_809011E:
    bl sub_80902DC
    bne loc_809017C
    ...
    bl sub_802F164
    bne loc_8090138
    ldr r4, [pc, #0x8090194-0x8090134-4] // =unk_808F728
    b loc_809017C
loc_8090138:
    mov r0, #0xb
    mov r1, #0xe6
    ...
    strb r0, [r5,#0x1c]
    bl loc_809E2FE
    ldr r4, [pc, #0x8090198-0x8090156-2] // =unk_808F6EC
    b loc_809017C
loc_809015A:
    mov r0, #0
    strb r0, [r5,#0xe]
    mov r0, #3
    strb r0, [r5,#0x16]
    ldr r4, [pc, #0x8090188-0x8090162-2] // =dword_808F668+40
    b loc_809017C
loc_8090166:
    bl sub_80901EC
    beq loc_8090170
    ldr r4, [pc, #0x809018c-0x809016c-4] // =unk_808F748
    b loc_809017C
loc_8090170:
    ldrb r0, [r5,#0xb]
    cmp r0, #0
    ...
    mov r0, #0xff
    strb r0, [r5,#0xb]
    ldr r4, [pc, #0x8090190-0x809017a-2] // =unk_808F788
loc_809017C:
    add r0, r4, #0
    pop {r4-r7,pc}
...
.endfunc // end of function sub_8090104
...
loc_80901AC:
    ...
    bl sub_809022C
    beq loc_80901DC
    ldr r0, [pc, #0x809021c-0x80901b4-4] // =0x8090226
    add r1, r4, #0
    lsl r1, r1, #1
    ldrh r0, [r0,r1]
// <mkdata>
...
loc_80901E4:
    ...
    pop {r4-r7,pc}
    .balign 4, 0x00
.endfunc // end of function sub_809019C
...
unk_8090220:    .byte 0xEC
    ...
    .byte 0xEB
    .byte 0xB
.endfunc // end of function sub_80901EC
...
sub_809022C:
    ...
    push {r1}
    mov r8, r0
    ldr r6, [pc, #0x80902d8-0x8090234-4] // =off_808FDB8
...
.endfunc // end of function sub_809022C
...
unk_8090300:    .byte 0xE1
    ...
    .byte 0xD2
    .byte 0xF
.endfunc // end of function sub_80902DC
...
loc_8090324:
    ...
    pop {r4,pc}
    .balign 4, 0x00
.endfunc // end of function sub_8090308
...
// <endpool> <endfile>
    pop {pc}
.endfunc // end of function sub_809032C
