...
sub_800BF5C:
    mov r1, #0x50 
    mul r0, r1
    ldr r1, off_800BF80 // =unk_203CF00 
    add r0, r0, r1
    mov pc, lr
.endfunc // sub_800BF5C
...
sub_800BF88:
    push {r4,r6,r7,lr}
    bl sub_800C4BC
    ldr r0, off_800C1F8 // =dword_203CB04 
    mov r1, #0x8c
    str r1, [r0]
...
sub_800BFC4:
    ...
    bne locret_800C016
    bl sub_800C746
    ldr r0, off_800C1FC // =dword_203CB04 
    ldr r1, [r0]
    sub r1, #1
    str r1, [r0]
    bne loc_800BFE6
...
loc_800C038:
    eor r3, r4
    lsl r4, r4, #3
    ldr r6, dword_800C088 // =0x800C0AA 
    add r6, r6, r4
    ldrb r4, [r6,r0]
    str r4, [sp]
    mov r4, #3
    ...
    add r4, #6
    str r4, [sp,#4]
    ldr r6, off_800C084 // =dword_800C08C 
    cmp r2, #0xff
    beq loc_800C066
    mov r4, #6
    mul r4, r2
...
sub_800C0BA:
    ...
    ldrb r4, [r6,#0xd]
    lsl r4, r4, #3
    ldr r6, dword_800C0FC // =0x800C0AA 
    add r6, r6, r4
    ldrb r4, [r6,r0]
    str r4, [sp]
    mov r4, #3
...
sub_800C100:
    ...
    eor r2, r4
    lsl r4, r4, #3
    ldr r6, dword_800C174 // =0x800C182 
    add r6, r6, r4
    ldrb r4, [r6,r0]
    str r4, [sp]
    mov r4, #3
    ...
    add r4, #6
    str r4, [sp,#4]
    ldr r6, off_800C16C // =dword_86E0498 
    lsl r7, r2, #5
    add r6, r6, r7
    // j
    ldr r0, [sp]
...
sub_800C138:
    ...
    add r4, #6
    str r4, [sp,#4]
    ldr r6, off_800C170 // =dword_800C178 
    // j
    ldr r0, [sp]
    // i
    ldr r1, [sp,#4]
...
locret_800C436:
    pop {r4-r7,pc}
loc_800C438:
    ldr r0, off_800C4B8 // =dword_203CB04 
    ldr r1, [r0]
    mov r2, #0x8c
    ldrb r0, [r7,#0xa]
    cmp r0, #3
...
sub_800C6D6:
    mov r1, #0xc
    mul r0, r1
    ldr r1, off_800C8D4 // =unk_800D730 
    add r0, r0, r1
    mov pc, lr
.endfunc // sub_800C6D6
...
loc_800E498:
    push {lr}
    lsl r0, r0, #2
    ldr r1, off_800E4AC // =dword_800E4B0 
    ldr r1, [r1,r0]
    ldr r0, [r5,#0x54]
    ldrb r0, [r0,#0xc]
    mov lr, pc
...
loc_800E5C6:
    ...
    lsl r1, r1, #3
    add r2, r2, r1
    ldr r1, off_800E65C // =dword_800E660 
    add r1, r1, r2
    ldr r2, [r1]
    ldr r3, [r1,#4]
    add r0, r6, #0
...
loc_800E6A4:
    ...
    lsl r1, r1, #3
    add r0, r0, r1
    ldr r1, off_800E6C4 // =unk_800E6C8 
    add r1, r1, r0
    ldr r2, [r1]
    ldr r3, [r1,#4]
    add r0, r6, #0
...
loc_800ED0A:
    ...
    blt loc_800ED0A
    mov r0, #0
    ldr r1, off_800ED28 // =dword_203F6A0 
    str r0, [r1]
    mov pc, lr
    .byte 0, 0
...
object_createAIData:
    ...
    ldr r3, off_800ED7C // =dword_203F6A0 
    ldr r2, [r3]
    mov r1, #1
    lsl r1, r1, #0x1f
    mov r4, #0
