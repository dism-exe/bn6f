...
class DiscoveredStructField:
    __slots__ = ("offset", "size", "field_name")
    def __init__(self, offset, size, field_name):
        self.offset = offset
        self.size = size
        self.field_name = field_name

def track_discovered_struct_fields(offset, size, struct_name, field_name):
    discovered_struct_fields[struct_name].append(DiscoveredStructField(offset, size, field_name))

def output_discovered_struct_fields():
    output = ""
                ...
                if array_field is not None:
                    ...
                    if size == Size.BYTE:
                        ...
                        try:
                            ...
                            track_discovered_struct_fields(total_offset, size, self.struct_name, hword_offset_name)
            ...
            for low_bound, high_bound in zip(remaining_field_type_ranges, remaining_field_type_ranges[1:]):
                if low_bound <= total_offset < high_bound:
                    if i == 0:
                        ...
                        track_discovered_struct_fields(total_offset, size, self.struct_name, unk_field.offset_name)
                        return unk_field
        else:
...
class Camera(Struct):
    ...
    def generate_basic_struct_fields(self):
        return {
            ...
            0x10: {Size.HWORD: StructField("_Unk_10", UnkPrimitiveMemory())},
            0x12: {Size.HWORD: StructField("_Unk_12", UnkPrimitiveMemory())},
            0x14: {Size.WORD: StructField("_Unk_14", UnkMemory())},
            0x30: {Size.WORD: StructField("_X", UnkPrimitiveMemory())},
            0x34: {Size.WORD: StructField("_Y", UnkPrimitiveMemory())},
            0x38: {Size.WORD: StructField("_Z", UnkPrimitiveMemory())},
            0x3c: {Size.WORD: StructField("_nextX_3c", UnkPrimitiveMemory())},
            0x40: {Size.WORD: StructField("_nextY_40", UnkPrimitiveMemory())},
            0x44: {Size.WORD: StructField("_nextZ_44", UnkPrimitiveMemory())},
...
class Chatbox(Struct):
    ...
    def generate_basic_struct_fields(self):
        return {
            ...
            0x1: {Size.BYTE: StructField("_TextScriptIdx", UnkPrimitiveMemory())},
            0x2: {Size.BYTE: StructField("_CurrLine", UnkPrimitiveMemory())},
            0x3: {Size.BYTE: StructField("_Unk_03", UnkPrimitiveMemory())},
            0x4: {Size.BYTE: StructField("_TextScriptState_04", UnkPrimitiveMemory())},
            0x5: {Size.BYTE: StructField("_Unk_05", UnkPrimitiveMemory())},
            0x6: {Size.BYTE: StructField("_Und_06", UnkPrimitiveMemory())},
            0x7: {Size.BYTE: StructField("_MugshotPaletteIdx", UnkPrimitiveMemory())},
            0x8: {Size.BYTE: StructField("_TextScriptPrintSpeed", UnkPrimitiveMemory())},
            0x9: {Size.BYTE: StructField("_CharInPrint", UnkPrimitiveMemory())},
            0xA: {Size.BYTE: StructField("_Unk_0A", UnkPrimitiveMemory())},
            0xB: {Size.BYTE: StructField("_Unk_0B", UnkPrimitiveMemory())},
            0xC: {Size.BYTE: StructField("_BoxY", UnkPrimitiveMemory()),
                  Size.HWORD: StructField("_BoxYX", UnkPrimitiveMemory())},
            0xD: {Size.BYTE: StructField("_BoxX", UnkPrimitiveMemory())},
            0xE: {Size.BYTE: StructField("_Unk_0E", UnkPrimitiveMemory())},
            0xF: {Size.BYTE: StructField("_BoxGfxLoadState_0F", UnkPrimitiveMemory())},
            0x10: {Size.BYTE: StructField("_OpenState_10", UnkPrimitiveMemory())},
            0x11: {Size.BYTE: StructField("_JumpTableOffset_11", UnkPrimitiveMemory())},
            0x12: {Size.BYTE: StructField("_Unk_12", UnkPrimitiveMemory())},
            0x13: {Size.BYTE: StructField("_ChoiceCursorPos", UnkPrimitiveMemory())},
            ...
            0x18: {Size.BYTE: StructField("_TextScriptCharIdx", UnkPrimitiveMemory())},
            0x19: {Size.BYTE: StructField("_Unk_19", UnkPrimitiveMemory())},
            0x1A: {Size.BYTE: StructField("_CursorIdx", UnkPrimitiveMemory())},
            0x1B: {Size.BYTE: StructField("_Unk_1B", UnkPrimitiveMemory())},
            0x1C: {Size.BYTE: StructField("_CurTileXBlockPos", UnkPrimitiveMemory())},
            0x1D: {Size.BYTE: StructField("_CurTileYBlockPos", UnkPrimitiveMemory())},
            0x1E: {Size.BYTE: StructField("_CurTileWidth16", UnkPrimitiveMemory())},
            ...
            0x30: {Size.WORD: StructField("_TextScriptPtr", UnkMemory())},
            0x34: {Size.WORD: StructField("_CurrTextScriptPtr", UnkMemory())},
            0x38: {Size.WORD: StructField("_Unk_38", UnkMemory())},
            0x3C: {Size.BYTE: StructField("_Und_3C", UnkPrimitiveMemory())},
            0x3D: {Size.BYTE: StructField("_Unk_3D", UnkPrimitiveMemory())},
            0x3E: {Size.HWORD: StructField("_flags_3E", UnkPrimitiveMemory())},
            0x40: {Size.WORD: StructField("_MugshotColorFilter_40", UnkPrimitiveMemory())},
            0x44: {Size.WORD: StructField("_Unk_44", UnkMemory())},
            0x48: {Size.WORD: StructField("_Und_48", UnkMemory())},
            0x4C: {Size.WORD: StructField("_Unk_4C", UnkMemory()),
                   Size.BYTE: StructField("_Unk_4C", UnkPrimitiveMemory())},
            0x50: {Size.WORD: StructField("_Unk_50", UnkMemory())},
            0x54: {Size.WORD: StructField("_Unk_54", UnkMemory())},
            0x58: {Size.WORD: StructField("_Unk_58", UnkMemory())},
            0x64: {Size.WORD: StructField("_Unk_64", UnkMemory()),
                   Size.HWORD: StructField("_Unk_64_Hword", UnkPrimitiveMemory())},
            0x68: {Size.HWORD: StructField("_Unk_68", UnkPrimitiveMemory())},
            0x6A: {Size.HWORD: StructField("_Unk_6A", UnkPrimitiveMemory())},
            0x6C: {Size.HWORD: StructField("_Unk_6C", UnkPrimitiveMemory())},
            0x6E: {Size.HWORD: StructField("_Unk_6E", UnkPrimitiveMemory())},
            0x70: {Size.WORD: StructField("_Unk_70", UnkMemory())},
            0x74: {Size.WORD: StructField("_Unk_74", UnkMemory())},
            0x78: {Size.WORD: StructField("_Unk_78", UnkMemory())},
            0x7C: {Size.WORD: StructField("_Unk_7C", UnkMemory())},
            0x80: {Size.BYTE: StructField("_Unk_80", UnkPrimitiveMemory()),
                   Size.WORD: StructField("_Unk_80_Word", UnkMemory())},
            0x84: {Size.WORD: StructField("_Unk_84", UnkMemory())},
            0x88: {Size.WORD: StructField("_Unk_88", UnkMemory())},
            0x8C: {Size.WORD: StructField("_Und_8C", UnkMemory())},
            0x90: {Size.WORD: StructField("_Unk_90", UnkMemory())},
            0x94: {Size.BYTE: StructField("_Unk_94", UnkPrimitiveMemory())}
        }

    _unk_field_offset_ranges = (0x0, 0x230)
    @property
    def unk_field_offset_ranges(self):
        return Chatbox._unk_field_offset_ranges
    ...
    def on_nan_struct_offset(self, fileline, offset):
        fileline_msg("ChatboxNanOffsetWarning: Offset is NaN!", fileline)
        return Struct.barebones_struct_field
