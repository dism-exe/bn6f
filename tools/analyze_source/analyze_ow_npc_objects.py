...
def main():
    ...
    try:
        ...
        analyzer.read_ow_npc_object_function()
    except:
    ...
    for i in range(5):
        print('\a')
        time.sleep(0.4)
    print_post_output_info(start_time, analyzer_start_time, analyzer_end_time, syms, scanned_files)
...
def print_post_output_info(start_time, analyzer_start_time, analyzer_end_time, syms, scanned_files):
