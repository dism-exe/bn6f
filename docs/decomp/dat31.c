...
int __fastcall sub_810C544(int a1)
{
  ...
  object_canMove(a1);
  if ( _ZF || (v4 = sound_play(200), sub_801A082(v4, 53, 2, 3), (v5 = (*(v2 + 40))(*(v2 + 44))) == 0) )
  {
    *(v2 + 26) = 0;
    result = sub_8011714();
  }
  else
  {
    *(v2 + 22) = v5;
    *(v2 + 23) = v6;
    if ( v5 == 5 * (*(v1 + 22) ^ 1) + 1 || object_getPanelParameters(*(v2 + 22), *(v2 + 23)) & 0xF880080 )
    {
      v7 = *(v1 + 18);
      *(v1 + 20) = v7;
      v8 = *(v1 + 19);
...
int sub_810D378()
{
  ...
  *(v1 + 48) = v2;
  ...
  {
    *(v1 + 48) = 64;
    sound_play(*&byte_810D3DE[2 * *(v1 + 3)]);
  }
  result = *(v1 + 16) - 1;
  *(v1 + 16) = result;
  if ( !result )
