...
void __noreturn sub_80A5304()
{
    ...
    else
    {
        ...
        *(v0 + 36) = v3;
        ...
        {
            case 50:
                sound_play(&dword_14C, 50, v2);
                break;
            case 74:
                sound_play(230, 74, v2);
                break;
            case 93:
                sound_play(153, 93, v2);
                break;
        }
    }
    sprite_update();
...
void __noreturn sub_80A8748()
{
    ...
    *(v0 + 20) += v7;
    v8 = 2 * v2;
    if ( *&byte_80A87C8[v8] )
        sound_play(*&byte_80A87C8[v8], v7, v6);
    *(v0 + 8) = 4;
    sprite_update();
}
...
void __noreturn sub_80A8B4C()
{
    ...
    if ( v1 )
    {
        ...
        v3 = *&byte_80065E0[v2] << 8;
        v0[3] -= *&byte_8006660[v2] << 8;
        v0[4] -= v3;
        sub_809E1AE();
        v0[5] = v4 + 1310720;
        sub_80A8C98();
    ...
    if ( v3 == *(v0 + 20) )
    {
        ...
        if ( v2 == 1 )
        {
            ...
            *(v1 + 4) = *(v0 + 4);
            ...
            sub_8002E52();
            *(v0 + 8) = 8;
            LODWORD(v2) = sound_play(&loc_1A4, v4, v5);
        }
    }
    return v2;
}
    ...
    *(v0 + 20) = v1;
    if ( (v1 < 0) ^ v2 )
    {
        *(v0 + 20) = 0;
        ...
        sprite_loadAnimationData();
        sub_80302A8(1, 10);
        sound_play(218, v3, v4);
        sound_play(192, v5, v6);
        *(v0 + 8) = 8;
    }
    sprite_update();
}
