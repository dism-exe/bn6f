  ...
  *(v0 + 50) = *(v0 + 48);
  ...
  if ( v2 )
  {
    if ( *(v0 + 48) )
    {
      ...
      {
        sub_81365F0();
        if ( v2 || (v4 = *(v1 + oToolkit_GameStatePtr), *(v4 + oGameState_MapGroup) < 128) )
        {
          sub_81366FC();
          sub_813658C();
          *(v0 + 17) = 40;
  ...
  if ( !v5 )
  {
    if ( v2 & byte_200 )
    {
      ...
      *(v0 + 14) = sub_813B920((v6 - 1) & 3);
      sub_8136384();
      return sound_play(127, v7, v8);
    }
    if ( v2 & byte_100 )
    {
      v9 = sub_813B928();
      *(v0 + 14) = sub_813B920((v9 + 1) & 3);
      sub_8136384();
      return sound_play(127, v7, v8);
    }
  }
