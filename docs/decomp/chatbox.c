...
// 0x803fd68
// (u8 scriptID) -> void
int __fastcall chatbox_runScript_202da04(int a1)
{
  return chatbox_runScript(&unk_202DA04, a1);
}
...
int **chatbox_onUpdate_803FEB4()
{
  ...
  if ( *v1 )
  {
    ...
    v5 = chatbox_maskFlags_3e(1);
    if ( v3 )
    {
      v6 = *(v1 + offsetof(ChatBoxPropreties, unk_1E));
      if ( !v6 )
      {
        chatbox_8040154(v5);
        goto LABEL_11;
      }
      *(v1 + offsetof(ChatBoxPropreties, unk_1E)) = v6 - 1;
    }
...
LABEL_15:
      ...
      *(v0 + offsetof(ChatBoxPropreties, bNumCharacterTyped)) = *(v0 + offsetof(ChatBoxPropreties, typingSpeed));
      v5 = chatbox_maskFlags_3e(64);
      if ( v11 )
        v5 = sound_play(*(v0 + offsetof(ChatBoxPropreties, unk_68)));
      if ( v6 == 228 )
      {
        v9 = *(v0 + offsetof(ChatBoxPropreties, unk_7C));
        v8 = sub_3006F8C(0, v1[1] + 228);
        v1 += 2;
      }
      else
      {
        v7 = *(v0 + offsetof(ChatBoxPropreties, unk_7C));
        v8 = sub_3006F8C(v5, v6);
        ++v1;
      }
      chatbox_8040C44(v8);
      v3 = 1;
...
LABEL_16:
  ...
  while ( v3 );
  v10 = chatbox_maskFlags_3e(&byte_100);
  if ( v11 )
    chatbox_copyTiles_8040344(v10);
  v12 = chatbox_8045F3C(128);
  if ( !v11 )
  {
    chatbox_maskFlags_3e(&byte_100);
    if ( !v11 || (v12 = *(v0 + 16), v12 == 3) )
    {
      v13 = *(v0 + 15);
      ...
      v12 = chatbox_804021C(v13);
    }
  }
  v14 = chatbox_8040B8C(v12);
  return chatbox_804082C(v14);
}
...
signed int sub_804005C()
{
  ...
  *(v0 + 2) = *(v0 + 15);
  ...
  do
  {
    ...
    {
      v3 = (chatbox_jt_ctrlCmds[v2 - 229])();
      chatbox_8040C9C(v3);
    }
    *(v0 + 44) = v1;
    v9 = *(v0 + 62) & 1;
  }
  while ( !(*(v0 + 116) | v9) || !(*(v0 + 17) + v9) );
...
int __fastcall chatbox_runTrainScript(int a1)
{
  return chatbox_runScript(&unk_2034A04, a1);
}
...
void __fastcall dead_80405F8(int a1, int a2, int a3, int a4)
{
  ...
  *(v7 + 144) = 13;
  ...
  CopyByEightWords(v16, &unk_3001B40, 0x20u);
  CopyByEightWords(dword_86B7AC0, byte_3001710, 0x20u);
}
...
signed int chatbox_804082C()
{
  ...
  result = chatbox_maskFlags_3e(32);
  if ( result )
  {
    v2 = v0[3];
    v3 = off_8040898[v2];
...
int __fastcall chatbox_config_80408D0(int a1, int a2)
{
  int v2; // r5
  int v3; // r0
  char v4; // t1
  ...
  *(v2 + offsetof(ChatBoxPropreties, scriptID)) = a2;
  v3 = *(v2 + offsetof(ChatBoxPropreties, pScriptArray)) + *(*(v2 + offsetof(ChatBoxPropreties, pScriptArray)) + 2 * a2);
  *(v2 + offsetof(ChatBoxPropreties, pScriptCursor)) = v3;
  *(v2 + offsetof(ChatBoxPropreties, pCurrScript)) = v3;
  *(v2 + offsetof(ChatBoxPropreties, chatPageState)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, unk_64)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, unk_12)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, currLine)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, unk_17)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, unk_3D)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, unk_80)) = 0;
  *(v2 + offsetof(ChatBoxPropreties, bxoff_11)) = 1;
  *(v2 + offsetof(ChatBoxPropreties, unk_74)) = 1;
  v4 = *(v2 + offsetof(ChatBoxPropreties, typingSpeed));
  v5 = *(v2 + offsetof(ChatBoxPropreties, textCoord));
  *(v2 + offsetof(ChatBoxPropreties, unk_94)) = v5;
  chatbox_8045F60(v5);
...
int chatbox_E6_end()
{
  ...
  v4 = chatbox_maskFlags_3e(0x100u);
  if ( !v5 )
  {
...
LABEL_22:
    ...
    {
      chatbox_8045F1C(16);
      v15 = *(v1 + offsetof(ChatBoxPropreties, choiceCursorPos));
    }
    v16 = *(v0 + *(v1 + offsetof(ChatBoxPropreties, choiceCursorPos)) + 3);
    if ( v16 == 255 )
    {
      v17 = *(v0 + 1);
      v18 = *(v0 + 2);
    ...
    {
      chatbox_config_80408D0(v16, *(v0 + *(v1 + offsetof(ChatBoxPropreties, choiceCursorPos)) + 3));
    }
    *(v1 + 4) = 0;
  ...
  else
  {
    ...
    v21 = *(v1 + offsetof(ChatBoxPropreties, amount_of_box_appeared));
...
signed int chatbox_8041670()
{
  ...
  v1 = **(&off_8043C84 + *(v0 + 2));
  if ( v1 != 255 )
    chatbox_config_80408D0(&off_8043C84, v1);
  return 1;
}
...
signed int chatbox_8041818()
{
  ...
  if ( v1 == 9 )
  {
    v6 = sub_8021BC0(v0[2] | (v0[3] << 8), v0[4]);
...
// 0x804198c
signed int chatbox_804198C()
{
  int v0; // r4
  int v1; // r0
  int v2; // r1

  v1 = **(&off_8043C64 + *(v0 + 2)) + 3;
  v2 = *(v0 + v1);
  if ( v2 != 255 )
    chatbox_config_80408D0(v1, v2);
  return 1;
...
signed int chatbox_F0_jump()
{
  ...
  if ( v3 != 1 )
  {
    ...
    {
      v6 = *(v0 + 1);
      v7 = (**(v2 + oToolkit_CurFramePtr) & 3) + 2;
      do
      {
...
signed int __fastcall chatbox_F4_unk(int a1, int a2, int a3, int a4)
{
  ...
  signed int v7; // r0
  signed int result; // r0
  int (__fastcall *v9)(signed int); // [sp+0h] [bp-4h]

  v6 = v4[1];
  if ( 16 * (v6 >> 4) == 16 )
    v6 = chatbox_8041DF4(v6, 16, a3, a4, v9);
  switch ( v6 )
  {
    case 0u:
      goto LABEL_13;
...
signed int chatbox_8042128()
{
  ...
  if ( *(v0 + 3) )
    ...
    v2 = sub_803D06C();
  chatbox_8042A14(v2, *(v0 + 2), &unk_200AFA0 + 64 * *(v0 + 3));
  *(v1 + 44) = &unk_200AFA0 + 64 * *(v0 + 3);
  v3 = v0 + 4;
  *(v1 + 68) = v3;
...
// 0x80422d4
signed int chatbox_80422D4()
{
  int v0; // r4

  sound_play(*(v0 + 2) | (*(v0 + 3) << 8));
  return 1;
}


// 0x80422e8
signed int chatbox_80422E8()
{
  int v0; // r4

  sound_bgmusic_play(*(v0 + 2) | (*(v0 + 3) << 8));
  return 1;
}
...
signed int chatbox_80423DC()
{
  ...
  sound_play(115);
  *(v1 + 76) = *(4 * *(v0 + 2) + v0 + 3) | (*(4 * *(v0 + 2) + v0 + 4) << 8) | (*(4 * *(v0 + 2) + v0 + 5) << 16) | (*(4 * *(v0 + 2) + v0 + 6) << 24);
  sub_803CFF8();
  v2 = v0 + 4 * (*(v0 + 2) + 1) + 3;
  return 1;
}
...
int chatbox_804252C()
{
  ...
  v3 = v2;
  v4 = sub_80010D4(v2);
  sub_80010EC(v3, v4 + v1);
  return 0;
}


// 0x8042554
signed int sub_8042554()
{
  int v0; // r4
  int v1; // r5
  signed int v2; // r0
  ...
  sound_play(115);
  v2 = *((*(v0 + 2) & change_20013F0_800151C()) + v0 + 3);
  *(v1 + 76) = v2;
  sub_803CD98(v2, 1);
  v3 = v0 + *(v0 + 2) + 1 + 3;
  return 1;
...
signed int chatbox_8042678()
{
  ...
  v1 = *(v4 + v3 + 2);
  if ( v1 != 255 )
    chatbox_config_80408D0(v3 + 2, v1);
  return 1;
}
...
signed int chatbox_8042A9C()
{
  ...
  if ( v2 == 1 )
  {
    v8 = sub_803CE08(v0[2], v0[3]) + 4;
    v6 = v0[v8];
LABEL_18:
    if ( v6 != 255 )
      chatbox_config_80408D0(v8, v6);
    return 1;
  }
  if ( v2 != 2 )
  {
...
signed int chatbox_8042B38()
{
  ...
  {
    v7 = v0[2] | (v0[3] << 8) | (v0[4] << 16) | (v0[5] << 24);
    v5 = sub_803D040() + 6;
    v6 = v0[v5];
  }
  else
  {
    if ( v2 == 2 )
    {
      v8 = v0[2] | (v0[3] << 8) | (v0[4] << 16) | (v0[5] << 24);
      sub_803D02C();
      sound_play(115);
      return 1;
    }
...
LABEL_7:
  if ( *(v1 + 128) - 1 != *(v1 + 19) )
  {
    ...
    {
      v9 = *(v1 + v13 + 76);
      v14 = *(*(v2 + oToolkit_JoypadPtr) + 4);
      if ( v14 & 0x80 || v14 & 0x40 )
      {
        sound_play(*(v1 + 108));
        *(v1 + v15) = v9;
      }
...
signed int chatbox_8043A5C()
{
  ...
  if ( v0[1] == 27 )
  {
    ...
    if ( v4 == 255 )
      v4 = *(v1 + 88);
    sub_803D108(v3 + 144, v4, v0[3]);
    result = 1;
  }
  else if ( v2 == 1 )
  {
    sub_803D128(v0[2] + 144, v0[4], v0[3]);
    result = 1;
  }
  else if ( v2 == 2 )
  {
    sound_play(115);
    sub_803D118(v0[2] + 144, v0[4], v0[3]);
    result = 1;
  }
  else
  {
