...
signed int sub_809AB20()
{
  ...
  if ( !v3 )
  {
    CopyWords(*(v2 + oToolkit_ChatboxPtr) + 76, &v13, 8u);
    v5 = sub_813D41C(&v13);
    *(v1 + 120) = v0;
    if ( v5 == 1 )
    {
      v9 = *(v2 + oToolkit_ChatboxPtr);
      *(v9 + offsetof(ChatBoxPropreties, unk_4C)) = v7;
      *(v9 + offsetof(ChatBoxPropreties, unk_50)) = v8;
      if ( v6 == 1 )
      {
        v14 = v7;
        sub_803CD98(v7, 1);
      ...
      *(v1 + 116) = v10;
      *(v1 + 8) = v11;
      chatbox_runScript(&byte_86C67E4, 14);
    }
    else
    {
      if ( v5 == 2 )
...
int sub_809AC70()
{
  ...
  chatbox_runScript(&byte_86C67E4, *(v0 + 116));
  return 0;
}
...
signed int sub_809B054()
{
  ...
  sub_80047E0(11, v11 << 16, v12 << 16, v13 << 16);
  return 0;
}
...
int sub_809C09C()
{
  ...
  {
    v2 = (reqBBS_8140974)();
    v3 = ClearEventFlag(*(v0 + 6) + 7456 + v2);
    v4 = reqBBS_8140974(v3);
    SetEventFlag(*(v0 + 6) + 7584 + v4);
  }
  return 0;
}
  ...
  if ( !v4 )
  {
    if ( !*(*(v0 + oToolkit_GameStatePtr) + oGameState_Unk_0e) )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v4 )
        {
          if ( sub_803CE28(44) < *(v6 + 13) + 1 )
            sound_play(105);
          else
            init_s_02011C50_8036E90(byte_809C354, v6, v7, v8);
        }
      }
    }
    goto LABEL_23;
...
int sub_809D348()
{
  ...
  *(v0 + 48) = v3;
  ...
  {
    sub_809E3D6();
    v4 = sub_8030B6A(v0 + 28);
    if ( v4 )
    {
      v4 = TestEventFlagFromImmediate(23, 22);
      if ( !v5 )
      {
        TestEventFlagFromImmediate(23, 61);
        if ( !v5 )
        ...
        v6 = ClearEventFlagFromImmediate(23, 62);
        v4 = sub_809DE60(v6);
      }
    }
  }
  ...
  if ( !v5 )
  {
    v9 = ClearEventFlagFromImmediate(23, 24);
    sub_809E0C8(v9);
  }
  v10 = *(v0 + 22);
  if ( !*(v0 + 22) )
    v10 = sub_8035694((v0 + 28));
  v11 = sub_8002E14(v10);
  if ( sub_809DFA0(v11) && !s_2011C50_ptr_1C_isNull() )
  {
    v12 = *(v0 + 19);
...
int sub_809D61A()
{
  ...
  v2 = TestEventFlagFromImmediate(23, 22);
  if ( v3 || (v2 = TestEventFlagFromImmediate(23, 61), v3) )
  {
    v4 = sub_809D9E0(v2);
    if ( !v4 )
      goto LABEL_8;
  ...
  if ( !v2 )
  {
    ...
    if ( !v2 )
    {
      if ( *(v0 + 80) & 0xC00000 )
      {
        ...
        v3 = SetEventFlagFromImmediate(23, 63);
        result = sub_809DE60(v3);
      }
    }
  }
  return result;
...
// 0x809e13c
int __fastcall sub_809E13C(char a1)
{
  byte_200ACE2 = a1;
...
// 0x809e168
int __fastcall sub_809E168(char a1)
{
  int v1; // r10
