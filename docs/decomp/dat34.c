...
LABEL_37:
        ...
        if ( result <= 2 )
        {
          if ( result != 2 )
          {
            ...
            *(v0 + 38) = 4;
            *(v18 + 10) = *(v0 + 42);
            v19 = sub_812EC2C(144, 1, 4);
            *(v0 + 48) = sub_812EDFC(v19, 1);
            v20 = sub_812EE78(1);
            return sub_812EDE4(v20);
          }
          goto LABEL_37;
        }
        if ( result == 255 )
...
int sub_812E650()
{
  ...
  v1 = (*(&off_812E668 + *(v0 + 12)))();
  return sub_812EFE4(v1);
}
