...
signed int __fastcall sub_8145210(unsigned __int16 a1)
{
    ...
    {
        word_200FE14 = v10;
        word_200FE16 = BYTE1(v10);
        if ( byte_200FE09 )
        {
            byte_200FE0A = 1;
            if ( !byte_200FE06 && !BYTE1(v10) )
                byte_200FE0A = 4;
            if ( byte_200FE0A == 1 )
            {
                v2 = 0;
    ...
    if ( *dword_2010CC0 == 1 )
    {
        if ( BYTE2(v10) )
        {
            ...
            do
            {
                if ( (byte_200FE30 >> v4) & 1 && (BYTE2(v10) >> v4) & 1 )
                    algn_200FE34[v4] = 0;
                v4 = (v4 + 1) & 0xFF;
            }
            while ( v4 <= 3 );
            byte_200FE30 &= ~BYTE2(v10);
            word_200FE14 = BYTE2(v10);
            sub_81461B0(50, 1);
        }
        if ( !byte_200FE30 )
            goto LABEL_38;
...
int __fastcall sub_8145658(unsigned __int16 a1, unsigned __int16 a2)
{
    ...
    unsigned int v15; // r3
    char v16; // r0
    unsigned __int8 v18; // [sp+0h] [bp-1Ch]
...
LABEL_76:
    ...
    if ( v2 == 48 )
    {
        ...
        v18 = word_200FE14 & eStruct200FE00;
        v15 = 0;
        do
        {
            if ( (v18 >> v15) & 1 && byte_200FE01 )
                --byte_200FE01;
            v15 = (v15 + 1) & 0xFF;
        }
        while ( v15 <= 3 );
...
int __fastcall sub_8145D54(unsigned __int16 a1)
{
    ...
    if ( dword_200FE44 )
        return sub_814DA64(v1, dword_200FE44);
    byte_200FE0F = 0;
    byte_200FE0E = v2;
    return v5;
}
...
int __fastcall sub_81461B0(int a1, int a2)
{
    ...
    a2 = a2;
    if ( dword_200FE40 )
        return sub_814DA68(a1, a2, dword_200FE40);
    word_200FE16 = 0;
    word_200FE14 = 0;
    return v3;
}
...
int sub_814673C()
{
    ...
    {
        v3 = sub_81466F4(i);
        sub_81469F0(v3, v0, 0xDu);
        v4 = sub_81466C4(i);
        sub_81469F0(v4, v1, 8u);
        v0 += 16;
        v1 += 8;
        ++byte_2009470;
    }
...
// 0x8146808
unsigned int __fastcall sub_8146808(int a1)
{
...
int __fastcall sub_81469BC(int a1, int a2)
{
    ...
    v2 = a2 << 16;
    v3 = a2;
    sub_8146A48(a1, &unk_2010150, 0xBu);
    byte_201015B = v3;
...
int sub_8146E60()
{
    ...
    sub_8146E90(&byte_20101E0, byte_2010230, 0xCu);
    return v1;
}
...
int sub_8146E78()
{
    ...
    sub_8146F90(&byte_20101E0, byte_2010230, 12);
    return v1;
}
    ...
    if ( byte_20101B4 != 143 && (byte_20101D0 & byte_2010292) == byte_2010292 )
    {
        ...
        do
        {
            if ( ((0x2000000 << v1) >> 24) & byte_2010292 && byte_20101B4 == 1 )
                CopyWords(&byte_2010230[16 * v1], &unk_20101EC + 12 * v1, 0xCu);
            v1 = (v1 + 1) & 0xFF;
        }
        while ( v1 <= 3 );
        if ( byte_20101B4 == 1 )
...
signed int __fastcall sub_8149220(int a1, unsigned __int16 a2, int a3, char a4)
{
    ...
    {
        v8 = v7 - 1;
        dword_2010CB0[v7] = dword_2010CB0[v8] + 112;
        off_2010CA0[v7] = off_2010CA0[v8] + 1;
        v7 = (v7 + 1) & 0xFFFF;
    }
    while ( v7 <= 3 );
    v9 = dword_2010CAC + 28;
...
int __fastcall sub_81494B8(unsigned __int8 a1, unsigned __int16 a2)
{
    ...
    *(dword_2010CC4 + 28) = v3;
    if ( *v4 & 8 )
        sub_814DA68(v2, v3, *dword_2010CC8);
    return v6;
}
...
int __fastcall sub_81494F8(unsigned __int8 a1, int a2)
{
    ...
    {
        if ( *dword_2010CC4 & 8 )
            sub_814DA68(255, v2 >> 16, *dword_2010CC8);
        v3 = *(dword_2010CC0 + 3) | *(dword_2010CC0 + 2);
        v4 = 0;
        do
        {
            if ( (v3 >> v4) & 1 )
...
int sub_8149AA8()
{
    ...
    {
        v6 = *(i + 2);
        if ( v6 <= 3 && !((*(dword_2010CC0 + 2) >> v6) & 1) && !((*(dword_2010CC0 + 3) >> v6) & 1) )
        {
            if ( *(&v10 + v6) )
                ++*(dword_2010CC4 + 14 + v6);
            v7 = (dword_2010CC4 + 14 + v6);
            if ( *v7 > 3u )
            {
                *v7 = 0;
                *(dword_2010CC0 + 10 + v6) = -1;
                *(dword_2010CC0 + 2) |= 1 << v6;
                ++*(dword_2010CC0 + 1);
                v8 = dword_2010CC0 + 32 * v6;
                *(v8 + 20) = *i;
                *(v8 + 22) = v6;
                *dword_2010CC0 = 1;
                *dword_2010CC4 &= 0x7Fu;
                *(dword_2010CC4 + 18 + 2 * v6) = *(dword_2010CC0 + 32 * v6 + 20);
            }
        }
        v1 = (v1 - 1) & 0xFF;
    }
...
int __fastcall sub_814A060(__int16 a1, _BYTE *a2, char *a3, _BYTE *a4)
{
    ...
    unsigned int v25; // r0
    char *v26; // [sp+0h] [bp-38h]
    _BYTE *v27; // [sp+4h] [bp-34h]
    signed int v28; // [sp+8h] [bp-30h]
    ...
    *a4 = 0;
    ...
    if ( !v29 )
    {
        ...
        while ( 1 )
        {
            ...
            if ( v28 != 1 || !(*(dword_2010CC0 + 2) & v14) )
                goto LABEL_36;
            if ( *(dword_2010CC0 + 10 + v12) )
            {
                v16 = (dword_2010CC4 + 10 + v12);
                v15 = 0;
            }
            else
            {
...
LABEL_33:
                ...
                {
                    v17 = (dword_2010CC4 + 10 + v12);
                    v18 = *v17 + 1;
                    *v17 = v18;
                    if ( v18 <= *(dword_2010CC4 + 26) )
                        goto LABEL_36;
            ...
            if ( *dword_2010CC0 == 1 )
            {
                ...
                if ( *v20 )
                {
                    ...
                    else if ( !((*(dword_2010CC0 + 2) | v21) & v14) )
                    {
                        ...
                        if ( v23 )
                        {
                            if ( *(v24 + 2) != v12 || *v24 != *(dword_2010CC4 + 18 + 2 * v12) )
                            {
                                while ( 1 )
                                {
                                    v24 += 2;
...
int __fastcall sub_814B0B4(unsigned __int8 a1)
{
    ...
    if ( v2 != 1 || *(dword_2010CC0 + 4) | *(dword_2010CC0 + 5) | *(dword_2010CC0 + 6) )
    {
        ...
        if ( *(dword_2010CC0 + 14) )
        {
            ...
            STWI_send_DataTxREQ(dword_2010CC8 + 104, (*(dword_2010CC4 + 36) + 4) & 0xFF);
        }
    }
    else
    {
        ...
        if ( *(dword_2010CC4 + 8) || !(*(dword_2010CC4 + 7) & 0xF) )
        {
            ...
            *(v3 + 120) = 255;
            ...
            if ( v1 )
                ...
                STWI_send_DataTxREQ(dword_2010CC8 + 104, 1);
            return v6;
        }
    }
    if ( v1 )
...
int __fastcall sub_814B6D4(unsigned __int8 a1, int a2, int a3, int a4)
{
    ...
    if ( !(v5 >> 16) && *(*(dword_2010CC8 + 220) + 1) )
    {
        *(dword_2010CC4 + 1) = 0;
        ...
        do
        {
            v10 = &dword_2010CB0[v8];
            v11 = *v10;
            if ( *(*v10 + 52) == 32835 && !((*(dword_2010CC4 + 1) >> v8) & 1) )
            {
                if ( *(v11 + 97) == 1 )
                    *(*v9 + 7) |= 1 << v8;
                v12 = v9;
...
// 0x814c5f4
int __fastcall STWI_send_CP_StartREQ(unsigned __int16 a1)
{
    int v1; // r4
    int v3; // [sp+4h] [bp-4h]

    v1 = a1;
    if ( !(STWI_init(0x1Fu) << 16) )
    {
        *(dword_2010CCC + 4) = 1;
...
// 0x814c66c
int __fastcall STWI_send_DataTxREQ(int a1, int a2)
{
    void *v2; // r6
    unsigned int v3; // r4
    char v4; // r5
...
// 0x814c6b4
int __fastcall STWI_send_DataTxAndChangeREQ(int a1, int a2)
{
    void *v2; // r6
    unsigned int v3; // r4
    char v4; // r5
...
// 0x814c744
int __fastcall STWI_send_DataReadyAndChangeREQ(unsigned __int8 a1)
{
    int v1; // r4
    unsigned __int8 v2; // r5
    unsigned __int8 *v3; // r0
...
// 0x814c794
int __fastcall STWI_send_DisconnectedAndChangeREQ(char a1, char a2)
{
    char v2; // r4
    char v3; // r5
    char *v4; // r0
...
// 0x814c7d4
int STWI_send_ResumeRetransmitAndChangeREQ()
{
    int v1; // [sp+0h] [bp-4h]
...
// 0x814c7f8
int __fastcall STWI_send_DisconnectREQ(unsigned __int8 a1)
{
    int v1; // r4
    int v3; // [sp+4h] [bp-4h]

    v1 = a1;
    if ( !(STWI_init(0x30u) << 16) )
    {
        *(dword_2010CCC + 4) = 1;
        *(*(dword_2010CCC + 36) + 4) = v1;
        STWI_start_Command();
...
// 0x814c828
int __fastcall STWI_send_TestModeREQ(unsigned __int8 a1, unsigned __int8 a2)
{
    int v2; // r5
    int v3; // r4
    int v5; // [sp+8h] [bp-4h]
    ...
    v2 = a1;
    v3 = a2;
    if ( !(STWI_init(0x31u) << 16) )
    {
        *(dword_2010CCC + 4) = 1;
        *(*(dword_2010CCC + 36) + 4) = (v3 << 8) | v2;
        STWI_start_Command();
    }
    return v5;
}
...
// 0x814c860
int __fastcall STWI_send_CPR_StartREQ(unsigned __int16 a1, unsigned __int16 a2, unsigned __int8 a3)
{
    int v3; // r5
    int v4; // r4
    int v5; // r6
...
// 0x814c96c
int __fastcall STWI_set_timer(unsigned __int8 a1)
{
    signed int v1; // r3
    int v2; // r0
    __int16 *v3; // r4
...
// 0x814ca44
int __fastcall STWI_init(unsigned __int8 a1)
{
    int v1; // r1
    __int16 v2; // t1
    int (__fastcall *v3)(int, int); // r2
    ...
    if ( *(dword_2010CCC + 44) == 1 )
    {
        ...
        *v5 = 0;
        v7 = *(dword_2010CCC + 24);
        if ( v7 )
            sub_814DA68(a1, *(dword_2010CCC + 18), v7);
        return 1;
    }
    if ( !*(dword_2010CCC + 20) )
    {
        ...
        *(dword_2010CCC + 18) = 4;
        v9 = *(v4 + 24);
        if ( v9 )
            return sub_814DA6C(a1, *(v4 + 18), v4, v9);
        return 1;
    }
    v11 = *v5;
    *v5 = 1;
    ...
    if ( v1 > 1 )
    {
        ...
        if ( v2 != 39 && v2 != 37 && v2 != 53 && v2 != 55 )
        {
            ...
            *(v0 + 44) = 0;
            v7 = *(dword_2010CCC + 24);
            if ( v7 )
                sub_814DA68(*(dword_2010CCC + 6), *(dword_2010CCC + 18), v7);
            *dword_2010CCC = 4;
        }
        else
        {
            ...
            *v3 = 0;
            v5 = *(dword_2010CCC + 24);
            if ( v5 )
                sub_814DA68(*(dword_2010CCC + 6), *(dword_2010CCC + 18), v5);
        }
    }
    else
    {
...
// 0x814dc84
void __fastcall m4a_814DC84(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, unsigned int a10, int a11)
{
    int v11; // r6
    int v12; // r0
    int v13; // r3
    ...
    v12 = v11 << 24;
    v13 = BYTE1(dword_4[0x400000 * v11]);
    if ( BYTE1(dword_4[0x400000 * v11]) )
        sub_814DC94(v12, sub_814DC94, a3, v13);
    else
        sub_814DCE8(v12, a2, a3, v13, a5, a6, a7, a8, a9, a10, a11);
}
...
LABEL_34:
    ...
    *(a11 + 91) = (*(a11 + 83) * v29) >> 8;
    ...
    return sub_814DE20(sub_814DE20, v15, *(a11 + 104), *(a11 + 120), a5, v30, a7, a8, v31);
}
...
// 0x814e0b4
void __fastcall sub_814E0B4(int a1, int a2, unsigned __int8 *a3)
{
    int v3; // r3
...
int __fastcall ply_goto(int a1, int a2)
{
    ...
    sub_814E0B4(((((*(*(a2 + 64) + 3) << 8) | *(*(a2 + 64) + 2)) << 8) | *(*(a2 + 64) + 1)) << 8, a2, *(a2 + 64));
    *(v4 + 64) = v2 | v3;
    return v6;
}
...
_DWORD *__fastcall sub_814E260(_DWORD *result, int a2)
{
    ...
    int (__fastcall *v36)(int, int, int); // [sp-4h] [bp-4h]
    ...
    if ( result[13] == 1752395091 )
    {
        ...
        v5 = result[14];
        if ( v5 )
            return sub_814E4CC(result[15], a2, 1752395091, v5);
        v33 = v2;
        v34 = v3;
        v35 = v4;
        v6 = result;
        if ( result[1] >= 0 )
        {
            ...
            if ( v6[1] >= 0 )
            {
                    ...
                    while ( 1 )
                    {
                        if ( *v25 & 0x80 )
                        {
                            ...
                            while ( !*(v25 + 1) )
                            {
                                ...
                                if ( v16 >= 0xCF )
                                    return sub_814E4CC(v16 - 207, v6, v25, *(v7 + 56));
                                if ( v16 > 0xB0 )
                                {
                                    *(v6 + 10) = v16 + 79;
                                    return sub_814E4CC(v6, v25, v15, *(*(v7 + 52) + 4 * (v16 - 177)));
                                }
                                *(v25 + 1) = byte_81C068C[v16 - 128];
                            }
                            --*(v25 + 1);
                            if ( *(v25 + 25) && *(v25 + 23) )
                            {
                ...
                do
                {
                                ...
                                if ( *v29 & 0xC7 )
                                {
                                    ...
                                    if ( *v27 & 0xC )
                                    {
                                        ...
                                        if ( v31 < 0 )
                                            v31 = 0;
                                        if ( v30 )
                                            return sub_814E4CC(v30, v31, *(v27 + 9), *(v7 + 48));
                                        *(v29 + 32) = sub_814E7F4(*(v29 + 36), v31, *(v27 + 9));
                                    }
                                }
                                else
                                {
                    ...
                    if ( ((v26 < 0) ^ v23) | (v26 == 0) )
                        break;
                    v23 = __OFADD__(v27, 80);
                    v27 += 80;
                }
                while ( !(((v27 < 0) ^ v23) | (v27 == 0)) );
            }
        }
LABEL_71:
        v6[13] = 1752395091;
        result = sub_814E4CC(v33, v34, v35, v36);
    }
    return result;
}
...
// 0x814ea58
int __fastcall sub_814EA58(int a1, int a2, int a3)
{
    int *v3; // r5
    signed int v4; // r4
    int v6; // [sp+8h] [bp-4h]
