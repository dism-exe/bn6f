...
int __fastcall sub_814A4CC(unsigned __int8 a1)
{
    ...
    if ( (*(dword_2010CC0 + 2) | *(dword_2010CC0 + 3)) & a1 )
    {
        *(dword_2010CC4 + 5) = a1;
        ...
        else if ( *(dword_2010CC4 + 9) && (sub_814C360(sub_81494F8), sub_814C564(), (v2 = sub_814C384()) != 0) )
        {
