...
void sub_807EDD4()
{
    ...
    v3 = sub_8001780();
    sub_8001778(v3 | v2[3]);
    sub_80304E8(off_807EE40[*(v1 + oGameState_MapNumber)]);
}
...
int sub_807EE92()
{
    ...
    return sub_8003570(pt_807EEAC[*(*(v0 + oToolkit_GameStatePtr) + oGameState_MapNumber)]);
}
