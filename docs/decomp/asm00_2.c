...
char (*__fastcall enemy_getStruct1(int a1))[8]
{
    ...
    v1 = GetVerActorTyAndAIIdx_80182B4(a1);
...
// 0x800f334
int getBattleObjectPalette_800F334()
{
    int v0; // r5
    _BYTE *v1; // r0
    int v2; // r2
...
int sub_800F35C()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F36C);
}
...
int sub_800F378()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F388);
}
...
int sub_800F394()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F3A4);
}
...
int sub_800F3B0()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F3C0);
}
...
int sub_800F3CC()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F3DC);
}
...
int sub_800F3E8()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F3F8);
}
...
int sub_800F404()
{
    return indexByActorTypeAndAIIdxThenDispatch_800F420(off_800F414);
}


// 0x800f420
int __fastcall indexByActorTypeAndAIIdxThenDispatch_800F420(int a1)
{
    int v1; // r5
...
int sub_801050C()
{
    ...
    do
    {
        ...
        if ( *v2 )
        {
            ...
            {
                *(result + 36) = *(result + 38);
                spawn_t1_0x0_EffectObject(v0, result + 64, *(result + 52), *(result + 56), *(result + 60));
...
int sub_8010820()
{
    ...
    spawn_t1_0x0_EffectObject(v1, v7 << 16, v4 + (v7 << 16), v5, v6 + (v8 << 16));
...
signed int __fastcall object_applyDamage(int a1)
{
    ...
    {
        v3 = result;
        spawn_t1_0x0_EffectObject(v1, &v1->vx, v1->x, v1->y, v1->z);
        ...
        if ( result == 2 )
        {
            ...
            if ( result <= 11 )
            {
                ...
                if ( result == 2 )
                {
                    result = *(v1 + 23);
                    if ( !result )
                        result = SpawnCounterPinkRingMaybe_80C4C12(0, 4, v3, 16);
                }
            }
        }
    }
...
int __fastcall sub_80151D4(int a1, int a2, int a3)
{
    ...
    if ( !*(v4 + 1) )
    {
        ...
        *(v4 + 16) = result;
        ...
        spawn_t1_0x0_EffectObject(v3, 0x200000, v3->x, v3->y, v3->z + 0x200000);
        if ( v9 )
        {
            *(v9 + 16) = 54;
            v13 = *v9 | 4;
...
void sub_801562C()
{
    ...
    if ( !*(v1 + 1) )
    {
        ...
        *(v0 + 31) = 0;
        ...
        v14 = sub_80144C0();
        (loc_80143B4)(v14);
        v15 = object_clearInvulnerableTime();
...
// 0x8016380
int __usercall RunSpawnAnimationMaybe_8016380@<R0>(Battle *obj@<R5>)
{
    int result; // r0
...
LABEL_5:
        ...
        spawn_t1_0x0_EffectObject(v0, (v0 + 64), *(v0 + 13), *(v0 + 14), *(v0 + 15) + 0x100000);
        v3 = *v2 | 4;
        *v2 = v3;
...
signed int __fastcall sub_80165F8(int a1)
{
    ...
    *(v1 + 76) = 0;
    sub_801A7F4();
    v2 = GetVerActorTyAndAIIdx_80182B4(*(v1 + 40));
    if ( !v2[1] )
    {
        if ( *v2 >= 4 )
            sub_802D65E(v2[2]);
...
int __noreturn sub_8016F56()
{
    ...
    *(v0 + oBattleObject_CurAnimCopy) = -1;
    ...
    sprite_loadAnimationData(v0);
    v3 = getBattleObjectPalette_800F334();
...
int sub_8017122()
{
    ...
    if ( !*(v0 + 11) )
    {
        ...
        *(v0 + 16) = 2;
        ...
        spawn_t1_0x0_EffectObject(v0, v0 + 64, *(v0 + 52), *(v0 + 56), *(v0 + 60) + 0x200000);
        *(v7 + 32) = 90;
        *(v0 + 32) = 90;
        *(v0 + 11) = 4;
    }
...
int __fastcall sub_8017888(int a1)
{
    ...
    sub_800A8F8(a1);
    if ( !v2 && GetVerActorTyAndAIIdx_80182B4(*(v1 + 40))[1] == 2 && !*(*(v1 + 88) + 64) )
    ...
    *(v0 + 25) = result;
    if ( !result )
    {
        ...
        *(v0 + 19) = v5;
        object_setCoordinatesFromPanels(v0);
        v6 = *(v0 + 44);
        object_spawnDimmingCollisionRegion(*(v0 + 18), *(v0 + 19), *(v0 + 14), 0);
        *(v0 + 36) = 0;
        *(v0 + 9) = 2;
        result = 0;
        *(v0 + 10) = 0;
...
// 0x801b1c4
int __fastcall battle_801B1C4(int a1)
{
    int v1; // r5
...
// 0x801da48
int __fastcall dispatch_801DA48(int result)
{
    int (**v1)(void); // r6
    unsigned int v2; // r7
    char v3; // cf
...
// 0x801dacc
int __fastcall dispatch_801DACC(int result)
{
    int (**v1)(void); // r6
    unsigned int v2; // r7
    char v3; // cf
...
// 0x801e574
int __noreturn RetrieveAndRenderEnemyVirusNamesInBattle_801E574()
{
    __int16 *v0; // r4
    unsigned int v1; // r0
    char *v2; // r2
    ...
    word_20352AE = 255;
    v0 = &word_20352A8;
    v1 = LoadVirusNameIDsForUpToFourSlots_800A998(&word_20352A8);
    v2 = byte_203EBA0;
    v3 = 100711232;
    do
    {
        ...
        v7 = v2;
        v8 = v3;
        v9 = selectVirusOrNaviNamesAndWhich_800EC56(*v0);
    ...
    while ( v4 != 1 );
    return dispatch_801DA48(0x2000);
}
