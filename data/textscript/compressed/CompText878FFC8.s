...
CompText878FFC8::
	...
	ts_check_chapter [
		lower: 0x42,
		upper: 0x46,
		jumpIfInRange: CompText878FFC8_unk5_id,
	...
	ts_check_chapter [
		lower: 0x42,
		upper: 0x46,
		jumpIfInRange: CompText878FFC8_unk6_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_mugshot_show mugshot=0x42
	ts_msg_open
	...
	ts_check_chapter [
		lower: 0x42,
		upper: 0x46,
		jumpIfInRange: CompText878FFC8_unk7_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_mugshot_show mugshot=0x42
	ts_msg_open
	...
	ts_check_flag [
		flag: 0xC20,
		jumpIfTrue: CompText878FFC8_unk60_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_check_flag [
		flag: 0xC1E,
		jumpIfTrue: CompText878FFC8_unk55_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_check_flag [
		flag: 0xC1A,
		jumpIfTrue: CompText878FFC8_unk50_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_mugshot_show mugshot=0x3E
	ts_msg_open
