...
CompText878A898::
	...
	ts_check_flag 0x41, 0x11, 0x2, 0xFF
	ts_check_flag 0x43, 0x11, 0x1, 0xFF
	...
	ts_check_flag 0x41, 0x11, 0x5, 0xFF
	ts_check_flag 0x43, 0x11, 0x4, 0xFF
	...
	ts_space 0x1
	.string "Urchin/1000\n"
	ts_option 0x0, 0x33, 0x10
	ts_space 0x1
	.string "YTail/1500  "
	ts_option 0x0, 0x22, 0x33
	ts_space 0x1
	.string "Quit"
	...
	ts_check_flag 0x95, 0x11, 0xC, 0xFF
	ts_check_take_zenny 0xB8, 0xB, 0x0, 0x0, 0xFF, 0x2B, 0x2B
	ts_flag_set 0x95, 0x11
	ts_mugshot_show 0x41
	ts_msg_open
	...
	ts_check_flag 0x9B, 0x11, 0xE, 0xFF
	ts_check_take_zenny 0xE8, 0x3, 0x0, 0x0, 0xFF, 0x2B, 0x2B
	ts_flag_set 0x9B, 0x11
	ts_mugshot_show 0x41
	ts_msg_open
	...
	ts_check_flag 0x9A, 0x11, 0x10, 0xFF
	ts_check_take_zenny 0xDC, 0x5, 0x0, 0x0, 0xFF, 0x2B, 0x2B
	ts_flag_set 0x9A, 0x11
	ts_mugshot_show 0x41
	ts_msg_open
	...
	ts_check_flag 0x9C, 0x11, 0x13, 0xFF
	ts_check_take_zenny 0xE8, 0x3, 0x0, 0x0, 0xFF, 0x2C, 0x2C
	ts_flag_set 0x9C, 0x11
	ts_mugshot_show 0x3E
	ts_msg_open
	...
	ts_check_flag 0x98, 0x11, 0x15, 0xFF
	ts_check_take_zenny 0xE8, 0x3, 0x0, 0x0, 0xFF, 0x2C, 0x2C
	ts_flag_set 0x98, 0x11
	ts_mugshot_show 0x3E
	ts_msg_open
	.string "Shrimp it is!!\n"
	.string "Comin' right up!!"
	...
	ts_check_flag 0x99, 0x11, 0x17, 0xFF
	ts_check_take_zenny 0x20, 0x3, 0x0, 0x0, 0xFF, 0x2C, 0x2C
	ts_flag_set 0x99, 0x11
	ts_mugshot_show 0x3E
	ts_msg_open
	...
	ts_check_flag 0x9B, 0x11, 0x1A, 0xFF
	ts_check_take_zenny 0xDC, 0x5, 0x0, 0x0, 0xFF, 0x2D, 0x2D
	ts_flag_set 0x9B, 0x11
	ts_mugshot_show 0x40
	ts_msg_open
	.string "Urchin it is!!\n"
	...
	ts_check_flag 0x98, 0x11, 0x1C, 0xFF
	ts_check_take_zenny 0x20, 0x3, 0x0, 0x0, 0xFF, 0x2D, 0x2D
	ts_flag_set 0x98, 0x11
	ts_mugshot_show 0x40
	ts_msg_open
	.string "Shrimp it is!!\n"
	...
	ts_check_flag 0x96, 0x11, 0x1F, 0xFF
	ts_check_take_zenny 0x84, 0x3, 0x0, 0x0, 0xFF, 0x2E, 0x2E
	ts_flag_set 0x96, 0x11
	ts_mugshot_show 0x3F
	ts_msg_open
	.string "You got it!\n"
	...
	ts_check_flag 0x95, 0x11, 0x21, 0xFF
	ts_check_take_zenny 0xD0, 0x7, 0x0, 0x0, 0xFF, 0x2E, 0x2E
	ts_flag_set 0x95, 0x11
	ts_mugshot_show 0x3F
	ts_msg_open
	.string "You got it!\n"
	...
	ts_check_flag 0x97, 0x11, 0x23, 0xFF
	ts_check_take_zenny 0x84, 0x3, 0x0, 0x0, 0xFF, 0x2E, 0x2E
	ts_flag_set 0x97, 0x11
	ts_mugshot_show 0x3F
	ts_msg_open
	.string "You got it!\n"
	...
	ts_check_flag 0x95, 0x11, 0x26, 0xFF
	ts_check_take_zenny 0xE8, 0x3, 0x0, 0x0, 0xFF, 0x2F, 0x2F
	ts_flag_set 0x95, 0x11
	ts_mugshot_show 0x43
	ts_msg_open
	...
	ts_check_flag 0x98, 0x11, 0x28, 0xFF
	ts_check_take_zenny 0x84, 0x3, 0x0, 0x0, 0xFF, 0x2F, 0x2F
	ts_flag_set 0x98, 0x11
	ts_mugshot_show 0x43
	ts_msg_open
	...
	ts_check_flag 0x96, 0x11, 0x2A, 0xFF
	ts_check_take_zenny 0xD0, 0x7, 0x0, 0x0, 0xFF, 0x2F, 0x2F
	ts_flag_set 0x96, 0x11
	ts_mugshot_show 0x43
	ts_msg_open
	...
	ts_check_flag 0x9C, 0x11, 0x31, 0xFF
	ts_check_take_zenny 0x4C, 0x4, 0x0, 0x0, 0xFF, 0x2D, 0x2D
	ts_flag_set 0x9C, 0x11
	ts_mugshot_show 0x40
	ts_msg_open
	.string "Snapper it is!!\n"
