...
CompText877A7FC::
	...
	ts_check_flag 0x20, 0x1, 0xFF, 0x9
	ts_check_flag 0x34, 0x8, 0x1, 0xFF
	ts_check_chapter 0x32, 0x33, 0x78, 0xFF
	ts_check_flag 0x7E, 0x8, 0x7, 0xFF
	ts_flag_set 0x7E, 0x8
	ts_mugshot_show 0x0
	ts_msg_open
	...
	ts_check_flag 0x48, 0x8, 0x8, 0xFF
	ts_mugshot_show 0x22
	ts_msg_open
	...
	ts_check_flag 0x63, 0x1, 0x13, 0xFF
	ts_check_flag 0x20, 0x1, 0xFF, 0x13
	ts_check_flag 0x49, 0x8, 0xB, 0xFF
	ts_check_chapter 0x32, 0x33, 0x7A, 0xFF
	ts_check_flag 0x7F, 0x8, 0x11, 0xFF
	ts_flag_set 0x7F, 0x8
	ts_mugshot_show 0x0
	ts_msg_open
	...
	ts_check_flag 0x56, 0x8, 0x8, 0xFF
	ts_mugshot_show 0x23
	ts_msg_open
	.string "Ho,ho,ho,ho,\n"
	.string "the final lesson."
	...
	ts_flag_set 0x72, 0x8
	ts_check_flag 0x73, 0x8, 0xFF, 0x19
	ts_msg_open
	.string "..."
	...
	ts_menu_select_password 0x16, 0x17, 0x18, 0x0
	ts_end
	...
	ts_check_flag 0x41, 0x11, 0x21, 0xFF
	ts_check_flag 0x43, 0x11, 0x20, 0xFF
	ts_check_flag 0x40, 0x11, 0x1F, 0xFF
	ts_flag_set 0x40, 0x11
	ts_mugshot_show 0xF
	ts_msg_open
	...
	ts_check_flag 0x87, 0x11, 0x26, 0xFF
	ts_check_flag 0x81, 0x11, 0x25, 0xFF
	ts_check_flag 0x80, 0x11, 0x24, 0xFF
	ts_flag_set 0x80, 0x11
	...
	ts_flag_set 0x87, 0x11
	ts_item_take 0x26, 0x1
	ts_mugshot_show 0x15
	ts_msg_open
	.string "AHHH!!\n"
	.string "This is my\n"
	...
	ts_check_flag 0x2, 0x13, 0x33, 0xFF
	ts_flag_set 0x2, 0x13
	ts_mugshot_show 0x22
	ts_msg_open
	...
	ts_check_chapter 0x30, 0x3F, 0x35, 0xFF
	ts_end
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x14, 0x13
	ts_end

	def_text_script CompText877A7FC_unk54
	ts_check_flag 0x18, 0x13, 0xFF, 0x35
	ts_mugshot_show 0x22
	ts_msg_open
	.string "SlashMan,\n"
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x15, 0x13
	ts_end

	def_text_script CompText877A7FC_unk55
	ts_check_flag 0xE, 0x3, 0xFF, 0x36
	ts_check_flag 0x18, 0x13, 0xFF, 0x35
	ts_mugshot_show 0x22
	ts_msg_open
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x16, 0x13
	ts_end

	def_text_script CompText877A7FC_unk56

	def_text_script CompText877A7FC_unk57
	ts_check_flag 0x18, 0x13, 0x3A, 0xFF
	ts_flag_set 0x18, 0x13
	ts_jump 58
	...
	ts_check_flag 0x3, 0x13, 0x3D, 0xFF
	ts_flag_set 0x3, 0x13
	ts_mugshot_show 0x23
	ts_msg_open
	.string "Ho,ho,ho,ho...\n"
	...
	ts_check_chapter 0x30, 0x3F, 0x3F, 0xFF
	ts_end
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x19, 0x13
	ts_end

	def_text_script CompText877A7FC_unk64
	ts_check_flag 0x1D, 0x13, 0xFF, 0x3F
	ts_mugshot_show 0x23
	ts_msg_open
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x1A, 0x13
	ts_end

	def_text_script CompText877A7FC_unk65
	ts_check_flag 0x2C, 0x3, 0xFF, 0x40
	ts_check_flag 0x1D, 0x13, 0xFF, 0x3F
	ts_mugshot_show 0x23
	ts_msg_open
	.string "Ho,ho,ho,ho...\n"
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0x1B, 0x13
	ts_end

	def_text_script CompText877A7FC_unk66

	def_text_script CompText877A7FC_unk67
	ts_check_flag 0x1D, 0x13, 0x44, 0xFF
	ts_flag_set 0x1D, 0x13
	ts_jump 68
	...
	ts_check_shop_stock 0xD, 0xFF, 0x66
	...
	ts_check_flag 0x5B, 0x11, 0x72, 0xFF
	ts_check_flag 0x5C, 0x11, 0x71, 0xFF
	ts_check_flag 0x5E, 0x11, 0x70, 0xFF
	ts_check_flag 0x5D, 0x11, 0x6F, 0xFF
	ts_flag_set 0x5D, 0x11
	ts_mugshot_show 0xE
	ts_msg_open
	...
	ts_check_flag 0x1E, 0x1, 0x79, 0xFF
	ts_flag_set 0x1E, 0x1
	ts_flag_set 0x7E, 0x8
	ts_mugshot_show 0x0
	ts_msg_open
	...
	ts_check_flag 0x1E, 0x1, 0x7B, 0xFF
	ts_flag_set 0x7F, 0x8
	ts_flag_set 0x1E, 0x1
	ts_mugshot_show 0x0
	ts_msg_open
