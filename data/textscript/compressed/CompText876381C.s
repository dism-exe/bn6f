...
CompText876381C::
	...
	ts_check_chapter [
		lower: 0x63,
		upper: 0x64,
		jumpIfInRange: CompText876381C_unk15_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x62,
		upper: 0x62,
		jumpIfInRange: CompText876381C_unk10_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x61,
		upper: 0x61,
		jumpIfInRange: CompText876381C_unk5_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	...
	ts_check_chapter [
		lower: 0x63,
		upper: 0x64,
		jumpIfInRange: CompText876381C_unk16_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x62,
		upper: 0x62,
		jumpIfInRange: CompText876381C_unk11_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x61,
		upper: 0x61,
		jumpIfInRange: CompText876381C_unk6_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_flag [
		flag: 0xE08,
	...
	ts_check_chapter [
		lower: 0x63,
		upper: 0x64,
		jumpIfInRange: CompText876381C_unk17_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x61,
		upper: 0x61,
		jumpIfInRange: CompText876381C_unk7_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
