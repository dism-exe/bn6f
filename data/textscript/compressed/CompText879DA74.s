...
CompText879DA74::
	...
	ts_key_wait 0x0
	ts_flag_set 0x15, 0x17
	ts_flag_set 0xD9, 0x1
	ts_end

	def_text_script CompText879DA74_unk52
	ts_check_flag 0xD4, 0x1, 0x36, 0xFF
	...
	ts_check_flag 0xEC, 0x1, 0x37, 0xFF
	ts_mugshot_show 0x5C
	ts_msg_open
	.string "AMAZING!!\n"
	.string "WELL DONE!!"
	...
	ts_clear_msg
	ts_mugshot_hide
	ts_item_give_chip 0x50, 0x0, 0x1A, 0x1
	...
	ts_clear_msg
	ts_mugshot_hide
	ts_check_give_zenny 0xF4, 0x1, 0x0, 0x0, 0xFF, 0xFF, 0xFF
	ts_player_animate_object 0x18
	ts_print_current_navi
	.string " got:\n"
	.string "\"500 Zennys\"!!"
	...
	ts_clear_msg
	ts_mugshot_hide
	ts_check_give_bug_frags 0x2, 0x0, 0x0, 0x0, 0xFF, 0xFF, 0xFF
	ts_player_animate_object 0x18
	ts_print_current_navi
	.string " got:\n"
	.string "\"2 BugFrags\"!!"
