...
CompText8786694::
	...
	ts_check_chapter [
		lower: 0x43,
		upper: 0x46,
		jumpIfInRange: CompText8786694_unk10_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x42,
		upper: 0x42,
		jumpIfInRange: CompText8786694_unk5_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	...
	ts_check_chapter [
		lower: 0x43,
		upper: 0x46,
		jumpIfInRange: CompText8786694_unk11_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	ts_check_chapter [
		lower: 0x42,
		upper: 0x42,
		jumpIfInRange: CompText8786694_unk6_id,
		jumpIfOutOfRange: TS_CONTINUE,
	]
	...
	ts_check_flag [
		flag: 0xC20,
		jumpIfTrue: CompText8786694_unk60_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_check_flag [
		flag: 0xC1E,
		jumpIfTrue: CompText8786694_unk55_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_check_flag [
		flag: 0xC1A,
		jumpIfTrue: CompText8786694_unk50_id,
		jumpIfFalse: TS_CONTINUE,
	]
	ts_mugshot_show mugshot=0x3F
	ts_msg_open
	...
	def_text_script CompText8786694_unk61

	def_text_script CompText8786694_unk62

	def_text_script CompText8786694_unk63

	def_text_script CompText8786694_unk64

	def_text_script CompText8786694_unk65

	def_text_script CompText8786694_unk66

	def_text_script CompText8786694_unk67

	def_text_script CompText8786694_unk68
