TextScript873D108::
	...
	ts_jump_buffer_set 7
	ts_check_flag 0x8, 0x17, 0x8, 0x5
	ts_end
	...
	ts_clear_msg
	ts_item_take 0x85, 0x1
	ts_jump_buffer

	def_text_script TextScript873D108_unk6

	def_text_script TextScript873D108_unk7
	ts_flag_set_buffered 0x0
	ts_item_give_chip 0xFF, 0xFF, 0xFF, 0x1
	ts_player_animate_object 0x18
	ts_print_current_navi_ow
	.string " got:\n"
	.string "\""
	ts_print_chip1 0x0, 0x3
	.string " "
	ts_print_code 0x0, 0x4
	.string "\"!!!"
	ts_key_wait 0x0
	ts_player_finish
	...
	ts_jump_buffer_set 17
	ts_check_flag 0x8, 0x17, 0x12, 0xF
	ts_end
	...
	ts_check_give_item 0xFF, 0x1, 0xFF, 0x10, 0x10
	ts_flag_set_buffered 0x0
	ts_player_animate_object 0x18
	ts_print_current_navi_ow
	.string " got a\n"
	...
	ts_jump_buffer_set 27
	ts_check_flag 0x8, 0x17, 0x1C, 0x19
	ts_end
	...
	ts_flag_set_buffered 0x0
	ts_check_give_zenny 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
	ts_player_animate_object 0x18
	ts_print_current_navi_ow
	.string " got:\n"
	.string "\""
	...
	ts_jump_buffer_set 37
	ts_check_flag 0x8, 0x17, 0x26, 0x23
	ts_end
	...
	ts_jump_buffer_set 47
	ts_check_flag 0x8, 0x17, 0x30, 0x2D
	ts_end
	...
	ts_jump_buffer_set 77
	ts_check_flag 0x8, 0x17, 0x4E, 0x4B
	ts_end
	...
	ts_jump_buffer_set 87
	ts_check_flag 0x8, 0x17, 0x58, 0x55
	ts_end
	...
	ts_flag_set_buffered 0x0
	ts_item_give_navi_cust_program 0xFF, 0x1, 0xFF
	ts_player_animate_object 0x18
	ts_print_current_navi_ow
	.string " got:\n"
	.string "\""
	ts_print_navi_cust_program5 0x0, 0x3
	.string "\"!!!"
	ts_key_wait 0x0
	ts_player_finish
	ts_player_reset_object
	...
	ts_jump_buffer_set 97
	ts_check_flag 0x8, 0x17, 0x62, 0x5F
	ts_end
	...
	ts_jump_buffer_set 107
	ts_check_flag 0x8, 0x17, 0x6C, 0x69
	ts_end
	...
	ts_jump_buffer_set 117
	ts_check_flag 0x8, 0x17, 0x76, 0x73
	ts_end
	...
	ts_check_navi_all 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x79
	ts_msg_open
	ts_print_current_navi_ow
	.string " has no use\n"
